 ...
 */
package org.apache.shpurdp.spi;
...
public class RepositoryVersion {
   ...
   *
   * @param id
   *          the internal ID of the repository stored in Shpurdp.
   * @param stackName
  ...
  /**
   * Gets the internal ID of the repository version stored in Shpurdp's database.
   *
