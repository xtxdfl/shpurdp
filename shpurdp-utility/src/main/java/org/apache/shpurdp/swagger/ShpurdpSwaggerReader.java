 ...
 * treat nested API's.
 */
public class ShpurdpSwaggerReader extends JaxrsReader {

  /**
   * Logger instance.
   */
  protected final static Logger logger = LoggerFactory.getLogger(ShpurdpSwaggerReader.class);

  public ShpurdpSwaggerReader(Swagger swagger, Log LOG) {
    super(swagger, LOG);
  }
