...
shpurdp_server_resources = config['hostLevelParams']['jdk_location']
oracle_driver_symlink_url = format("{shpurdp_server_resources}oracle-jdbc-driver.jar")
mysql_driver_symlink_url = format("{shpurdp_server_resources}mysql-jdbc-driver.jar")

shpurdp_db_rca_url = config['hostLevelParams']['shpurdp_db_rca_url'][0]
shpurdp_db_rca_driver = config['hostLevelParams']['shpurdp_db_rca_driver'][0]
shpurdp_db_rca_username = config['hostLevelParams']['shpurdp_db_rca_username'][0]
shpurdp_db_rca_password = config['hostLevelParams']['shpurdp_db_rca_password'][0]
