...
# params from nifi-shpurdp-config
nifi_initial_mem = config['configurations']['nifi-shpurdp-config']['nifi.initial_mem']
nifi_max_mem = config['configurations']['nifi-shpurdp-config']['nifi.max_mem']
nifi_shpurdp_reporting_frequency = config['configurations']['nifi-shpurdp-config']['nifi.shpurdp_reporting_frequency']
nifi_shpurdp_reporting_enabled = config['configurations']['nifi-shpurdp-config']['nifi.shpurdp_reporting_enabled']

# note: nifi.node.port and nifi.node.ssl.port must be defined in same xml file for quicklinks to work
nifi_node_port = config['configurations']['nifi-shpurdp-config']['nifi.node.port']
nifi_node_ssl_port = config['configurations']['nifi-shpurdp-config']['nifi.node.ssl.port']
nifi_node_protocol_port = config['configurations']['nifi-shpurdp-config']['nifi.node.protocol.port']

nifi_znode = config['configurations']['nifi-shpurdp-config']['nifi.nifi_znode']

nifi_internal_dir=config['configurations']['nifi-shpurdp-config']['nifi.internal.dir']
nifi_state_dir=config['configurations']['nifi-shpurdp-config']['nifi.state.dir']
nifi_database_dir=config['configurations']['nifi-shpurdp-config']['nifi.database.dir']
nifi_flowfile_repo_dir=config['configurations']['nifi-shpurdp-config']['nifi.flowfile.repository.dir']
nifi_content_repo_dir_default=config['configurations']['nifi-shpurdp-config']['nifi.content.repository.dir.default']
nifi_provenance_repo_dir_default=config['configurations']['nifi-shpurdp-config']['nifi.provenance.repository.dir.default']
nifi_config_dir = config['configurations']['nifi-shpurdp-config']['nifi.config.dir']
nifi_flow_config_dir = config['configurations']['nifi-shpurdp-config']['nifi.flow.config.dir']
nifi_sensitive_props_key = config['configurations']['nifi-shpurdp-config']['nifi.sensitive.props.key']
...
# In sandbox scenario, Shpurdp should still setup nifi in clustered mode for now
nifi_is_node='true'
...
# params from nifi-shpurdp-ssl-config

nifi_ssl_enabled = config['configurations']['nifi-shpurdp-ssl-config']['nifi.node.ssl.isenabled']
nifi_keystore = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.keystore']
nifi_keystoreType = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.keystoreType']
nifi_keystorePasswd = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.keystorePasswd']
nifi_keyPasswd = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.keyPasswd']
nifi_truststore = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.truststore']
nifi_truststoreType = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.truststoreType']
nifi_truststorePasswd = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.truststorePasswd']
nifi_needClientAuth = config['configurations']['nifi-shpurdp-ssl-config']['nifi.security.needClientAuth']
nifi_initial_admin_id = config['configurations']['nifi-shpurdp-ssl-config']['nifi.initial.admin.identity']
nifi_ssl_config_content = config['configurations']['nifi-shpurdp-ssl-config']['content']
...
nifi_ca_parent_config = config['configurations']['nifi-shpurdp-ssl-config']
...
#autodetect shpurdp server for metrics
...
nifi_host_port = config['configurations']['nifi-shpurdp-config']['nifi.node.port']
...
shpurdp_server_hostname = config['clusterHostInfo']['shpurdp_server_host'][0]
...
if has_ranger_admin:
  ...
  if stack_supports_ranger_kerberos:
    nifi_ranger_plugin_config['shpurdp.service.check.user'] = policy_user
