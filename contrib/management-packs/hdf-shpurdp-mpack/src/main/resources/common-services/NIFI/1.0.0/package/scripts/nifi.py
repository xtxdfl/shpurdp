...
class Master(Script):
  ...
  def start(self, env):
    ...
    # only during first install. It is used to automate setup of Shpurdp metrics reporting task in Nifi
    if params.metrics_collector_host and params.nifi_shpurdp_reporting_enabled and self.check_is_fresh_install(self):
