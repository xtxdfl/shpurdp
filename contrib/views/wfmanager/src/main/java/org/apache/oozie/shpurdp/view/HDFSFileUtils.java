...
import org.apache.shpurdp.view.utils.hdfs.ConfigurationBuilder;
...
public class HDFSFileUtils {
	...
	private static final String SHPURDP_SKIP_HOME_DIRECTORY_CHECK_PROTOCOL_LIST = "views.skip.home-directory-check.file-system.list";
	...
	public Boolean shouldCheckForHomeDir(){
		...
		try {
			...
			String shpurdpSkipCheckValues = viewContext.getShpurdpProperty(SHPURDP_SKIP_HOME_DIRECTORY_CHECK_PROTOCOL_LIST);
			List<String> protocolSkipList = (shpurdpSkipCheckValues == null? new LinkedList<String>() : Arrays.asList(shpurdpSkipCheckValues.split(",")));
