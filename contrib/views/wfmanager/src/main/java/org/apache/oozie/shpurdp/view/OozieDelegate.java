...
public class OozieDelegate {
  ...
  private final ShpurdpIOUtil shpurdpIOUtil;

  public OozieDelegate(ViewContext viewContext) {
    super();
    this.viewContext = viewContext;
    this.shpurdpIOUtil = new ShpurdpIOUtil(viewContext);
  }
  ...
  public InputStream readFromOozie(HttpHeaders headers, String urlToRead,
    ...
    return shpurdpIOUtil.readFromUrl(urlToRead, method, body, newHeaders);
  }
