...
public class Services {
  ...
  public Services(ShpurdpApi shpurdpApi, ViewContext context) {
    this.shpurdpApi = shpurdpApi;
  ...
  private String getActiveRMUrl(String[] urls) {
    ...
    throw new ShpurdpApiException("RA110 All ResourceManagers are not accessible or none seem to be active.");
  }
  ...
  public static String addProtocolIfMissing(String url, String protocol) throws ShpurdpApiException {
    if (!hasProtocol(url)) {
      url = protocol + "://" + url;
    }
    return url;
