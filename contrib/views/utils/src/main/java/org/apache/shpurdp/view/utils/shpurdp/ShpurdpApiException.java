...
/**
 * Exception during work with Shpurdp API
 */
public class ShpurdpApiException extends RuntimeException {
  public ShpurdpApiException(String message) {
    super(message);
  }

  public ShpurdpApiException(String message, Throwable cause) {
    super(message, cause);
  }
