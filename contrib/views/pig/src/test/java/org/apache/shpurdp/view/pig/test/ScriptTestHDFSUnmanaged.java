...
import org.apache.shpurdp.view.pig.HDFSTest;
import org.apache.shpurdp.view.pig.persistence.DataStoreStorage;
import org.apache.shpurdp.view.pig.persistence.Storage;
import org.apache.shpurdp.view.pig.resources.scripts.ScriptService;
import org.apache.shpurdp.view.pig.persistence.utils.StorageUtil;
import org.apache.shpurdp.view.pig.resources.scripts.models.PigScript;
...
import org.apache.shpurdp.view.utils.hdfs.HdfsUtil;
...
//        properties.put("scripts.dir", "/tmp/.pigscripts");
    ...
    expect(context.getUsername()).andReturn("shpurdp-qa").anyTimes();
...
//        properties.put("dataworker.storagePath", pigStorageFile.toString());
  ...
  public void hdfsApiNoUsernameProvided() throws IOException, InterruptedException {
    ...
    Assert.assertEquals("shpurdp-qa", HdfsUtil.getHdfsUsername(context));
