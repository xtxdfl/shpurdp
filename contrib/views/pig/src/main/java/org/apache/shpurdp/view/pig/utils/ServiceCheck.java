...
package org.apache.shpurdp.view.pig.utils;
...
public class ServiceCheck {
  ...
  public Policy getServiceCheckPolicy() throws HdfsApiException {
    ...
    try {
      ...
      String shpurdpSkipCheckValues = viewContext.getShpurdpProperty(Constants.SHPURDP_SKIP_HOME_DIRECTORY_CHECK_PROTOCOL_LIST);
