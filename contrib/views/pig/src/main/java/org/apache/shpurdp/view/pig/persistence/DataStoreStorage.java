...
package org.apache.shpurdp.view.pig.persistence;

import org.apache.shpurdp.view.PersistenceException;
import org.apache.shpurdp.view.ViewContext;
import org.apache.shpurdp.view.pig.persistence.utils.*;
...
public class DataStoreStorage implements Storage {
  ...
  public static void storageSmokeTest(ViewContext context) {
    try {
      ...
      if (entity.getId() == null) throw new ServiceFormattedException("Shpurdp Views instance data DB doesn't work properly (auto increment id doesn't work)", null);
      ...
      if (!status) throw new ServiceFormattedException("Shpurdp Views instance data DB doesn't work properly", null);
