...
package org.apache.shpurdp.view.pig.resources.jobs;

import org.apache.shpurdp.view.ViewContext;
import org.apache.shpurdp.view.pig.persistence.utils.FilteringStrategy;
import org.apache.shpurdp.view.pig.persistence.utils.Indexed;
import org.apache.shpurdp.view.pig.resources.PersonalCRUDResourceManager;
import org.apache.shpurdp.view.pig.resources.jobs.models.PigJob;
import org.apache.shpurdp.view.pig.resources.jobs.utils.JobPolling;
import org.apache.shpurdp.view.pig.templeton.client.TempletonApi;
import org.apache.shpurdp.view.pig.templeton.client.TempletonApiFactory;
import org.apache.shpurdp.view.pig.utils.MisconfigurationFormattedException;
import org.apache.shpurdp.view.pig.utils.ServiceFormattedException;
import org.apache.shpurdp.view.pig.utils.UserLocalObjects;
import org.apache.shpurdp.view.utils.shpurdp.ShpurdpApiException;
import org.apache.shpurdp.view.utils.hdfs.HdfsApiException;
  ...
  private void submitJob(PigJob job) {
    ...
    try {
      ...
      if (data.id != null) {
        ...
        throw new ShpurdpApiException("Cannot get id for the Job.");
      }
