...
public class ConfigurationServiceTest {
    ...
    private Cluster shpurdpCluster;
    ...
    public void setUp() throws Exception {
        ...
        shpurdpCluster = createNiceMock(Cluster.class);

        EasyMock.expect(shpurdpCluster.getConfigurationValue("ranger-yarn-plugin-properties", "ranger-yarn-plugin-enabled")).andReturn("Yes").anyTimes();
        EasyMock.expect(context.getCluster()).andReturn(shpurdpCluster).anyTimes();
        EasyMock.expect(context.getProperties()).andReturn(properties).anyTimes();
        EasyMock.replay(context);
        EasyMock.replay(shpurdpCluster);
