...
export default DS.RESTAdapter.extend({
 ...
 headers: Ember.computed(function () {
    ...
    if (ENV.environment === 'development') {
      // In development mode when the UI is served using ember serve the xhr requests are proxied to shpurdp server
      // by setting the proxyurl parameter in ember serve and for shpurdp to authenticate the requests, it needs this
