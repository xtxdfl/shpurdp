...
python version_builder.py --file $filename --finalize --xsd ../../shpurdp-server/src/main/resources/version_definition.xsd

# to upload this to running Shpurdp instance on localhost:
