...
# This script will configure the shpurdp-server
...
if [ $# -lt 3 ]; then
    echo "usage: ./set_shpurdp_server_network.sh <Weave internal IP> <Weave DNS IP> <Mask>"
    echo "example: ./set_shpurdp_server_network.sh 192.168.255.1 192.168.255.2 16"
    exit 1
fi
