...
echo "Alias /shpurdpnagios %{_prefix}/share/hdp" >> $RPM_BUILD_ROOT/%{httpd_confdir}/hdp_mon_nagios_addons.conf
...
%changelog
* Fri Feb 17 2011 Hortonworks <shpurdp-group@hortonworks.com>
- Initial version
