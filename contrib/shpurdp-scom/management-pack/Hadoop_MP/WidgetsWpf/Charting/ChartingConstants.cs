...
namespace Shpurdp.SCOM.Widgets.Charting {
    static class ChartingConstants {
        ...
        public const string StackableSeriesType = "xsd://Shpurdp.SCOM.Presentation!Shpurdp.SCOM.Presentation.Schema.ChartDataTypes/StackableSeries";
        public const string AreaSeriesType = "xsd://Shpurdp.SCOM.Presentation!Shpurdp.SCOM.Presentation.Schema.ChartDataTypes/AreaSeries";
