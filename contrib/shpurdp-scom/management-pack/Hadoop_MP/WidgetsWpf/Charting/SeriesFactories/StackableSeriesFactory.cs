...
namespace Shpurdp.SCOM.Widgets.Charting.SeriesFactories {
    ...
    public class StackableSeriesFactory : Series2DFactoryBase {
        ...
        private const string DefaultStackedSeriesType = "xsd://Shpurdp.SCOM.Presentation!Shpurdp.SCOM.Presentation.Schema.ChartDataTypes/StackedSeries";
