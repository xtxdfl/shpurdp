...
using Shpurdp.SCOM.ScomPages.Properties;
...
namespace Shpurdp.SCOM.ScomPages.DiscoveryTemplate {
    public partial class WatcherNodesPage : UIPage {
        ...
        private void GetSharedUserData() {
            shpurdpUri = SharedUserData[ShpurdpDetailsPage.SharedUserDataShpurdpUri] as string;
            runAsName = SharedUserData[ShpurdpDetailsPage.SharedUserDataRunAsName] as string;
            runAsSsid = SharedUserData[ShpurdpDetailsPage.SharedUserDataRunAsSsid] as byte[];
