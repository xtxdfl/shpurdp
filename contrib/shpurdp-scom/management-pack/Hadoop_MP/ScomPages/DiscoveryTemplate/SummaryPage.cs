...
namespace Shpurdp.SCOM.ScomPages.DiscoveryTemplate {
    public partial class SummaryPage : UIPage {
        ...
        private void SetListViewItems() {
            ...
            AddSummaryItem(Resources.ShpurdpUri, SharedUserData[ShpurdpDetailsPage.SharedUserDataShpurdpUri] as string);
            AddSummaryItem(Resources.RunAsAccount, SharedUserData[ShpurdpDetailsPage.SharedUserDataRunAsName] as string);
