...
namespace GUI_Shpurdp
{
    public partial class Form1 : Form
    {
        ...
        private void Install_Click(object sender, EventArgs e) 
        {
            ...
            {
                MessageBox.Show("Please enter correct Shpurdp directory", "Error");
            }
            ...
            {
                MessageBox.Show("You are installing Shpurdp on separate node. Please enter correct cluster layout file path", "Error");
            }
        ...
        private void Cancel_Click(object sender, EventArgs e)
        {
            ...
            {
                GUI_Shpurdp.Program.Kill_Msiexec();
                Environment.Exit(1);
            }
        }
        ...
        private void Generate_Shpurdp_Props()
        {
            ...
            string cp = res + "\\shpurdpproperties.txt";
        ...
        private void Cbrowse_Click(object sender, EventArgs e)
        {
           ...
           OpenFile.Title = "Please select Shpurdp properties file";
           OpenFile.ShowDialog();
