...
public class SinkConnectionFactoryTest {
  ...
  public static SinkConnectionFactory getFactory(String url, String driver) {
    ...
    shpurdpProperties.setProperty(SinkConnectionFactory.SCOM_SINK_DB_URL, url);
    shpurdpProperties.setProperty(SinkConnectionFactory.SCOM_SINK_DB_DRIVER, driver);
