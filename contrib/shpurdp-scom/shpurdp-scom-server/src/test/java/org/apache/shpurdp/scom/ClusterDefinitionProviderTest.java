...
public class ClusterDefinitionProviderTest {
  ...
  public static ClusterDefinitionProvider getProvider(String filename, String clusterName, String versionId) {
    ...
    shpurdpProperties.setProperty(ClusterDefinitionProvider.SCOM_CLUSTER_DEFINITION_FILENAME, filename);
    shpurdpProperties.setProperty(ClusterDefinitionProvider.SCOM_CLUSTER_NAME, clusterName);
    shpurdpProperties.setProperty(ClusterDefinitionProvider.SCOM_VERSION_ID, versionId);
