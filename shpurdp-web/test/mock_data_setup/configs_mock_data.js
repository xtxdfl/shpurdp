    ...
    var configGroups = [
      {
        ...
        "type":"core-site",
        "properties": {
          "fs.defaultFS" : "hdfs://c6401.shpurdp.apache.org:8020",
      ...
      },
      {
        ...
        "type":"storm-site",
        "properties": {
          "storm.zookeeper.servers": "['c6401.shpurdp.apache.org','c6402.shpurdp.apache.org']",
      ...
      },
      {
        ...
        "properties": {
          ...
          "stormuiserver_host": "c6401.shpurdp.apache.org"
        }
      },
      {
        "tag":"version1",
    ...
    return [
      {
        "serviceName": "HDFS",
        "name": "fs.defaultFS",
        "value": "hdfs://c6401.shpurdp.apache.org:8020",
    ...
    return [
      {
        ...
        "recommendedValue":"['c6401.shpurdp.apache.org','c6402.shpurdp.apache.org']",
        "filename":"storm-site.xml",
