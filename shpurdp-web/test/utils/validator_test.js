...
describe('validator', function () {
  ...
  describe('#isValidURL', function() {
    var tests = [
      ...
      {m:'"http://shpurdp.apache.org" - valid',i:'http://shpurdp.apache.org',e:true},
      {m:'"https://shpurdp.apache.org" - valid',i:'https://shpurdp.apache.org',e:true},
      {m:'"htp://shpurdp.apache.org." - invalid',i:'.htp://shpurdp.apache.org.',e:false},
      {m:'"shpurdp.apache.org" - invalid',i:'shpurdp.apache.org',e:false},
      {m:'"www.shpurdp.apache.org" - invalid',i:'www.shpurdp.apache.org',e:false},
      {m:'"" - invalid',i:'',e:false}
    ];
    tests.forEach(function(test) {
      it(test.m + ' ', function () {
  ...
  describe('#isHostname()', function() {
    var tests = [
      ...
      {m:'"c6401.apache.shpurdp.org" - valid',i:'c6401.apache.shpurdp.org',e:true},
