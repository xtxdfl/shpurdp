    ...
    Em.A([
      {
        ...
        rValue: 'c6401.shpurdp.apache.org:8020',
      ...
      },
      {
        ...
        localDB: getLocalDBForSingleComponent('NAMENODE'),
        rValue: 'hdfs://c6401.shpurdp.apache.org:8020',
      ...
      },
      {
        ...
        rValue: 'c6401.shpurdp.apache.org:50090',
      ...
      },
      {
        ...
        localDB: getLocalDBForSingleComponent('HISTORYSERVER'),
        rValue: 'c6407.shpurdp.apache.org:19888',
      ...
      },
      {
        ...
        rValue: 'c6407.shpurdp.apache.org',
        expectedValue: 'h1'
      },
      {
        config: 'yarn.resourcemanager.resource-tracker.address',
        localDB: getLocalDBForSingleComponent('RESOURCEMANAGER'),
        rValue: 'c6407.shpurdp.apache.org:123',
      ...
      },
      {
        ...
        rValue: 'c6407.shpurdp.apache.org:432',
      ...
      },
      {
        ...
        rValue: 'c6407.shpurdp.apache.org:111',
      ...
      },
      {
        ...
        localDB: getLocalDBForSingleComponent('HISTORYSERVER'),
        rValue: 'c6407.shpurdp.apache.org:555',
      ...
      },
      {
        ...
        rValue: "['c6401.shpurdp.apache.org','c6402.shpurdp.apache.org']",
