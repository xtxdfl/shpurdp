...
describe('App.QuickViewLinks', function () {
  ...
  describe("#shpurdpProperties", function () {
    beforeEach(function () {
    ...
    it("shpurdpProperties are updated", function () {
      expect(quickViewLinks.get('shpurdpProperties')).to.eql({p: 1});
    });
  });
  ...
  describe('#setProtocol', function () {
    var tests = [
      ...
      },
      {
        serviceName: "OOZIE",
        configProperties: [
          {type: 'oozie-site', properties: {"oozie.base.url":"http://c6401.shpurdp.apache.org:11000/oozie"}}
        ],
        quickLinksConfig: {
          protocol:{
            type:"https",
      ...
      Em.Object.create({
        ...
        'configProperties':
          [
            {
              'type': 'yarn-site',
              'properties': {'yarn.timeline-service.webapp.address': 'c6401.shpurdp.apache.org:8188'}
            }
          ],
        'result': '8188'
      }),
      ...
      Em.Object.create({
        ...
        'configProperties':
          [
            {
              'type': 'yarn-site',
              'properties': {'yarn.timeline-service.webapp.https.address': 'c6401.shpurdp.apache.org:8090'}
            }
          ],
        'result': '8090'
      }),
          ...
          [
            {
              ...
              'properties':
                {
                  'oozie.base.url': 'c6401.shpurdp.apache.org:11000/oozie',
          ...
          [
            {
              ...
              'properties':
                {
                  'oozie.base.url': 'c6401.shpurdp.apache.org:11002/oozie',
                  'oozie.https.port' : '11444'
                }
            }
          ],
