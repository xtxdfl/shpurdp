...
describe('App.DirectoriesTabOnStep7View', function () {
  ...
  describe('#setServices()', function () {
    beforeEach(function () {
      sinon.stub(controller, 'selectedServiceObserver', Em.K);
        ...
        Em.Object.create({
          "id": "SHPURDP_METRICS_directories",
          "themeName": "directories",
          "serviceName": "SHPURDP_METRICS"
        }),
      ]));
      controller.set('tabs', Em.A([
        Em.Object.create({isActive: true, selectedServiceName: 'SHPURDP_METRICS_directories'})
      ]));
    });
    afterEach(function () {
    ...
    it('should set services', function () {
      controller.set('stepConfigs', Em.A([
        Em.Object.create({
          serviceName: 'SHPURDP_METRICS', configs: Em.A([
    ...
    it('should set controller selectedService', function () {
      controller.set('stepConfigs', Em.A([
        Em.Object.create({
          serviceName: 'SHPURDP_METRICS_directories', configs: Em.A([
            Em.Object.create({name: "metrics_grafana_username", displayName: "Grafana Admin Password",})
          ])
        })
      ]));
  ...
  describe('#selectService()', function () {
    var eventContext;
    beforeEach(function () {
      eventContext = Em.Object.create({context: Em.Object.create({'isActive': false, serviceName: 'SHPURDP_METRICS'})});
