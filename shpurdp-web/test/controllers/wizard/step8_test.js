            ...
            repository_versions: [
              {
                operating_systems: [
                  {
                    OperatingSystems: {
                      shpurdp_managed_repositories: true
                    },
                    repositories: [
                      {
                        Repositories: {
    ...
    describe('#createNotification', function () {
      ...
      beforeEach(function () {
        ...
        installerStep8Controller.set('configs', [
          ...
          {name: 'shpurdp.dispatch.recipients', value: 'to@f.c', serviceName: 'MISC', filename: 'alert_notification'},
          ...
          {name: 'shpurdp.dispatch.credential.username', value: 'usr', serviceName: 'MISC', filename: 'alert_notification'},
          {name: 'shpurdp.dispatch.credential.password', value: 'pwd', serviceName: 'MISC', filename: 'alert_notification'},
      ...
      describe('sent data should be valid', function () {
        ...
        it('shpurdp.dispatch.recipients is valid', function () {
          expect(data.properties['shpurdp.dispatch.recipients']).to.eql(['to@f.c']);
        });
        ...
        it('shpurdp.dispatch.credential.username is valid', function () {
          expect(data.properties['shpurdp.dispatch.credential.username']).to.equal('usr');
        });
        it('shpurdp.dispatch.credential.password is valid', function () {
          expect(data.properties['shpurdp.dispatch.credential.password']).to.equal('pwd');
        });
