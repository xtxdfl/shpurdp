...
describe('App.WizardStep3Controller', function () {
    ...
    var agentUserCases = [
      {
        ...
        userRunAs: 'user',
        title: 'Shpurdp Agent user account customize enabled'
      },
      {
        customizeAgentUserAccount: false,
        userRunAs: 'root',
        title: 'Shpurdp Agent user account customize disabled'
      }
    ];
  ...
  describe('#doCheckJDK', function () {
    ...
    it('should do request to the shpurdp-server', function () {
  ...
  describe('#doCheckJDKsuccessCallback', function () {
    ...
    it('should do request to shpurdp-server', function () {
  ...
  describe('#getDataForCheckRequest', function() {
    ...
    beforeEach(function() {
      sinon.stub(App.get('router'), 'get' , function(p) {
        return p === 'clusterController.shpurdpProperties.jdk_location' ? 'jdk_location' : Em.get(App.get('router'), p);
      })
    });
    afterEach(function() {
