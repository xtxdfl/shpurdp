...
describe('App.WizardStep4Controller', function () {
  ...
  var services = [
    ...
    'YARN', 'MAPREDUCE2', 'FALCON', 'TEZ', 'STORM', 'SHPURDP_METRICS', 'RANGER', 'SPARK', 'SLIDER', 'ATLAS', 'SHPURDP_INFRA_SOLR'
  ];
  var controller;
    ...
    var tests = [
        {
          ...
          errorsExpected: ['shpurdpMetricsCheck', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['ZOOKEEPER'],
          errorsExpected: ['shpurdpMetricsCheck', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        ...
        {
          services: ['HDFS'],
          errorsExpected: ['serviceCheck_ZOOKEEPER', 'shpurdpMetricsCheck', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'TEZ', 'ZOOKEEPER'],
          errorsExpected: ['serviceCheck_YARN', 'shpurdpMetricsCheck' , 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'ZOOKEEPER', 'FALCON'],
          errorsExpected: ['serviceCheck_OOZIE', 'shpurdpMetricsCheck' , 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
        ...
        },
        {
          ...
          errorsExpected: ['serviceCheck_YARN', 'multipleDFS', 'shpurdpMetricsCheck', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
        ...
        {
          services: ['HDFS','ZOOKEEPER', 'SHPURDP_METRICS'],
          errorsExpected: ['smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['ZOOKEEPER', 'SHPURDP_METRICS'],
          errorsExpected: ['smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'SHPURDP_METRICS'],
          errorsExpected: ['serviceCheck_ZOOKEEPER', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'TEZ', 'ZOOKEEPER', 'SHPURDP_METRICS'],
          errorsExpected: ['serviceCheck_YARN', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'ZOOKEEPER', 'FALCON', 'SHPURDP_METRICS'],
          errorsExpected: ['serviceCheck_OOZIE', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'ZOOKEEPER', 'GANGLIA', 'HIVE', 'SHPURDP_METRICS'],
          errorsExpected: ['serviceCheck_YARN', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS', 'GLUSTERFS', 'ZOOKEEPER', 'HIVE', 'SHPURDP_METRICS'],
          errorsExpected: ['serviceCheck_YARN', 'multipleDFS', 'smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['HDFS','ZOOKEEPER', 'GANGLIA', 'SHPURDP_METRICS'],
          errorsExpected: ['smartSenseCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['RANGER'],
          errorsExpected: ['shpurdpMetricsCheck', 'smartSenseCheck', 'atlasCheck', 'shpurdpRangerInfraCheck']
        },
        {
          services: ['SMARTSENSE'],
          errorsExpected: ['shpurdpMetricsCheck', 'rangerCheck', 'atlasCheck']
        },
        {
          services: ['ATLAS', 'SHPURDP_METRICS', 'SMARTSENSE'],
          errorsExpected: ['rangerCheck', 'shpurdpAtlasInfraCheck', 'shpurdpAtlasHbaseCheck']
        },
        {
          services: ['LOGSEARCH', 'SHPURDP_METRICS', 'SMARTSENSE'],
          errorsExpected: ['rangerCheck', 'atlasCheck', 'shpurdpLogsearchCheck']
        },
        {
          services: ['ATLAS', 'SHPURDP_METRICS', 'SMARTSENSE', 'RANGER'],
          errorsExpected: ['shpurdpRangerInfraCheck', 'shpurdpAtlasInfraCheck', 'shpurdpAtlasHbaseCheck']
        },
      ],
    ...
    controllerNames.forEach(function (name) {
      tests.forEach(function(test) {
        ...
        if (name !== 'installerController') {
          errorsExpected = test.errorsExpected.without('shpurdpMetricsCheck').without('smartSenseCheck').without('rangerCheck').without('atlasCheck');
        }
  ...
  describe('#serviceValidation', function () {
    ...
    var cases = [
      {
        services: ['HDFS'],
        isShpurdpMetricsWarning: false,
        title: 'Shpurdp Metrics not available'
      },
      {
        services: ['SHPURDP_METRICS'],
        isShpurdpMetricsSelected: false,
        isShpurdpMetricsWarning: true,
        title: 'Shpurdp Metrics not selected'
      },
      {
        services: ['SHPURDP_METRICS'],
        isShpurdpMetricsSelected: true,
        isShpurdpMetricsWarning: false,
        title: 'Shpurdp Metrics selected'
      }
    ];
    ...
    cases.forEach(function (item) {
      it(item.title, function () {
        controller.set('content', generateSelectedServicesContent(item.services));
        var ams = controller.findProperty('serviceName', 'SHPURDP_METRICS');
        if (item.services.contains('SHPURDP_METRICS')) {
          ams.set('isSelected', item.isShpurdpMetricsSelected);
        } else {
          controller.removeObject(ams);
        }
        controller.serviceValidation(Em.K, 'SHPURDP_METRICS', 'shpurdpMetricsCheck');
        expect(controller.get('errorStack').mapProperty('id').contains('shpurdpMetricsCheck')).to.equal(item.isShpurdpMetricsWarning);
      });
    });
