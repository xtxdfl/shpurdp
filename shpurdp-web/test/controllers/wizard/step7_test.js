...
describe('App.InstallerStep7Controller', function () {
  ...
  describe('#checkMySQLHost', function () {
    it('should send query', function () {
      ...
      var args = testHelpers.findAjaxRequest('name', 'shpurdp.service');
      expect(args).exists;
    });
  });
  ...
  describe('#setInstalledServiceConfigs', function () {
    ...
    var controller = App.WizardStep7Controller.create({
        installedServiceNames: ['HBASE', 'SHPURDP_METRICS']
      }),
      configs = [
        {
  ...
  describe('#getShpurdpDatabaseSuccess', function () {
      ...
      cases = [
        {
          ...
          title: 'no Shpurdp Server host components'
        },
        {
          data: {
            hostComponents: [
          ...
          mySQLServerConflict: false,
          title: 'Shpurdp MySQL Server and Hive Server are on the same host but different database types'
        },
        {
          data: {
            hostComponents: [
          ...
          title: 'Shpurdp MySQL Server and Hive Server are on the same host'
        },
        {
          data: {
            hostComponents: [
          ...
          mySQLServerConflict: false,
          title: 'Shpurdp MySQL Server and Hive Server are on different hosts'
        }
      ];

    cases.forEach(function (item) {
      it(item.title, function () {
        controller.getShpurdpDatabaseSuccess(item.data);
  ...
  describe('#addHawqConfigsOnNnHa', function () {
    var configs = [
      ...
      },
      {
        ...
        value: 'c6401.shpurdp.apache.org:8020',
        recommendedValue: 'c6401.shpurdp.apache.org:8020'
      },
      {
        ...
        value: 'c6402.shpurdp.apache.org:8020',
        recommendedValue: 'c6402.shpurdp.apache.org:8020'
      },
      {
        ...
        recommendedValue: 'c6401.shpurdp.apache.org:50070'
      },
      {
        ...
        value: 'c6402.shpurdp.apache.org:50070',
        recommendedValue: 'c6402.shpurdp.apache.org:50070'
      }
    ];
  ...
  describe('#addHawqConfigsOnRMHa', function () {
    var configs = [
      {
        ...
        recommendedValue: 'c6401.shpurdp.apache.org'
      },
      {
        id: 'yarn.resourcemanager.hostname.rm2__yarn-site',
        name: 'yarn.resourcemanager.hostname.rm2',
        value: 'c6402.shpurdp.apache.org',
        recommendedValue: 'c6402.shpurdp.apache.org'
      }
    ];
    ...
    it('yarn.resourcemanager.ha__yarn-client', function() {
      var expectedYarnRmHaValue = 'c6401.shpurdp.apache.org:8032,c6402.shpurdp.apache.org:8032';
    ...
    it('yarn.resourcemanager.scheduler.ha__yarn-client', function() {
      var expectedYarnRmSchedulerValue = 'c6401.shpurdp.apache.org:8030,c6402.shpurdp.apache.org:8030';
  ...
  describe('#setSkippedTabs', function () {
    ...
    beforeEach(function () {
      ...
      installerStep7Controller.set('content.selectedServiceNames', Em.A(["HDFS", "YARN", "MAPREDUCE2", "TEZ", "ZOOKEEPER", "SHPURDP_METRICS", "SMARTSENSE"]));
    });
    ...
    it('set tab "credentials"\'s properties "isDisabled" and "isSkipped" to false', function () {
      sinon.stub(App.Tab, 'find').returns([
        Em.Object.create({themeName: 'credentials', serviceName: 'SHPURDP_METRICS',}),
    ...
    it('set tab "databases"\'s properties "isDisabled" and "isSkipped" to false', function () {
      sinon.stub(App.Tab, 'find').returns([
        Em.Object.create({themeName: 'database', serviceName: 'SHPURDP_METRICS'}),
  ...
  describe('#showConfigProperty', function () {
    ...
    it('set props "isActive" to true in entered showConfigProperty event and "false" in all another stepConfigs', function() {
      ...
      installerStep7Controller.set('stepConfigs', Em.A([
        ...
        Em.Object.create({serviceName: 'SHPURDP_METRICS', isActive: false, configGroups: [{},{}]}),
      ...
      expect(installerStep7Controller.get('stepConfigs').findProperty('serviceName', 'SHPURDP_METRICS').get('isActive')).to.be.equal(true);
    });
