...
describe('App.ManageAlertNotificationsController', function () {
  ...
  describe('#fillEditCreateInputs()', function () {
    ...
    it("should map properties from selectedAlertNotification to inputFields (shpurdp.dispatch.recipients ignored) - EMAIL", function () {
      ...
      controller.set('selectedAlertNotification', Em.Object.create({
        ...
        properties: {
          ...
          "mail.smtp.from" : "from",
          "shpurdp.dispatch.credential.username" : "user",
          "mail.smtp.host" : "s1",
          "mail.smtp.port" : "25",
          "mail.smtp.auth" : "true",
          "shpurdp.dispatch.credential.password" : "pass",
    ...
    it("should map properties from selectedAlertNotification to inputFields (shpurdp.dispatch.recipients ignored) - SNMP", function () {
      ...
      controller.set('selectedAlertNotification', Em.Object.create({
        ...
        properties: {
          ...
          'customName': 'customValue',
          'shpurdp.dispatch.snmp.version': 'SNMPv1',
          'shpurdp.dispatch.snmp.oids.trap': '1',
          'shpurdp.dispatch.snmp.community': 'snmp',
          'shpurdp.dispatch.snmp.port': 161
      ...
      expect(JSON.stringify(controller.get('inputFields'))).to.equal(JSON.stringify({
        ...
        email: {
          value: 'c6401.shpurdp.apache.org, c6402.shpurdp.apache.org'
        },
        severityFilter: {
          value: ['OK', 'UNKNOWN']
        },
    ...
    it("should map properties from selectedAlertNotification to inputFields (shpurdp.dispatch.recipients ignored) - SHPURDP_SNMP", function () {

      controller.set('selectedAlertNotification', Em.Object.create({
        name: 'SHPURDP_SNMP_name',
        global: true,
        description: 'test_description',
        groups: ['test1', 'test2'],
        type: 'SHPURDP_SNMP',
        ...
        properties: {
          ...
          'customName': 'customValue',
          'shpurdp.dispatch.snmp.version': 'SNMPv1',
          'shpurdp.dispatch.snmp.community': 'public',
          'shpurdp.dispatch.snmp.port': 161
    ...
    it("should map properties from selectedAlertNotification to inputFields - ALERT_SCRIPT", function () {
          ...
          controller.set('selectedAlertNotification', Em.Object.create({
            ...
            alertStates: ['OK', 'UNKNOWN'],
            properties: {
              'shpurdp.dispatch-property.script': "com.mycompany.dispatch.syslog.script",
              'shpurdp.dispatch-property.script.filename': 'a.py',
              'customName': 'customValue'
            }
          }));
