...
describe('App.HighAvailabilityWizardStep7Controller', function() {
  ...
  describe('#initializeTasks', function() {
    ...
    it('removeTasks should be called', function() {
      ...
      expect(controller.removeTasks.calledWith(['startShpurdpInfra', 'startRanger', 'startMysqlServer'])).to.be.true;
    });
  });

  describe('#startShpurdpInfra', function() {
    beforeEach(function() {
    ...
    it('startServices should be called', function() {
      controller.startShpurdpInfra();
      expect(controller.startServices.calledWith(false, ['SHPURDP_INFRA_SOLR'], true)).to.be.true;
    });
  });
