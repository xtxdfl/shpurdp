  ...
  var serverConfigData = {
    items: [
      ...
      },
      {
        type: 'ranger-env',
        properties: {
          'xasecure.audit.destination.hdfs.dir': 'hdfs://c6401.shpurdp.apache.org/ranger/audit'
        }
      }
    ]
  };
  ...
  describe('#tweakServiceConfigs', function () {
    ...
    beforeEach(function () {
      ...
      sinon.stub(App.Service, 'find', function () {
        return [{serviceName: 'HDFS'}, {serviceName: 'HBASE'}, {serviceName: 'SHPURDP_METRICS'}, {serviceName: 'ACCUMULO'}, {serviceName: 'HAWQ'}, {serviceName: 'RANGER'}]
      });
    });
    ...
    beforeEach(function () {
      sinon.stub(App.Service, 'find', function () {
        return [
          ...
          Em.Object.create({serviceName: 'SHPURDP_METRICS'}),
