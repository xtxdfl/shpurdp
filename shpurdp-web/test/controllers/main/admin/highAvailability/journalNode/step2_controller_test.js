  ...
  describe('#setNameSpaceConfigs', function() {
    it('set moveJNConfig.configs', function() {
      ...
      controller.set('content', Em.Object.create({
        nameServiceId: 'b,c',
        masterComponentHosts: [
          {component: 'JOURNALNODE', hostName: 'c7403.shpurdp.apache.org'},
          {component: 'JOURNALNODE', hostName: 'c7402.shpurdp.apache.org'},
          {component: 'JOURNALNODE', hostName: 'c7401.shpurdp.apache.org'},
        ]
      }));
