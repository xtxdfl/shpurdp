...
describe('App.MainHostDetailsController', function () {
  ...
  describe('#constructZookeeperConfigUrlParams()', function () {
    ...
    it('ATLAS is installed, SHPURDP_INFRA_SOLR isn\'t installed', function () {
      loadService('ATLAS');
        ...
        e: {
          configs: {
            'application-properties': {
              ...
              'atlas.graph.index.search.solr.zookeeper-url': 'host1:2181/shpurdp-solr,host2:2181/shpurdp-solr',
  ...
  describe("#parseNnCheckPointTime", function () {
    var tests = [
      ...
      },
      {
        ...
        result: "c6401.shpurdp.apache.org"
      },
      {
