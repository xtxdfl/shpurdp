...
describe('App.usersMapper', function () {
  ...
  describe('#isAdmin', function() {
    var tests = [
      {i:["SHPURDP.ADMINISTRATOR"],e:true,m:'has admin role'},
      {i:["CLUSTER.USER", "SHPURDP.ADMINISTRATOR"],e:true,m:'has admin role'},
  ...
  describe('#isClusterUser', function() {
    var tests = [
      {i:["SHPURDP.ADMINISTRATOR", "CLUSTER.USER"],e:false,m:'is cluster user'},
