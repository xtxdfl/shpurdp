        ...
        alerts_summary_grouped: [
          {
            ...
            summary: {
              OK: {
                ...
                maintenance_count: 0,
                latest_text: "Connection failed: [Errno 111] Connection refused to c6407.shpurdp.apache.org:60000"
              },
              WARNING: {
                count: 1,
    ...
    it('should map summary info for 1st alert', function () {
      ...
      expect(App.AlertDefinition.find().findProperty('id', 1).get('summary')).to.eql({
        OK: {
          count: 1,
          maintenanceCount: 0,
          latestText: "Connection failed: [Errno 111] Connection refused to c6407.shpurdp.apache.org:60000"
        },
        WARNING: {
          count: 1,
          maintenanceCount: 0,
