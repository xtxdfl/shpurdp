...
describe('App.WidgetSectionMixin', function () {
  ...
  describe('#isShpurdpMetricsInstalled', function () {

    var cases = [
      {
        services: Em.A([]),
        isShpurdpMetricsInstalled: false,
        title: 'Shpurdp Metrics not installed'
      },
      {
        services: Em.A([
          {
        ...
        isShpurdpMetricsInstalled: true,
        title: 'Shpurdp Metrics installed'
      }
    ];
    ...
    cases.forEach(function (item) {
      it(item.title, function () {
        ...
        expect(mixin.get('isShpurdpMetricsInstalled')).to.equal(item.isShpurdpMetricsInstalled);
      });
    });
  });
