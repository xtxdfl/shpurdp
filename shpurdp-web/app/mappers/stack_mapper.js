...
App.stackMapper = App.QuickDataMapper.create({
  ...
  map: function(json) {
    ...
    //In case shpurdp_managed_repositories is undefined, set use_redhat_satellite to be false
    stack.use_redhat_satellite = item.operating_systems[0].OperatingSystems.shpurdp_managed_repositories === false;
