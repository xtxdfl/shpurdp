...
App.usersMapper = App.QuickDataMapper.create({
  ...
  isAdmin: function(permissionList) {
    ...
    return permissionList.indexOf('SHPURDP.ADMINISTRATOR') > -1 || permissionList.indexOf('CLUSTER.ADMINISTRATOR') > -1;
  },
  ...
  isOperator: function(permissionList) {
    return permissionList.indexOf('CLUSTER.ADMINISTRATOR') > -1 && !(permissionList.indexOf('SHPURDP.ADMINISTRATOR') > -1);
  },
