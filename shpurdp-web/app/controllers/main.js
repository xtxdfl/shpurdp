...
App.MainController = Em.Controller.extend({
  ...
  setShpurdpServerVersion: function (data) {
  ...
  monitorInactivity: function() {
    var timeout = Number(App.router.get('clusterController.shpurdpProperties')['user.inactivity.timeout.default']);
    var readonly_timeout = Number(App.router.get('clusterController.shpurdpProperties')['user.inactivity.timeout.role.readonly.default']);
