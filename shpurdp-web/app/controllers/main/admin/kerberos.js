...
App.MainAdminKerberosController = App.KerberosWizardStep4Controller.extend({
  ...
  errorCallback: function (jqXHR) {
    ...
    // jqXHR.status will be empty when browser cancels the request. Refer to SHPURDP-5921 for more info
    if (!!jqXHR.status) {
  ...
  prepareConfigProperties: function (configs) {
    ...
    configProperties.forEach(function (property, item, allConfigs) {
      ...
      // All user identity should be grouped under "Shpurdp Principals" category
