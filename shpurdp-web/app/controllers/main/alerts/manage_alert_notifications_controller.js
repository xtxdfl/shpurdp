...
App.ManageAlertNotificationsController = Em.Controller.extend({
  ...
  ignoredCustomProperties: [
    'shpurdp.dispatch.credential.password',
    'shpurdp.dispatch.credential.username',
    ...
    'shpurdp.dispatch-property.script',
    'shpurdp.dispatch-property.script.filename'
  ],
  ...
  fillEditCreateInputs: function (addCopyToName) {
    ...
    inputFields.set('email.value', properties['shpurdp.dispatch.recipients'] ?
      properties['shpurdp.dispatch.recipients'].join(', ') : '');
    ...
    inputFields.set('SMTPUsername.value', properties['shpurdp.dispatch.credential.username']);
    inputFields.set('SMTPPassword.value', properties['shpurdp.dispatch.credential.password']);
    inputFields.set('retypeSMTPPassword.value', properties['shpurdp.dispatch.credential.password']);
    ...
    inputFields.set('version.value', properties['shpurdp.dispatch.snmp.version']);
    inputFields.set('OIDs.value', properties['shpurdp.dispatch.snmp.oids.trap']);
    inputFields.set('community.value', properties['shpurdp.dispatch.snmp.community']);
    inputFields.set('host.value', properties['shpurdp.dispatch.recipients'] ?
      properties['shpurdp.dispatch.recipients'].join(', ') : '');
    inputFields.set('port.value', properties['shpurdp.dispatch.snmp.port']);
    ...
    inputFields.set('scriptDispatchProperty.value', properties['shpurdp.dispatch-property.script'] || '');
    inputFields.set('scriptFileName.value', properties['shpurdp.dispatch-property.script.filename'] || '');
  ...
  formatNotificationAPIObject: function () {
    ...
    if (inputFields.get('method.value') === 'EMAIL') {
      properties['shpurdp.dispatch.recipients'] = inputFields.get('email.value').replace(/\s/g, '').split(',');
      ...
      if (inputFields.get('SMTPUseAuthentication.value')) {
        properties['shpurdp.dispatch.credential.username'] = inputFields.get('SMTPUsername.value');
        properties['shpurdp.dispatch.credential.password'] = inputFields.get('SMTPPassword.value');
        properties['mail.smtp.starttls.enable'] = inputFields.get('SMTPSTARTTLS.value');
      }
    } else if(inputFields.get('method.value') === 'SNMP') {
      properties['shpurdp.dispatch.snmp.version'] = inputFields.get('version.value');
      properties['shpurdp.dispatch.snmp.community'] = inputFields.get('community.value');
      properties['shpurdp.dispatch.recipients'] = inputFields.get('host.value').replace(/\s/g, '').split(',');
      properties['shpurdp.dispatch.snmp.port'] = inputFields.get('port.value');
    } else if(inputFields.get('method.value') === 'Custom SNMP') {
      properties['shpurdp.dispatch.snmp.version'] = inputFields.get('version.value');
      properties['shpurdp.dispatch.snmp.oids.trap'] = inputFields.get('OIDs.value');
      properties['shpurdp.dispatch.snmp.oids.subject'] = inputFields.get('OIDs.value');
      properties['shpurdp.dispatch.snmp.oids.body'] = inputFields.get('OIDs.value');
      properties['shpurdp.dispatch.snmp.community'] = inputFields.get('community.value');
      properties['shpurdp.dispatch.recipients'] = inputFields.get('host.value').replace(/\s/g, '').split(',');
      properties['shpurdp.dispatch.snmp.port'] = inputFields.get('port.value');
      ...
      if( scriptDispatchProperty != '')
          properties['shpurdp.dispatch-property.script'] = scriptDispatchProperty;

      var scriptFileName = inputFields.get('scriptFileName.value').trim();
      if( scriptFileName != '')
          properties['shpurdp.dispatch-property.script.filename'] = scriptFileName;
    }
  ...
  getNotificationTypeText: function(notificationType) {
    ...
    } else if(notificationType === "SHPURDP_SNMP") {
