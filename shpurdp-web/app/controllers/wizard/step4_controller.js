...
App.WizardStep4Controller = Em.ArrayController.extend({
  ...
  validate: function () {
    ...
    if (this.get('wizardController.name') === 'installerController') {
      this.serviceValidation(callback, 'SHPURDP_METRICS', 'shpurdpMetricsCheck');
    ...
    this.dependentServiceValidation('RANGER', 'SHPURDP_INFRA_SOLR', 'shpurdpRangerInfraCheck', callback);
    this.dependentServiceValidation('ATLAS', 'SHPURDP_INFRA_SOLR', 'shpurdpAtlasInfraCheck', callback);
    this.dependentServiceValidation('ATLAS', 'HBASE', 'shpurdpAtlasHbaseCheck', callback);
    this.dependentServiceValidation('LOGSEARCH', 'SHPURDP_INFRA_SOLR', 'shpurdpLogsearchCheck', callback);
