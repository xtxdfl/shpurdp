...
App.WizardStep9Controller = Em.Controller.extend(App.ReloadPopupMixin, {
   ...
   * <code>
   *   {
   *     hostName: {String} Name of host that has stopped heartbeating to shpurdp-server
  ...
  /**
   * Load shpurdp property to determine if we should run service checks on deploy
   */
  ...
  /**
   *  Callback function Load shpurdp property to determine if we should run service checks on deploy
   * @param {Object} data
