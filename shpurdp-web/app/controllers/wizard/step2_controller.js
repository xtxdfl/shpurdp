...
App.WizardStep2Controller = Em.Controller.extend({
   ...
   * @type {string}
   */
  installType: Em.computed.ifThenElse('manualInstall', 'manualDriven', 'shpurdpDriven'),
  ...
  /**
   * Warn to manually install shpurdp-agent on each host
   ...
   * @method setShpurdpJavaHome
   */
  setShpurdpJavaHome: function () {
    App.ajax.send({
      name: 'shpurdp.service',
      sender: this,
      success: 'onGetShpurdpJavaHomeSuccess',
      error: 'onGetShpurdpJavaHomeError'
    });
  },

  /**
   * Set received java.home value
   * @method onGetShpurdpJavaHomeSuccess
   * @param {Object} data
   */
  onGetShpurdpJavaHomeSuccess: function (data) {
    this.set('content.installOptions.javaHome', data.RootServiceComponents.properties['java.home']);
  },

  /**
   * Set default java.home value
   * @method onGetShpurdpJavaHomeError
   */
  onGetShpurdpJavaHomeError: function () {
