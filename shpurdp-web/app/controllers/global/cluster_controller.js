...
App.ClusterController = Em.Controller.extend(App.ReloadPopupMixin, {
  ...
  loadShpurdpProperties: function () {
    return App.ajax.send({
      name: 'shpurdp.service',
      sender: this,
      success: 'loadShpurdpPropertiesSuccess',
      error: 'loadShpurdpPropertiesError'
    });
  },
  ...
  loadShpurdpPropertiesSuccess: function (data) {
    var mainController = App.router.get('mainController');
    this.set('shpurdpProperties', data.RootServiceComponents.properties);
    // Absence of 'jdk.name' and 'jce.name' properties says that shpurdp configured with custom jdk.
    ...
    mainController.setShpurdpServerVersion.call(mainController, data);
    mainController.monitorInactivity();
  },

  loadShpurdpPropertiesError: Em.K,
