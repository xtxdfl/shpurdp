...
App.ModalPopup = Ember.View.extend({
  ...
  fitHeight: function () {
    ...
    const popup = this.$().find('#modal'),
      ...
      wh = $(window).height(),
      ww = $(window).width(),
      topNavPaddingTop = 19, // from shpurdp-web/app/styles/common.less
      topNavFontSize = 20, // from shpurdp-web/app/styles/common.less
      topNavLineHeight = 1.3, // from shpurdp-web/app/styles/common.less
      modalMarginTopDefault = 10, // from shpurdp-web/app/styles/common.less
      modalMarginTopWide = 30, // from shpurdp-web/app/styles/common.less
      modalMarginTop = ww < 768 ? modalMarginTopDefault : modalMarginTopWide, // from shpurdp-web/vendor/styles/bootstrap.css
