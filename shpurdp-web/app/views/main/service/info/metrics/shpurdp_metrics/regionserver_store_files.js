...
App.ChartServiceMetricsAMS_RegionServerStoreFiles = App.ChartServiceMetricsAMS_RegionServerBaseView.extend({
  id: "service-metrics-shpurdp-metrics-region-server-store-files",
  title: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.storeFiles'),
  renderer: 'line',
  ajaxIndex: 'service.metrics.shpurdp_metrics.region_server.store_files',
  ...
  displayName: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.displayNames.storeFilesCount')
});