...
App.ChartServiceMetricsAMS_RegionServerCompactionQueueSize = App.ChartServiceMetricsAMS_RegionServerBaseView.extend({
  id: "service-metrics-shpurdp-metrics-region-server-compaction-queue-size",
  title: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.compactionQueueSize'),
  ajaxIndex: 'service.metrics.shpurdp_metrics.region_server.compaction_queue_size',
  ...
  displayName: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.displayNames.compactionQueueSize'),
