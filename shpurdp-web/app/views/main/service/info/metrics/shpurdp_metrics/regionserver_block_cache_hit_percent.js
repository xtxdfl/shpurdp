...
App.ChartServiceMetricsAMS_RegionServerBlockCacheHitPercent = App.ChartServiceMetricsAMS_RegionServerBaseView.extend({
  id: "service-metrics-shpurdp-metrics-region-server-block-cache-hit-percent",
  title: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.blockCacheHitPercent'),
  renderer: 'line',
  displayUnit: '%',
  ajaxIndex: 'service.metrics.shpurdp_metrics.region_server.block_cache_hit_percent',
  ...
  displayName: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.displayNames.blockCacheHitPercent'),
