...
App.ChartServiceMetricsAMS_RegionServerRegions = App.ChartServiceMetricsAMS_RegionServerBaseView.extend({
  id: "service-metrics-shpurdp-metrics-region-server-regions",
  title: Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.regions'),
  ajaxIndex: 'service.metrics.shpurdp_metrics.region_server.regions',
  ...
  displayName:  Em.I18n.t('services.service.info.metrics.shpurdpMetrics.regionServer.displayNames.regionsCount'),
