...
App.UpgradeVersionColumnView = App.UpgradeVersionBoxView.extend({
  ...
  adjustColumnWidth: function () {
    ...
    const reposCount = App.RepositoryVersion.find().filterProperty('isVisible').get('length'),
      ...
      columnBorderWidth = 1, // from shpurdp-web/app/styles/stack_versions.less
      columnPadding = 5, // from shpurdp-web/app/styles/stack_versions.less
      columnWrapperPadding = 7, // from shpurdp-web/app/styles/stack_versions.less
