...
App.ApplicationView = Em.View.extend({
  ...
  views: function () {
    return App.router.get('loggedIn') ? App.router.get('mainViewsController.visibleShpurdpViews') : [];
  }.property('App.router.mainViewsController.visibleShpurdpViews.[]', 'App.router.loggedIn'),
