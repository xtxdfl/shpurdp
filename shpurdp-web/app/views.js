...
require('views/main/service/info/metrics/shpurdp_metrics/master_average_load');
require('views/main/service/info/metrics/shpurdp_metrics/regionserver_base');
require('views/main/service/info/metrics/shpurdp_metrics/regionserver_store_files');
require('views/main/service/info/metrics/shpurdp_metrics/regionserver_regions');
require('views/main/service/info/metrics/shpurdp_metrics/regionserver_requests');
require('views/main/service/info/metrics/shpurdp_metrics/regionserver_block_cache_hit_percent');
require('views/main/service/info/metrics/shpurdp_metrics/regionserver_compaction_queue_size');
