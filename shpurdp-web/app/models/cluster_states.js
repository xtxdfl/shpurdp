...
App.clusterStatus = Em.Object.create(App.Persist, {
  ...
  getUserPrefSuccessCallback: function (response, opt, params) {
    ...
    // after upgrading shpurdp, loading local storage data from the "persist" data saved via an older version of
    // Shpurdp can result in missing namespaces that are defined in the new version of Shpurdp.
    App.db.mergeStorage();
  },
