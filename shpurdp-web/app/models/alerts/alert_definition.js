...
App.AlertDefinition = DS.Model.extend({
  ...
  isShpurdpService: Em.computed.equal('service._id', 'SHPURDP'),

  isShpurdpAgentComponent: Em.computed.equal('componentName', 'SHPURDP_AGENT'),

  isHostAlertDefinition: Em.computed.and('isShpurdpService', 'isShpurdpAgentComponent'),
   ...
   * cluster services - like Shpurdp-Server. This method unifies
