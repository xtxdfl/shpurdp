...
App.AlertInstance = DS.Model.extend({
  ...
  */  
  ...
  /**
   * Define if definition serviceName is Shpurdp
   * Used in some logic in templates to distinguish definitions with Shpurdp serviceName
   * @returns {boolean}
   */
  isShpurdpServiceName: Em.computed.equal('serviceName', 'SHPURDP'),
