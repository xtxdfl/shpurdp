...
module.exports =
{
  "haConfig": {
    ...
    configCategories: [
      ...
      App.ServiceConfigCategory.create({ name: 'SHPURDP_METRICS', displayName: 'Shpurdp Metrics'}),
    ...
    /**********************************************HDFS***************************************/
      ...
      },
      {
        "name": "hbase.rootdir",
        "displayName": "hbase.rootdir",
        "description": "Shpurdp Metrics service uses HBase as default storage backend. Set the rootdir for HBase to either local filesystem path if using Shpurdp Metrics in embedded mode or to a HDFS dir, example: hdfs://namenode.example.org:8020/amshbase.",
        "isReconfigurable": false,
        "recommendedValue": "file:///var/lib/shpurdp-metrics-collector/hbase",
        "value": "file:///var/lib/shpurdp-metrics-collector/hbase",
        "category": "SHPURDP_METRICS",
        "isVisible": false,
