...
module.exports = Em.Route.extend({
  ...
  enter: function (router) {
    ...
    router.get('mainViewsController').loadShpurdpViews();
  },
  ...
  shortViewDetails: Em.Route.extend({
    ...
    connectOutlets: function (router, params) {
      ...
      router.get('mainViewsController').dataLoading().done(function() {
        var content = App.router.get('mainViewsController.shpurdpViews').filterProperty('viewName', params.viewName).findProperty('shortUrl', slicedShortName)
