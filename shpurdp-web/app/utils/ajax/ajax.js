...
var urls = {
  ...
  'common.across.services.configurations': {
    'type': 'PUT',
    'real':'/clusters/{clusterName}',
    'mock':'/data/services/shpurdp.json',
    'format': function(data) {
      return {
        dataType: 'text',
        data: data.data
  ...
  'shpurdp.service.load_server_version': {
    'real': '/services/SHPURDP?fields=components/RootServiceComponents/component_version&components/RootServiceComponents/component_name=SHPURDP_SERVER&minimal_response=true',
    'mock': '/data/services/shpurdp.json'
  },
  ...
  'service.metrics.shpurdp_metrics.master.average_load': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields=metrics/hbase/master/AverageLoad[{fromSeconds},{toSeconds},{stepSeconds}]',
    'mock': '/data/services/metrics/shpurdp_metrics/master_average_load.json',
    'testInProduction': true
  },
  'service.metrics.shpurdp_metrics.region_server.store_files': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields=metrics/hbase/regionserver/storefiles[{fromSeconds},{toSeconds},{stepSeconds}]',
    'mock': '/data/services/metrics/shpurdp_metrics/regionserver_store_files.json',
    'testInProduction': true
  },
  'service.metrics.shpurdp_metrics.region_server.regions': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields=metrics/hbase/regionserver/regions[{fromSeconds},{toSeconds},{stepSeconds}]',
    'mock': '/data/services/metrics/shpurdp_metrics/regionserver_regions.json',
    'testInProduction': true
  },
  'service.metrics.shpurdp_metrics.region_server.request': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields=metrics/hbase/regionserver/requests._rate[{fromSeconds},{toSeconds},{stepSeconds}]',
    'mock': '/data/services/metrics/shpurdp_metrics/regionserver_requests.json',
    'testInProduction': true
  },
  'service.metrics.shpurdp_metrics.region_server.block_cache_hit_percent': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields=metrics/hbase/regionserver/blockCacheHitPercent[{fromSeconds},{toSeconds},{stepSeconds}]',
    'mock': '/data/services/metrics/shpurdp_metrics/regionserver_blockcache_hitpercent.json',
    'testInProduction': true
  },
  'service.metrics.shpurdp_metrics.region_server.compaction_queue_size': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields=metrics/hbase/regionserver/compactionQueueSize[{fromSeconds},{toSeconds},{stepSeconds}]',
    'mock': '/data/services/metrics/shpurdp_metrics/regionserver_compaction_queue_size.json',
    'testInProduction': true
  },
  'service.metrics.shpurdp_metrics.aggregated': {
    'real': '/clusters/{clusterName}/services/SHPURDP_METRICS/components/METRICS_COLLECTOR?fields={fields}',
    'mock': '/data/services/metrics/shpurdp_metrics/master_average_load.json',
    'testInProduction': true
  },
  ...
  'shpurdp.service': {
    'real': '/services/SHPURDP/components/SHPURDP_SERVER{fields}',
    'mock': '/data/services/shpurdp_server.json'
  },
        ...
        data: JSON.stringify({
          "RequestInfo": {
            ...
            "parameters":{
              ...
              "jdk_location": data.jdk_location,
              "threshold":"60",
              "shpurdp_server_host": "c6403.shpurdp.apache.org",
