...
import org.apache.shpurdp.server.orm.dao.HostRoleCommandDAO.LastServiceCheckDTO;
...
public class ServiceCheckValidityCheckTest {
  ...
  public void setUp() throws Exception {
    ...
    shpurdpMetaInfo = mock(ShpurdpMetaInfo.class);
    ...
    serviceCheckValidityCheck.shpurdpMetaInfo = new Provider<ShpurdpMetaInfo>() {
      @Override
    ...
    when(shpurdpMetaInfo.isServiceWithNoConfigs(Mockito.anyString(), Mockito.anyString(),
  ...
  @Test
  public void testWithNullCommandDetailAtCommand() throws ShpurdpException {
  ...
  @Test
  public void testFailWhenServiceWithOutdatedServiceCheckExists() throws ShpurdpException {
    ServiceComponent serviceComponent = mock(ServiceComponent.class);
    when(serviceComponent.isVersionAdvertised()).thenReturn(true);
  ...
  @Test
  public void testFailWhenServiceWithNoServiceCheckExists() throws ShpurdpException {
    ServiceComponent serviceComponent = mock(ServiceComponent.class);
    when(serviceComponent.isVersionAdvertised()).thenReturn(true);
  ...
  @Test
  public void testFailWhenServiceWithOutdatedServiceCheckExistsRepeated() throws ShpurdpException {
    ServiceComponent serviceComponent = mock(ServiceComponent.class);
    when(serviceComponent.isVersionAdvertised()).thenReturn(true);
   ...
   */
  @Test
  public void testPassWhenSimilarlyNamedServiceIsOutdated() throws ShpurdpException {
    ServiceComponent serviceComponent = mock(ServiceComponent.class);
    when(serviceComponent.isVersionAdvertised()).thenReturn(true);
