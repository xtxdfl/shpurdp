...
import org.apache.shpurdp.server.alerts.ShpurdpPerformanceRunnable.PerformanceArea;
...
/**
 * Tests {@link ShpurdpPerformanceRunnable}.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ ClusterControllerHelper.class, ShpurdpPerformanceRunnable.class,
    PerformanceArea.class })
public class ShpurdpPerformanceRunnableTest {

  private final static long CLUSTER_ID = 1;
  private final static String CLUSTER_NAME = "c1";

  private final static String DEFINITION_NAME = "shpurdp_server_performance";
  private final static String DEFINITION_SERVICE = "SHPURDP";
  private final static String DEFINITION_COMPONENT = "SHPURDP_SERVER";
  ...
  public void testAlertFiresOKEvent() {
    ...
    ShpurdpPerformanceRunnable runnable = new ShpurdpPerformanceRunnable(
    ...
    assertEquals("SHPURDP", alert.getService());
    assertEquals("SHPURDP_SERVER", alert.getComponent());
