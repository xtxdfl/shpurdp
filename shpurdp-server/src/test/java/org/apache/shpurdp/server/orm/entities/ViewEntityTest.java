...
import org.apache.shpurdp.server.view.ViewSubResourceDefinition;
import org.apache.shpurdp.server.view.configuration.ResourceConfig;
import org.apache.shpurdp.server.view.configuration.ResourceConfigTest;
...
public class ViewEntityTest {
  ...
  public static ViewEntity getViewEntity(ViewConfig viewConfig) throws Exception {
    ...
    ViewEntity viewEntity = new ViewEntity(viewConfig, shpurdpConfig, "view.jar");
  ...
  public void testSetGetConfiguration() throws Exception {
    ...
    ViewConfig newViewConfig = ViewConfigTest.getConfig(with_shpurdp_versions);
  ...
  public void testIsClusterConfigurable() throws Exception {
    ...
    newViewConfig = ViewConfigTest.getConfig(with_shpurdp_versions);
    viewDefinition.setConfiguration(newViewConfig);
    Assert.assertFalse(viewDefinition.isClusterConfigurable());
  }

  @Test
  public void testGetShpurdpProperty() throws Exception {
    ViewConfig viewConfig = ViewConfigTest.getConfig();
    ViewEntity viewDefinition = getViewEntity(viewConfig);
    Assert.assertEquals("v1", viewDefinition.getShpurdpProperty("p1"));
    Assert.assertEquals("v2", viewDefinition.getShpurdpProperty("p2"));
    Assert.assertEquals("v3", viewDefinition.getShpurdpProperty("p3"));
  }
  ...
  @Test
  public void testGetShpurdpConfiguration() throws Exception {
    ViewEntity viewDefinition = getViewEntity();
    Configuration configuration = viewDefinition.getShpurdpConfiguration();
