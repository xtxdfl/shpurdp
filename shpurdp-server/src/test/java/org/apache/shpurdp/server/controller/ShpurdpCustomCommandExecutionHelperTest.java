...
import org.apache.shpurdp.server.orm.entities.ServiceComponentVersionEntity;
...
import org.apache.shpurdp.server.state.UserGroupInfo;
...
public class ShpurdpCustomCommandExecutionHelperTest {
  ...
  public void setup() throws Exception {
    ...
    shpurdpManagementController = injector.getInstance(ShpurdpManagementController.class);
    ...
    EasyMock.expect(hostRoleCommand.getRole()).andReturn(Role.SHPURDP_SERVER_ACTION);
  ...
  public void testRefreshQueueCustomCommand() throws Exception {
    ...
    shpurdpManagementController.createAction(actionRequest, requestProperties);
  ...
  public void testServiceCheckComponentWithEmptyHosts() throws Exception {
    ...
    ShpurdpCustomCommandExecutionHelper shpurdpCustomCommandExecutionHelper = injector.getInstance(ShpurdpCustomCommandExecutionHelper.class);
    ...
    shpurdpCustomCommandExecutionHelper.addExecutionCommandsToStage(actionExecutionContext, stage, new HashMap<>(), null);
   ...
   * This should cause Shpurdp to randomly pick one of the ZOOKEEPER_CLIENT hosts.
  ...
  public void testIsTopologyRefreshRequired() throws Exception {
    ShpurdpCustomCommandExecutionHelper helper = injector.getInstance(ShpurdpCustomCommandExecutionHelper.class);
  ...
  private void createClusterFixture(String clusterName, StackId stackId,
    String respositoryVersion, String hostPrefix) throws ShpurdpException, AuthorizationException, NoSuchFieldException, IllegalAccessException {
  ...
  private void addHost(String hostname, String clusterName) throws ShpurdpException {
  ...
  private void createCluster(String clusterName, String stackVersion) throws ShpurdpException, AuthorizationException {
    ClusterRequest r = new ClusterRequest(null, clusterName, State.INSTALLED.name(),
        SecurityType.NONE, stackVersion, null);
    shpurdpManagementController.createCluster(r);
  }

  private void createService(String clusterName, String serviceName,
      RepositoryVersionEntity repositoryVersion) throws ShpurdpException, AuthorizationException, NoSuchFieldException, IllegalAccessException {
    ...
    ServiceResourceProviderTest.createServices(shpurdpManagementController,
  ...
  private void createServiceComponent(String clusterName,
    ...
    Set<ServiceComponentRequest> requests =
      new HashSet<>();
    requests.add(r);
    ComponentResourceProviderTest.createComponents(shpurdpManagementController, requests);
  }
  ...
  private void createServiceComponentHost(String clusterName, String serviceName, String componentName, String hostname, State desiredState)
    ...
    Set<ServiceComponentHostRequest> requests =
      new HashSet<>();
    requests.add(r);
    shpurdpManagementController.createHostComponents(requests);
  }
