...
public class TestAuthenticationFactory {
  ...
  public static Authentication createAdministrator(String name) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createAdministratorGrantedAuthority()));
  }
  ...
  public static Authentication createClusterAdministrator(String name, Long clusterResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createClusterAdministratorGrantedAuthority(clusterResourceId)));
  }

  public static Authentication createClusterOperator(String name, Long clusterResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createClusterOperatorGrantedAuthority(clusterResourceId)));
  }
  ...
  public static Authentication createServiceAdministrator(String name, Long clusterResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createServiceAdministratorGrantedAuthority(clusterResourceId)));
  }
  ...
  public static Authentication createServiceOperator(String name, Long clusterResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createServiceOperatorGrantedAuthority(clusterResourceId)));
  }
  ...
  public static Authentication createClusterUser(String name, Long clusterResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createClusterUserGrantedAuthority(clusterResourceId)));
  }
  ...
  public static Authentication createViewUser(String name, Long viewResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.singleton(createViewUserGrantedAuthority(viewResourceId)));
  }
  ...
  public static Authentication createNoRoleUser(String name, Long clusterResourceId) {
    return createShpurdpUserAuthentication(1, name, Collections.emptySet());
  }

  private static GrantedAuthority createAdministratorGrantedAuthority() {
    return new ShpurdpGrantedAuthority(createAdministratorPrivilegeEntity());
  }

  private static GrantedAuthority createClusterAdministratorGrantedAuthority(Long clusterResourceId) {
    return new ShpurdpGrantedAuthority(createClusterAdministratorPrivilegeEntity(clusterResourceId));
  }

  private static GrantedAuthority createClusterOperatorGrantedAuthority(Long clusterResourceId) {
    return new ShpurdpGrantedAuthority(createClusterOperatorPrivilegeEntity(clusterResourceId));
  }

  private static GrantedAuthority createServiceAdministratorGrantedAuthority(Long clusterResourceId) {
    return new ShpurdpGrantedAuthority(createServiceAdministratorPrivilegeEntity(clusterResourceId));
  }

  private static GrantedAuthority createServiceOperatorGrantedAuthority(Long clusterResourceId) {
    return new ShpurdpGrantedAuthority(createServiceOperatorPrivilegeEntity(clusterResourceId));
  }

  private static GrantedAuthority createClusterUserGrantedAuthority(Long clusterResourceId) {
    return new ShpurdpGrantedAuthority(createClusterUserPrivilegeEntity(clusterResourceId));
  }

  private static GrantedAuthority createViewUserGrantedAuthority(Long resourceId) {
    return new ShpurdpGrantedAuthority(createViewUserPrivilegeEntity(resourceId));
  }
  ...
  private static PrivilegeEntity createAdministratorPrivilegeEntity() {
    return createPrivilegeEntity(createShpurdpResourceEntity(), createAdministratorPermission(), null);
  }
  ...
  public static PermissionEntity createAdministratorPermission() {
    ...
    permissionEntity.setId(PermissionEntity.SHPURDP_ADMINISTRATOR_PERMISSION);
    permissionEntity.setResourceType(createResourceTypeEntity(ResourceType.SHPURDP));
  ...
  private static ResourceEntity createShpurdpResourceEntity() {
    ResourceEntity resourceEntity = new ResourceEntity();
    resourceEntity.setId(null);
    resourceEntity.setResourceType(createResourceTypeEntity(ResourceType.SHPURDP));
  ...
  private static Authentication createShpurdpUserAuthentication(int userId, String username, Set<GrantedAuthority> authorities) {
    ...
    return new ShpurdpUserAuthentication(null, new ShpurdpUserDetailsImpl(new User(userEntity), null, authorities), true);
  }
}
