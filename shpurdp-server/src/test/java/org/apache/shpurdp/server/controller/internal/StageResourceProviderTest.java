...
public class StageResourceProviderTest {
  ...
  private ShpurdpManagementController managementController = null;
  ...
  public void before() {
    ...
    managementController = createNiceMock(ShpurdpManagementController.class);
  ...
  private class MockModule implements Module {
    ...
    public void configure(Binder binder) {
      ...
      binder.bind(ShpurdpManagementController.class).toInstance(managementController);
