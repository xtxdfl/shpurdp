...
import org.apache.shpurdp.server.stageplanner.RoleGraphNode;
...
public class RoleGraphTest {
  ...
  @Test
  public void testValidateOrder() throws ShpurdpException {
   ...
   */
  @Test
  public void testGetOrderedHostRoleCommands() throws ShpurdpException {
    ClusterImpl cluster = mock(ClusterImpl.class);
    when(cluster.getCurrentStackVersion()).thenReturn(new StackId("HDP-2.0.6"));
    when(cluster.getClusterId()).thenReturn(1L);
