...
public class ShpurdpLdapUtilsTest {
  ...
  public void testIsUserPrincipalNameFormat_True() throws Exception {
    ...
    // When
    boolean isUserPrincipalNameFormat = ShpurdpLdapUtils.isUserPrincipalNameFormat(testLoginName);
  ...
  public void testIsLdapObjectOutOfScopeFromBaseDn() throws NamingException {
    ...
    // WHEN
    boolean isOutOfScopeFromBaseDN = ShpurdpLdapUtils.isLdapObjectOutOfScopeFromBaseDn(adapter, "dc=apache,dc=org");
    // THEN
  ...
  public void testIsLdapObjectOutOfScopeFromBaseDn_dnOutOfScope() throws NamingException {
    ...
    // WHEN
    boolean isOutOfScopeFromBaseDN = ShpurdpLdapUtils.isLdapObjectOutOfScopeFromBaseDn(adapter, "dc=apache,dc=org,ou=custom");
    // THEN
  ...
  public void testGetFullDn() throws Exception {
    ...
    fullDn = ShpurdpLdapUtils.getFullDn(absoluteDn, adapterFullDn);
    Assert.assertEquals(absoluteDn, fullDn);

    fullDn = ShpurdpLdapUtils.getFullDn(absoluteDn, adapterBaseDn);
    Assert.assertEquals(absoluteDn, fullDn);

    fullDn = ShpurdpLdapUtils.getFullDn(relativeDn, adapterBaseDn);
    Assert.assertEquals(absoluteDn, fullDn);
    // ****************************
    ...
    fullDn = ShpurdpLdapUtils.getFullDn(absoluteDn.toString(), adapterFullDn);
    Assert.assertEquals(absoluteDn, fullDn);

    fullDn = ShpurdpLdapUtils.getFullDn(absoluteDn.toString(), adapterBaseDn);
    Assert.assertEquals(absoluteDn, fullDn);

    fullDn = ShpurdpLdapUtils.getFullDn(relativeDn.toString(), adapterBaseDn);
    Assert.assertEquals(absoluteDn, fullDn);
    // ****************************
    ...
    fullDn = ShpurdpLdapUtils.getFullDn(absoluteDn, nameInNamespaceFullDn);
    Assert.assertEquals(absoluteDn, fullDn);

    fullDn = ShpurdpLdapUtils.getFullDn(absoluteDn, nameInNamespaceBaseDn);
    Assert.assertEquals(absoluteDn, fullDn);

    fullDn = ShpurdpLdapUtils.getFullDn(relativeDn, nameInNamespaceBaseDn);
    Assert.assertEquals(absoluteDn, fullDn);
