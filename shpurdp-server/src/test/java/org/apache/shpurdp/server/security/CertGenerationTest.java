...
public class CertGenerationTest {
  ...
  public static void setUpBeforeClass() throws IOException {
    ...
    try {
      ...
      if (System.getProperty("os.name").contains("Windows")) {
        ...
        content = content.replaceAll("/var/lib/shpurdp-server/keys/db", temp.getRoot().getAbsolutePath());
      }
  ...
  @Ignore // randomly fails on BAO (e.g. https://builds.apache.org/job/Shpurdp-branch-2.2/155/console)
  @Test
