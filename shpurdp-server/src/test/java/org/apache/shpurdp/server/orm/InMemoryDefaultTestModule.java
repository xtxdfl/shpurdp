...
import org.apache.shpurdp.server.mpack.MpackManagerMock;
...
public class InMemoryDefaultTestModule extends AbstractModule {
   ...
   * In this implementation scan for {@link org.apache.shpurdp.server.EagerSingleton}
   * and {@link org.apache.shpurdp.server.StaticallyInject} and
   * {@link org.apache.shpurdp.server.ShpurdpService} annotations will not be run for every test.
   */
