...
/**
 * {@link org.apache.shpurdp.server.upgrade.UpgradeCatalog252} unit tests.
 */
...
public class UpgradeCatalog252Test {
  ...
  public void testExecuteDDLUpdates() throws Exception {
    ...
    Injector injector = getInjector(createMock(Clusters.class), createNiceMock(ShpurdpManagementControllerImpl.class));
  ...
  @Test
  public void testFixLivySuperUsers() throws ShpurdpException {
    ...
    final ShpurdpManagementController controller = createMock(ShpurdpManagementController.class);
    ...
    expect(zeppelinEnv.getProperties()).andReturn(Collections.singletonMap("zeppelin.server.kerberos.principal", "zeppelin_user@SHPURDP.LOCAL")).once();
  ...
  @Test
  public void testUpdateKerberosDescriptorArtifact() throws ShpurdpException {
    String initialJson = "{" +
        "  \"services\": [" +
        "    {" +
        "      \"name\": \"SPARK\"," +
  ...
  private Injector getInjector(Clusters clusters, ShpurdpManagementController shpurdpManagementController) {
