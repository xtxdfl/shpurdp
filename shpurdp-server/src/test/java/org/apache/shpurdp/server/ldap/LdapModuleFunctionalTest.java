...
import org.apache.shpurdp.server.ldap.service.ads.LdapConnectionTemplateFactory;
...
public class LdapModuleFunctionalTest {
  ...
  public void shouldLdapTemplateBeInstantiated() throws Exception {
    ...
    ShpurdpLdapConfiguration ldapConfiguration = new ShpurdpLdapConfiguration(getProps());
  ...
  private static Map<String, String> getProps() {
    ...
    ldapPropsMap.put(ShpurdpServerConfigurationKey.ANONYMOUS_BIND.key(), "true");
    ldapPropsMap.put(ShpurdpServerConfigurationKey.SERVER_HOST.key(), "ldap.forumsys.com");
    ldapPropsMap.put(ShpurdpServerConfigurationKey.SERVER_PORT.key(), "389");
    ldapPropsMap.put(ShpurdpServerConfigurationKey.BIND_DN.key(), "cn=read-only-admin,dc=example,dc=com");
    ldapPropsMap.put(ShpurdpServerConfigurationKey.BIND_PASSWORD.key(), "password");
//    ldapPropsMap.put(ShpurdpLdapConfigKeys.USE_SSL.key(), "true");

    ldapPropsMap.put(ShpurdpServerConfigurationKey.USER_OBJECT_CLASS.key(), SchemaConstants.PERSON_OC);
    ldapPropsMap.put(ShpurdpServerConfigurationKey.USER_NAME_ATTRIBUTE.key(), SchemaConstants.UID_AT);
    ldapPropsMap.put(ShpurdpServerConfigurationKey.USER_SEARCH_BASE.key(), "dc=example,dc=com");
    ldapPropsMap.put(ShpurdpServerConfigurationKey.DN_ATTRIBUTE.key(), SchemaConstants.UID_AT);
//    ldapPropsMap.put(ShpurdpLdapConfigKeys.TRUST_STORE.key(), "custom");
    ldapPropsMap.put(ShpurdpServerConfigurationKey.TRUST_STORE_TYPE.key(), "JKS");
//    ldapPropsMap.put(ShpurdpLdapConfigKeys.TRUST_STORE_PATH.key(), "/Users/lpuskas/my_truststore/KeyStore.jks");
