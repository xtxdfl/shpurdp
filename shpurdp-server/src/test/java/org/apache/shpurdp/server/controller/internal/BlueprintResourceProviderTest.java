...
import org.apache.shpurdp.server.controller.internal.BlueprintResourceProvider.BlueprintConfigPopulationStrategy;
import org.apache.shpurdp.server.controller.internal.BlueprintResourceProvider.BlueprintConfigPopulationStrategyV1;
import org.apache.shpurdp.server.controller.internal.BlueprintResourceProvider.BlueprintConfigPopulationStrategyV2;
...
import org.apache.shpurdp.server.orm.entities.BlueprintConfigEntity;
import org.apache.shpurdp.server.orm.entities.BlueprintConfiguration;
import org.apache.shpurdp.server.orm.entities.BlueprintEntity;
import org.apache.shpurdp.server.orm.entities.BlueprintSettingEntity;
import org.apache.shpurdp.server.orm.entities.HostGroupComponentEntity;
import org.apache.shpurdp.server.orm.entities.HostGroupEntity;
...
public class BlueprintResourceProviderTest {
  ...
  private final static ShpurdpMetaInfo metaInfo = createMock(ShpurdpMetaInfo.class);
  ...
  public void testCreateResources_TopologyValidationFails() throws Exception {
    ...
    ResourceProvider provider = AbstractControllerResourceProvider.getResourceProvider(
        Resource.Type.Blueprint,
        createMock(ShpurdpManagementController.class));
  ...
  public void testGetResourcesNoPredicate_withConfiguration() throws SystemException, UnsupportedPropertyException,
      NoSuchParentResourceException, NoSuchResourceException, ShpurdpException {
