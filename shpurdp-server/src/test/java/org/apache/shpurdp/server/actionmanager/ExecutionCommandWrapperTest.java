...
public class ExecutionCommandWrapperTest {
  ...
  private static final String HOST1 = "dev01.shpurdp.apache.org";
  ...
  @BeforeClass
  public static void setup() throws ShpurdpException {
  ...
  private static void createTask(ActionDBAccessor db, long requestId, long stageId, String hostName, String clusterName) throws ShpurdpException {
  ...
  @Test
  public void testGetExecutionCommand() throws JSONException, ShpurdpException {
  ...
  public void testExecutionCommandHasVersionInfoWithoutCurrentClusterVersion()
      throws JSONException, ShpurdpException {
  ...
  @AfterClass
  public static void tearDown() throws ShpurdpException, SQLException {
