...
public class ServicePropertiesTest {
   ...
   * during shpurdp upgrade and/or stack upgrade.
   *
   * @throws SAXException
   * @throws IOException
   */
  ...
  /**
   * Looks for directory under shpurdp-server/src/main/resources/ path.
  ...
  /**
   * Resolves File of shpurdp-server/src/test/resources/ folder.
   * Determines path based on TestAmbaryServer.samples folder in test resources
   * Should not depend on how and from which location the shpurdp-server
   * was started.
   * @return File of shpurdp-server/src/test/resources/ folder.
   */
