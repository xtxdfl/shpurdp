...
public class PluginUpgradeServerActionTest extends EasyMockSupport {
  ...
  private final ShpurdpMetaInfo m_mockMetaInfo = createNiceMock(ShpurdpMetaInfo.class);
  private final ShpurdpManagementController m_mockController = createNiceMock(ShpurdpManagementController.class);
