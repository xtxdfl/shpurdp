...
import org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.ConfigurationPackBuilder;
...
import org.apache.shpurdp.server.stack.ModuleFileUnmarshaller;
...
public class ConfigUpgradeValidityTest {
  ...
  public void testConfigurationDefinitionsExist() throws Exception {
    Collection<StackInfo> stacks = shpurdpMetaInfo.getStacks();
    ...
    for( StackInfo stack : stacks ){
      ...
      Map<String, UpgradePack> upgradePacks = shpurdpMetaInfo.getUpgradePacks(stack.getName(), stack.getVersion());
