...
import org.apache.shpurdp.server.audit.event.request.AddAlertTargetRequestAuditEvent;
import org.apache.shpurdp.server.audit.event.request.ChangeAlertTargetRequestAuditEvent;
import org.apache.shpurdp.server.audit.event.request.DeleteAlertTargetRequestAuditEvent;
import org.apache.shpurdp.server.audit.request.eventcreator.AlertTargetEventCreator;
...
import org.apache.shpurdp.server.notifications.dispatchers.EmailDispatcher;
...
public class AlertTargetEventCreatorTest extends AuditEventCreatorTestBase {
  ...
  public void postTest() {
    ...
    properties.put(AlertTargetResourceProvider.ALERT_TARGET_PROPERTIES + "/" + AlertNoticeDispatchService.SHPURDP_DISPATCH_RECIPIENTS, Arrays.asList("a@a.com","b@b.com","c@c.com"));
