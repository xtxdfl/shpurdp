...
import org.apache.shpurdp.server.api.services.BaseServiceTest;
...
public class ProxyServiceTest extends BaseServiceTest {
  ...
  public void testProxyGetRequest() throws Exception {
    ...
    headerParams.add("ShpurdpProxy-User-Remote","testuser");
    ...
    expect(getHttpHeaders().getRequestHeader("ShpurdpProxy-User-Remote")).andReturn(userRemoteParams);
