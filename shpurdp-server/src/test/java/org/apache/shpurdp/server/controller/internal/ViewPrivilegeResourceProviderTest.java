...
public class ViewPrivilegeResourceProviderTest {
  ...
  public void testGetResources() throws Exception {
    ...
    Assert.assertEquals("VIEW.USER", resource.getPropertyValue(ShpurdpPrivilegeResourceProvider.PERMISSION_NAME));
    Assert.assertEquals("View User", resource.getPropertyValue(ShpurdpPrivilegeResourceProvider.PERMISSION_LABEL));
    Assert.assertEquals("joe", resource.getPropertyValue(ShpurdpPrivilegeResourceProvider.PRINCIPAL_NAME));
