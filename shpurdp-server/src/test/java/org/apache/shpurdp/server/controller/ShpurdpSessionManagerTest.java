...
public class ShpurdpSessionManagerTest {

  @Test
  public void testGetCurrentSessionId() throws Exception {

    HttpSession session = createNiceMock(HttpSession.class);
    ShpurdpSessionManager sessionManager =
        createMockBuilder(ShpurdpSessionManager.class).addMockedMethod("getHttpSession").createMock();
  ...
  public void testGetSessionCookie() throws Exception {
    ...
    ShpurdpSessionManager shpurdpSessionManager = new ShpurdpSessionManager();

    shpurdpSessionManager.sessionHandler = sessionHandler;
    ...
    assertEquals("SESSION_COOKIE", shpurdpSessionManager.getSessionCookie());
