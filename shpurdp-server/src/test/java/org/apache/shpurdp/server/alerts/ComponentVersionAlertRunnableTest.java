...
public class ComponentVersionAlertRunnableTest extends EasyMockSupport {
  ...
  private final static String HOSTNAME_1 = "c6401.shpurdp.apache.org";
  private final static String HOSTNAME_2 = "c6402.shpurdp.apache.org";

  private final static String EXPECTED_VERSION = "2.6.0.0-1234";
  private final static String WRONG_VERSION = "9.9.9.9-9999";

  private final static String DEFINITION_NAME = "shpurdp_server_component_version";
  ...
  public void setup() throws Exception {
    ...
    m_metaInfo = m_injector.getInstance(ShpurdpMetaInfo.class);
