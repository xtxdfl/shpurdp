...
public class StackUpgradeConfigurationMergeTest extends EasyMockSupport {
  ...
  private class MockModule implements Module {
    ...
    public void configure(Binder binder) {
      ...
      binder.bind(ShpurdpManagementController.class).toInstance(createNiceMock(ShpurdpManagementController.class));
      ...
      binder.bind(ShpurdpLdapConfigurationProvider.class).toInstance(createMock(ShpurdpLdapConfigurationProvider.class));
