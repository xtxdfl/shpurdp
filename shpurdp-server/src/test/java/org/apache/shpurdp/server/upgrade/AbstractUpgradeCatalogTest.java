...
public class AbstractUpgradeCatalogTest {
  ...
  @Before
  public void init() throws ShpurdpException {
    ...
    expect(injector.getInstance(ShpurdpManagementController.class)).andReturn(amc).anyTimes();
  ...
  @Test
  public void shouldAddConfigurationFromXml() throws ShpurdpException {
  ...
  @Test
  public void shouldUpdateConfigurationFromXml() throws ShpurdpException {
  ...
  @Test
  public void shouldDeleteConfigurationFromXml() throws ShpurdpException {
  ...
  private static PropertyInfo createProperty(String filename, String name, boolean add, boolean update, boolean delete) {
    ...
    propertyInfo.setPropertyShpurdpUpgradeBehavior(new PropertyUpgradeBehavior(add, delete, update));
    return propertyInfo;
  }
}