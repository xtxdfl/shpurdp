...
public class KerberosServiceDescriptorTest {
  ...
  private KerberosServiceDescriptor createFromJSON() throws ShpurdpException {
    return KERBEROS_SERVICE_DESCRIPTOR_FACTORY.createInstance("SERVICE_NAME", JSON_VALUE);
  }

  private KerberosServiceDescriptor[] createMultipleFromJSON() throws ShpurdpException {
    return KERBEROS_SERVICE_DESCRIPTOR_FACTORY.createInstances(JSON_VALUE_SERVICES);
  }

  private KerberosServiceDescriptor createFromMap() throws ShpurdpException {
  ...
  @Test
  public void testJSONDeserialize() throws ShpurdpException {
    validateFromJSON(createFromJSON());
  }

  @Test
  public void testJSONDeserializeMultiple() throws ShpurdpException {
  ...
  public void testInvalid() {
    ...
    try {
      ...
      Assert.fail("Should have thrown ShpurdpException.");
  ...
  @Test
  public void testMapDeserialize() throws ShpurdpException {
    validateFromMap(createFromMap());
  }

  @Test
  public void testEquals() throws ShpurdpException {
    Assert.assertTrue(createFromJSON().equals(createFromJSON()));
    Assert.assertFalse(createFromJSON().equals(createFromMap()));
  }

  @Test
  public void testToMap() throws ShpurdpException {
    Gson gson = new Gson();
  ...
  @Test
  public void testUpdate() throws ShpurdpException {
   ...
   */
  @Test
  public void testJSONWithOnlyServiceNameAndConfigurations() throws ShpurdpException {
