...
import org.apache.shpurdp.server.state.alert.AggregateDefinitionMapping;
import org.apache.shpurdp.server.state.alert.AggregateSource;
...
import org.apache.shpurdp.server.state.alert.Reporting.ReportTemplate;
...
public class AlertDataManagerTest {
  ...
  @Test
  public void testAlertRecords() throws ShpurdpException {
