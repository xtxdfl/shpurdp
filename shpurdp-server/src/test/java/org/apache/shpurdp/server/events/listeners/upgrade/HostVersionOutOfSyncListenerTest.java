...
public class HostVersionOutOfSyncListenerTest {
   ...
   * @throws ShpurdpException
   */
  private RepositoryVersionEntity addRepoVersion(String INSTALLED_VERSION, StackId stackId) throws ShpurdpException {
   ...
   */
  @Test
  public void testOnServiceEvent() throws ShpurdpException {
   ...
   */
  @Test
  public void testOnServiceEvent_component_does_not_advertise_version() throws ShpurdpException {
    String INSTALLED_VERSION = "2.2.0-1000";
    StackId stackId = new StackId(this.stackId);
   ...
   */
  @Test
  public void testOnServiceComponentEvent() throws ShpurdpException {
    String INSTALLED_VERSION = "2.2.0-1000";
    String INSTALLED_VERSION_2 = "2.1.1-2000";
    StackId stackId = new StackId(this.stackId);
    StackId yaStackId = new StackId(yetAnotherStackId);
   ...
   * then Shpurdp needs to insert host_verion record for each one of
   * those stack versions with a state of OUT_OF_SYNC
   */
  @Test
  public void testOnHostEvent() throws ShpurdpException {
  ...
  /**
   * Tests that when a host is removed, the {@link org.apache.shpurdp.server.events.HostsRemovedEvent} fires and
   * eventually calls to recalculate the cluster state.
   */
  @Test
  public void testOnHostRemovedEvent() throws ShpurdpException {
    // add the 2nd host
    addHost("h2");
    clusters.mapHostToCluster("h2", "c1");
  ...
  private void addHost(String hostname) throws ShpurdpException {
  ...
  private void addService(Cluster cl, List<String> hostList, Map<String, List<Integer>> topology,
      String serviceName, RepositoryVersionEntity repositoryVersionEntity) throws ShpurdpException {
  ...
  private void addServiceComponent(Cluster cl, List<String> hostList,
                                   String serviceName, String componentName) throws ShpurdpException {
    StackId stackIdObj = new StackId(stackId);
