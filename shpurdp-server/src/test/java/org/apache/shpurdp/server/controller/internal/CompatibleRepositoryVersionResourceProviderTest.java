...
import org.apache.shpurdp.server.controller.predicate.OrPredicate;
...
import org.apache.shpurdp.server.state.repository.AvailableService;
...
public class CompatibleRepositoryVersionResourceProviderTest {
  ...
  public void before() throws Exception {
    final ShpurdpMetaInfo shpurdpMetaInfo = EasyMock.createMock(ShpurdpMetaInfo.class);
    ...
    expect(shpurdpMetaInfo.getStack("HDP", "1.1")).andReturn(stack1).atLeastOnce();
    expect(shpurdpMetaInfo.getStack("HDP", "2.2")).andReturn(stack2).atLeastOnce();
    expect(shpurdpMetaInfo.getUpgradePacks("HDP", "1.1")).andReturn(stack1.getUpgradePacks()).atLeastOnce();
    expect(shpurdpMetaInfo.getUpgradePacks("HDP", "2.2")).andReturn(stack2.getUpgradePacks()).atLeastOnce();

    replay(shpurdpMetaInfo);
