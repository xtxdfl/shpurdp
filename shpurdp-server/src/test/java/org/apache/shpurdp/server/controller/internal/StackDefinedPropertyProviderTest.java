...
import org.apache.shpurdp.server.controller.metrics.JMXPropertyProviderTest;
import org.apache.shpurdp.server.controller.metrics.MetricsServiceProvider;
import org.apache.shpurdp.server.controller.metrics.ganglia.GangliaPropertyProviderTest.TestGangliaHostProvider;
import org.apache.shpurdp.server.controller.metrics.ganglia.GangliaPropertyProviderTest.TestGangliaServiceProvider;
import org.apache.shpurdp.server.controller.metrics.timeline.MetricsRequestHelper;
...
public class StackDefinedPropertyProviderTest {
  ...
  public void testPopulateResources_params_category5() throws Exception {
    org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider streamProvider =
      new org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider("temporal_ganglia_data_yarn_queues.txt");
    ...
    resource.setProperty("HostRoles/cluster_name", "c2");
    resource.setProperty(HOST_COMPONENT_HOST_NAME_PROPERTY_ID, "dev01.shpurdp.apache.org");
    resource.setProperty(HOST_COMPONENT_COMPONENT_NAME_PROPERTY_ID, "RESOURCEMANAGER");
  ...
  public void testPopulateResources_ganglia_JournalNode() throws Exception {
    org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider streamProvider =
      new org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider("journalnode_ganglia_data.txt");
  ...
  public void testPopulateResources_resourcemanager_clustermetrics() throws Exception {
    ...
    org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider streamProvider =
      new org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider("yarn_ganglia_data.txt");
  ...
  public void testPopulateResourcesWithAggregateFunctionMetrics() throws Exception {
    ...
    org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider streamProvider =
      new org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider("ams/aggregate_component_metric.json");
  ...
  private void injectCacheEntryFactoryWithStreamProvider(org.apache.shpurdp.server.controller.metrics.ganglia.TestStreamProvider streamProvider) throws Exception {
