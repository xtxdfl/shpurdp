 ...
 */
package org.apache.shpurdp.server.state.alerts;
...
import org.apache.shpurdp.server.events.AlertStateChangeEvent;
...
import org.apache.shpurdp.server.orm.entities.AlertCurrentEntity;
import org.apache.shpurdp.server.orm.entities.AlertDefinitionEntity;
import org.apache.shpurdp.server.state.Alert;
import org.apache.shpurdp.server.state.AlertFirmness;
...
public class AlertReceivedListenerTest {
  ...
  private static final String SHPURDP_ALERT_DEFINITION = "shpurdp_server_alert";
  ...
  public void setup() throws Exception {
    ...
    EventBusSynchronizer.synchronizeShpurdpEventPublisher(m_injector);
    ...
    AlertDefinitionEntity definition = new AlertDefinitionEntity();
    definition.setDefinitionName(SHPURDP_ALERT_DEFINITION);
    definition.setServiceName(RootService.SHPURDP.name());
    definition.setComponentName(RootComponent.SHPURDP_SERVER.name());
    definition.setClusterId(m_cluster.getClusterId());
    definition.setHash(UUID.randomUUID().toString());
    definition.setScheduleInterval(Integer.valueOf(60));
    definition.setScope(Scope.SERVICE);
   ...
   */
  @Test
  public void testDisabledAlert() throws ShpurdpException {
   ...
   */
  @Test
  public void testInvalidHost() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String componentName = "DATANODE";
   ...
   */
  @Test
  public void testInvalidAlertDefinition() throws ShpurdpException {
    String componentName = "DATANODE";
   ...
   */
  @Test
  public void testInvalidServiceComponentHost() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String componentName = "DATANODE";
   ...
   */
  @Test
  public void testAgentAlertFromInvalidHost() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String serviceName = RootService.SHPURDP.name();
    String componentName = RootComponent.SHPURDP_AGENT.name();
  ...
  /**
   * Tests that an alert for SHPURDP/SHPURDP_SERVER is always valid.
   */
  @Test
  public void testShpurdpServerValidAlerts() throws ShpurdpException {
    String definitionName = SHPURDP_ALERT_DEFINITION;
    String serviceName = RootService.SHPURDP.name();
    String componentName = RootComponent.SHPURDP_SERVER.name();
   ...
   */
  @Test
  public void testMissingClusterAndInvalidHost() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String serviceName = RootService.SHPURDP.name();
    String componentName = RootComponent.SHPURDP_AGENT.name();
   ...
   */
  @Test
  public void testSkippedAlertWithNoCurrentAlert() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String serviceName = "HDFS";
   ...
   */
  @Test
  public void testSkippedAlertUpdatesTimestampAndText() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String serviceName = "HDFS";
    String componentName = "NAMENODE";
   ...
   */
  @Test
  public void testAlertOccurrences() throws ShpurdpException {
    String definitionName = ALERT_DEFINITION + "1";
    String serviceName = "HDFS";
    String componentName = "NAMENODE";
    String text = serviceName + " " + componentName + " is OK";
