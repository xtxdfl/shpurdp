...
public class StageUtilsTest extends EasyMockSupport {
  ...
  public void setup() throws Exception {
    ...
    injector = Guice.createInjector(new AbstractModule() {
      ...
      protected void configure() {
        ...
        PartialNiceMockBinder.newBuilder(StageUtilsTest.this).addShpurdpMetaInfoBinding()
  ...
  public void testGetClusterHostInfo() throws Exception {
    ...
    assertTrue(info.containsKey(StageUtils.SHPURDP_SERVER_HOST));
    Set<String> serverHost = info.get(StageUtils.SHPURDP_SERVER_HOST);
  ...
  @Test
  public void testUseShpurdpJdkWithoutavaHome() {
    // GIVEN
    Map<String, String> commandParams = new HashMap<>();
    Configuration configuration = new Configuration();
    // WHEN
    StageUtils.useShpurdpJdkInCommandParams(commandParams, configuration);
    // THEN
    assertTrue(commandParams.isEmpty());
  }

  @Test
  public void testUseShpurdpJdkWithCustomJavaHome() {
    // GIVEN
    Map<String, String> commandParams = new HashMap<>();
    Configuration configuration = new Configuration();
    configuration.setProperty("java.home", "myJavaHome");
    configuration.setProperty("shpurdp.java.home", "shpurdp_java_home");
    // WHEN
    StageUtils.useShpurdpJdkInCommandParams(commandParams, configuration);
    // THEN
    assertEquals("shpurdp_java_home", commandParams.get("shpurdp_java_home"));
    assertEquals(2, commandParams.size());
  }

  @Test
  public void testUseShpurdpJdk() {
    // GIVEN
    Map<String, String> commandParams = new HashMap<>();
    Configuration configuration = new Configuration();
    configuration.setProperty("java.home", "myJavaHome");
    ...
    // THEN
    assertEquals("shpurdp_java_home", commandParams.get("shpurdp_java_home"));
    assertEquals("myJdkName", commandParams.get("shpurdp_jdk_name"));
    assertEquals("myJceName", commandParams.get("shpurdp_jce_name"));
