...
public class HostTest {
  ...
  @Test
  public void testHostInfoImport() throws ShpurdpException{
  ...
  public void testHostOs() throws Exception {
    ...
    when(injector.getInstance(ShpurdpEventPublisher.class)).thenReturn(mock(ShpurdpEventPublisher.class));
  ...
  @Test
  public void testHostFSMInit() throws ShpurdpException{
    clusters.addHost("foo");
    Host host = clusters.getHost("foo");
