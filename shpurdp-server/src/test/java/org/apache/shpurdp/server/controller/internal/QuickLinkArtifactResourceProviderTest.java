...
import org.apache.shpurdp.server.stack.QuickLinksConfigurationModule;
import org.apache.shpurdp.server.state.QuickLinksConfigurationInfo;
import org.apache.shpurdp.server.state.ServiceInfo;
import org.apache.shpurdp.server.state.StackInfo;
import org.apache.shpurdp.server.state.quicklinks.Link;
import org.apache.shpurdp.server.state.quicklinks.QuickLinks;
...
public class QuickLinkArtifactResourceProviderTest {
  ...
  private QuickLinkArtifactResourceProvider createProvider() {
    return new QuickLinkArtifactResourceProvider(injector.getInstance(ShpurdpManagementController.class));
  }
  ...
  private class MockModule implements Module {
    ...
    public void configure(Binder binder) {
      ...
      expect(amc.getShpurdpMetaInfo()).andReturn(metaInfo).anyTimes();
