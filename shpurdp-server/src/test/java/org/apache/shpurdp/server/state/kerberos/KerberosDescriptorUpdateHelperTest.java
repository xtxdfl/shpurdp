...
public class KerberosDescriptorUpdateHelperTest extends EasyMockSupport {
  ...
  @Experimental(
      ...
      comment = "This was a very useful test that no longer works since all of the kerberos "
          + "descriptor files for services are stored in stacks no longer shipped with Shpurdp. "
  ...
  public void updateDefaultUserKerberosDescriptor() throws Exception {
    ...
    ShpurdpMetaInfo metaInfo = new ShpurdpMetaInfo(injector.getInstance(Configuration.class));
  ...
  @Test
  public void testUpdateProperties() throws ShpurdpException {
  ...
  @Test
  public void testUpdateIdentities() throws ShpurdpException {
    KerberosDescriptor oldValue = KERBEROS_DESCRIPTOR_FACTORY.createInstance(
        "{" +
            "  \"identities\": [" +
            "    {" +
            ...
            "        \"type\": \"user\"," +
            "        \"configuration\": \"cluster-env/shpurdp_principal_name\"" +
            "      }," +
            "      \"keytab\": {" +
            "        \"file\": \"${keytab_dir}/shpurdp.server.keytab\"" +
            "      }" +
            "    }" +
            "  ]" +
            "}");
    ...
    KerberosDescriptor newValue = KERBEROS_DESCRIPTOR_FACTORY.createInstance(
        "{" +
            ...
            "      \"name\": \"shpurdp-server\"," +
            "      \"principal\": {" +
            "        \"value\": \"shpurdp-server${principal_suffix}@${realm}\"," +
            "        \"type\": \"user\"," +
            "        \"configuration\": \"cluster-env/shpurdp_principal_name\"" +
            "      }," +
            "      \"keytab\": {" +
  ...
  @Test
  public void testUpdateConfigurations() throws ShpurdpException {
    KerberosDescriptor oldValue = KERBEROS_DESCRIPTOR_FACTORY.createInstance(
        "{\n" +
            "  \"configurations\": [\n" +
            "    {\n" +
  ...
  @Test
  public void testUpdateAuthToLocalRules() throws ShpurdpException {
    KerberosDescriptor oldValue = KERBEROS_DESCRIPTOR_FACTORY.createInstance(
        "{\n" +
  ...
  @Test
  public void testUpdateServices() throws ShpurdpException {
    KerberosDescriptor oldValue = KERBEROS_DESCRIPTOR_FACTORY.createInstance(
        "{\n" +
            "  \"services\": [\n" +
            "    {\n" +
