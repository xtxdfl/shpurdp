...
public class RootServiceComponentResourceProviderTest {
  ...
  public void testGetResources() throws Exception{
    ...
    allResponse.add(new RootServiceComponentResponse(serviceName, RootComponent.SHPURDP_SERVER.name(), "1.1.1", emptyMap));
    ...
    for (Resource resource : resources) {
      ...
      if (componentName.equals(RootComponent.SHPURDP_SERVER.name())){
