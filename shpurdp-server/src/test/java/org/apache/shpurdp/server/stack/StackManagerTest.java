...
public class StackManagerTest {
  ...
  public static StackManager createTestStackManager(String stackRoot) throws Exception {
    ...
    ShpurdpManagementHelper helper = new ShpurdpManagementHelper(stackDao, extensionDao, linkDao);
  ...
  public void testStackVersionInheritance() {
    ...
    expectedServices.add("SHPURDP_METRICS");
      ...
      for (ServiceInfo serviceInfo : stackInfo.getServices()) {
        ...
        if (serviceInfo.getMetricsFile() != null) {
          try {
            ...
            e.printStackTrace();
            throw new ShpurdpException("Failed to load metrics from file " + serviceInfo.getMetricsFile().getAbsolutePath());
          }
        }
      }
    }
