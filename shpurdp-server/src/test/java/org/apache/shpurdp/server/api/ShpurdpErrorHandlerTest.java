...
@PrepareForTest({ShpurdpErrorHandler.class, LoggerFactory.class, HttpConnection.class, UUID.class})
public class ShpurdpErrorHandlerTest extends EasyMockSupport {
  ...
  public void testHandleInternalServerError() throws IOException {
    ...
    expect(LoggerFactory.getLogger(ShpurdpErrorHandler.class)).andReturn(logger);
    ...
    ShpurdpErrorHandler shpurdpErrorHandler = new ShpurdpErrorHandler(gson, propertiesProvider);
    shpurdpErrorHandler.setShowStacks(false);
