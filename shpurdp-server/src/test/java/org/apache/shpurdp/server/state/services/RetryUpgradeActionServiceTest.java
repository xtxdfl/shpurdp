...
/**
 * Tests {@link org.apache.shpurdp.server.state.services.RetryUpgradeActionService}.
 */
public class RetryUpgradeActionServiceTest {
  ...
  public void test() throws Exception {
    ...
    hrc2.setOriginalStartTime(now);
    hrc2.setStatus(HostRoleStatus.HOLDING_FAILED);
    hrc2.setCustomCommandName("org.apache.shpurdp.server.serveraction.upgrades.FinalizeUpgradeAction");
    hostRoleCommandDAO.merge(hrc2);
   ...
   */
  private void createCluster() throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  private void prepareUpgrade() throws ShpurdpException {
    RepositoryVersionEntity repoVersionEntity = new RepositoryVersionEntity();
