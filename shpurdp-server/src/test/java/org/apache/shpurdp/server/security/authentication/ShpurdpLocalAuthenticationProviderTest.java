...
public class ShpurdpLocalAuthenticationProviderTest extends AbstractAuthenticationProviderTest {
  ...
  @Override
  protected void validateAuthenticationResult(ShpurdpUserAuthentication result) {
