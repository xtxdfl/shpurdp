...
public class TestHeartbeatMonitor {
  ...
  public void testHeartbeatLoss() throws ShpurdpException, InterruptedException,
    ...
    reg.setAgentVersion(shpurdpMetaInfo.getServerVersion());
  ...
  @Test
  public void testStateCommandsGeneration() throws ShpurdpException, InterruptedException,
          InvalidStateTransitionException {
  ...
  @Ignore
  //TODO should be rewritten, componentStatuses already are not actual as a part of heartbeat.
  public void testHeartbeatStateCommandsEnqueueing() throws ShpurdpException, InterruptedException,
          InvalidStateTransitionException {
    StackId stackId = new StackId("HDP-0.1");
    Clusters clusters = injector.getInstance(Clusters.class);
    clusters.addHost(hostname1);
  ...
  @Ignore
  // TODO should be rewritten after STOMP protocol implementation.
  public void testHeartbeatLossWithComponent() throws ShpurdpException, InterruptedException,
          InvalidStateTransitionException {
    StackId stackId = new StackId("HDP-0.1");
    Clusters clusters = injector.getInstance(Clusters.class);
    clusters.addHost(hostname1);
  ...
  @Test
  public void testStateCommandsWithAlertsGeneration() throws ShpurdpException, InterruptedException,
          InvalidStateTransitionException {
