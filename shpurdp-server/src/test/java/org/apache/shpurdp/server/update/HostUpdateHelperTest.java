...
import org.apache.shpurdp.server.utils.CollectionPresentationUtils;
...
public class HostUpdateHelperTest {
  ...
  public void testValidateHostChanges_Success() throws Exception {
    ...
    final ShpurdpManagementController mockShpurdpManagementController = easyMockSupport.createNiceMock(ShpurdpManagementController.class);
    ...
    final Injector mockInjector = Guice.createInjector(new AbstractModule() {
      ...
      protected void configure() {
        bind(ShpurdpManagementController.class).toInstance(mockShpurdpManagementController);
       }
    });
    ...
    expect(mockShpurdpManagementController.getClusters()).andReturn(mockClusters).once();
  ...
  @Test
  public void testUpdateHostsInConfigurations() throws ShpurdpException {
    EasyMockSupport easyMockSupport = new EasyMockSupport();
    final ShpurdpManagementController mockShpurdpManagementController = easyMockSupport.createNiceMock(ShpurdpManagementController.class);
    ...
    final Injector mockInjector = Guice.createInjector(new AbstractModule() {
      @Override
      protected void configure() {
        PartialNiceMockBinder.newBuilder().addClustersBinding(mockShpurdpManagementController).addLdapBindings().build().configure(binder());
        ...
        bind(ShpurdpMetaInfo.class).toInstance(EasyMock.createNiceMock(ShpurdpMetaInfo.class));
  ...
  @Test
  public void testCheckForSecurity_SecureCluster() throws ShpurdpException {
    EasyMockSupport easyMockSupport = new EasyMockSupport();
    final ShpurdpManagementController mockShpurdpManagementController = easyMockSupport.createNiceMock(ShpurdpManagementController.class);
    Clusters mockClusters = easyMockSupport.createStrictMock(Clusters.class);
    Cluster mockCluster = easyMockSupport.createNiceMock(Cluster.class);
  ...
  @Test
  public void testCheckForSecurity_NonSecureCluster() throws ShpurdpException {
    EasyMockSupport easyMockSupport = new EasyMockSupport();
    final ShpurdpManagementController mockShpurdpManagementController = easyMockSupport.createNiceMock(ShpurdpManagementController.class);
    Clusters mockClusters = easyMockSupport.createStrictMock(Clusters.class);
    Cluster mockCluster = easyMockSupport.createNiceMock(Cluster.class);
  ...
  @Test
  public void testUpdateHostsInDB() throws ShpurdpException {
    EasyMockSupport easyMockSupport = new EasyMockSupport();
  ...
  @Test
  public void testUpdateHostsForAlertsInDB() throws ShpurdpException {
    EasyMockSupport easyMockSupport = new EasyMockSupport();
    final ShpurdpManagementController mockShpurdpManagementController = easyMockSupport.createNiceMock(ShpurdpManagementController.class);
  ...
  @Test
  public void testInitHostChangesFileMap_SUCCESS() throws ShpurdpException {
    EasyMockSupport easyMockSupport = new EasyMockSupport();
