...
public class ConfigurationMergeCheckTest {
  ...
  public void testPerform() throws Exception {
    ...
    final ShpurdpMetaInfo ami = EasyMock.createMock(ShpurdpMetaInfo.class);


    field = ConfigMergeHelper.class.getDeclaredField("m_shpurdpMetaInfo");
    field.setAccessible(true);
    field.set(cmc.m_mergeHelper, new Provider<ShpurdpMetaInfo>() {
      @Override
