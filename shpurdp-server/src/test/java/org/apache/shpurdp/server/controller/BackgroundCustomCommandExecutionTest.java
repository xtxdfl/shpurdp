...
public class BackgroundCustomCommandExecutionTest {
  ...
  private static final String UPDATE_REPLICATION_PARAMS = "{\n" +
          "              \"replication_cluster_keys\": c7007.shpurdp.apache.org,c7008.shpurdp.apache.org,c7009.shpurdp.apache.org:2181:/hbase,\n" +
          "              \"replication_peers\": 1\n" +
          "            }";
  ...
  private void createClusterFixture() throws ShpurdpException, AuthorizationException, NoSuchFieldException, IllegalAccessException {
    createCluster("c1");
    addHost("c6401","c1");
    addHost("c6402","c1");
    addHost("c7007", "c1");
  ...
  public void testUpdateHBaseReplicationCustomCommand()
          throws AuthorizationException, ShpurdpException, IllegalAccessException,
  ...
  private void createCluster(String clusterName) throws ShpurdpException, AuthorizationException {
  ...
  private void createService(String clusterName,
      String serviceName, State desiredState) throws ShpurdpException, AuthorizationException, NoSuchFieldException, IllegalAccessException {
