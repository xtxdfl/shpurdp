...
public class StackServiceDirectoryTest {
  ...
  private MockStackServiceDirectory createStackServiceDirectory(String servicePath) throws ShpurdpException {
  ...
  private class MockStackServiceDirectory extends StackServiceDirectory {
    ...
    MockStackServiceDirectory (String servicePath) throws ShpurdpException {
      super(servicePath);
