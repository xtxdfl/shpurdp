...
public class ServiceComponentSupportTest extends EasyMockSupport {
  ...
  public void setUp() throws Exception {
    componentSupport = new ServiceComponentSupport(() -> shpurdpMetaInfo);
  }
  ...
  private void targetStackWith(String... serviceNames) throws ShpurdpException {
    expect(shpurdpMetaInfo.getServices(STACK_NAME, VERSION)).andReturn(serviceInfoMap(serviceNames)).anyTimes();
  ...
  private void markAsDeleted(String serviceName) throws ShpurdpException {
    shpurdpMetaInfo.getServices(STACK_NAME, VERSION).get(serviceName).setDeleted(true);
  }
