...
import static org.apache.shpurdp.server.topology.ConfigRecommendationStrategy.ALWAYS_APPLY;
import static org.apache.shpurdp.server.topology.addservice.AddServiceRequest.OperationType.ADD_SERVICE;
import static org.apache.shpurdp.server.topology.addservice.AddServiceRequest.ValidationType.PERMISSIVE;
import static org.apache.shpurdp.server.topology.addservice.AddServiceRequest.ValidationType.STRICT;
...
import org.apache.shpurdp.server.topology.Credential;
...
public class AddServiceRequestTest {
  ...
  public void testDeserialize_basic() throws Exception {
    ...
    assertEquals(
      ImmutableSet.of(
        Component.of("NIMBUS", START_ONLY, "c7401.shpurdp.apache.org", "c7402.shpurdp.apache.org"),
        Component.of("BEACON_SERVER", "c7402.shpurdp.apache.org", "c7403.shpurdp.apache.org")
      ),
  ...
  public void testDeserialize_defaultAndEmptyValues() throws Exception {
    ...
    // filled-out values
    assertEquals(
      ImmutableSet.of(Component.of("NIMBUS", "c7401.shpurdp.apache.org", "c7402.shpurdp.apache.org"), Component.of("BEACON_SERVER", "c7402.shpurdp.apache.org", "c7403.shpurdp.apache.org")),
      request.getComponents());
