 ...
 */
package org.apache.shpurdp.server.controller.utilities.webserver;
...
public class StartServer {
  ...
  public static void main(String[] args) throws IOException {
    ...
    System.out.println("Starting Shpurdp API server using the following properties: " + mapArgs);
    System.setProperty("shpurdpapi.dbfile", mapArgs.get("db"));

    ResourceConfig config = new ResourceConfig();
    config.packages("org.apache.shpurdp.server.api.services");
  ...
  public static void printUsage() {
    System.err.println("Usage: java StartServer [-p portNum] [-d abs path to shpurdp db file]");
    System.err.println("Default Values: portNum=9998, shpurdpDb=/var/db/hmc/data/data.db");
  }
}
