...
public class ViewClassLoaderTest {
  ...
  public void testGetResource() throws Exception {
    ...
    URL url = classLoader.getResource("shpurdp.properties");
  ...
  public void testLoadClass() throws Exception {
    ...
    expect(parentClassLoader.getPackage("org.apache.shpurdp.server.view")).andReturn(null).anyTimes();
    ...
    expect(parentClassLoader.loadClass("org.apache.shpurdp.server.controller.spi.ResourceProvider")).andReturn(parentClass).once();
    expect(parentClassLoader.loadClass("org.apache.shpurdp.view.ViewContext")).andReturn(parentClass).once();
    ...
    clazz = classLoader.loadClass("org.apache.shpurdp.server.controller.spi.ResourceProvider");

    Assert.assertNotNull(clazz);
    Assert.assertSame(parentClass, clazz);

    clazz = classLoader.loadClass("org.apache.shpurdp.view.ViewContext");
