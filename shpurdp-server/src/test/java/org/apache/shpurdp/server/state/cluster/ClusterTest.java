...
import org.apache.shpurdp.server.agent.AgentEnv.Directory;
...
public class ClusterTest {
  ...
  public void setup() throws Exception {
    ...
    metaInfo = injector.getInstance(ShpurdpMetaInfo.class);
   ...
   * can advertise a version. Then, simulate the {@link org.apache.shpurdp.server.events.listeners.upgrade.StackVersionListener}
  ...
  public void testAddAndGetServices() throws Exception {
    ...
    // public void addService(Service service) throws ShpurdpException;
   ...
   * the contract of
   * {@link Cluster#transitionHostsToInstalling(RepositoryVersionEntity, org.apache.shpurdp.server.state.repository.VersionDefinitionXml, boolean)}.
   *
   * @throws Exception
   */
  @Test
