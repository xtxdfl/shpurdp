...
public class ViewURLStreamProviderTest {
  ...
  public void testProxyRestriction() throws Exception {
    ...
    shpurdpProperties.setProperty(Configuration.PROXY_ALLOWED_HOST_PORTS.getKey(), "");
    ...
    shpurdpProperties = new Properties();
    shpurdpProperties.setProperty(Configuration.PROXY_ALLOWED_HOST_PORTS.getKey(), "host1.com:*");
    configuration = new Configuration(shpurdpProperties);
    hprh =
        viewURLStreamProvider.new HostPortRestrictionHandler(
            configuration.getProxyHostAndPorts());
    ...
    shpurdpProperties = new Properties();
    shpurdpProperties.setProperty(Configuration.PROXY_ALLOWED_HOST_PORTS.getKey(), " host1.com:80 ,host2.org:443, host2.org:22");
    configuration = new Configuration(shpurdpProperties);
    hprh =
        viewURLStreamProvider.new HostPortRestrictionHandler(
            configuration.getProxyHostAndPorts());
    ...
    ViewContext viewContext = createNiceMock(ViewContext.class);
    expect(viewContext.getShpurdpProperty(anyObject(String.class))).andReturn(
    ...
    expect(viewContext.getShpurdpProperty(anyObject(String.class))).andReturn("c6401.shpurdp.apache.org:8088");
    replay(viewContext);
    viewURLStreamProvider = new ViewURLStreamProvider(viewContext, null);
    Assert.assertTrue(viewURLStreamProvider.isProxyCallAllowed(
        "http://c6401.shpurdp.apache.org:8088/ws/v1/cluster/get-node-labels"));

    viewContext = createNiceMock(ViewContext.class);
    expect(viewContext.getShpurdpProperty(anyObject(String.class))).andReturn("*:8088");
    replay(viewContext);
    viewURLStreamProvider = new ViewURLStreamProvider(viewContext, null);
    ...
    viewContext = createNiceMock(ViewContext.class);
    expect(viewContext.getShpurdpProperty(anyObject(String.class))).andReturn("c6401.shpurdp.apache.org:*");
    replay(viewContext);
    viewURLStreamProvider = new ViewURLStreamProvider(viewContext, null);
    Assert.assertTrue(viewURLStreamProvider.isProxyCallAllowed(
        "http://c6401.shpurdp.apache.org:8088/ws/v1/cluster/get-node-labels"));
    ...
    viewContext = createNiceMock(ViewContext.class);
    expect(viewContext.getShpurdpProperty(anyObject(String.class))).andReturn(
        "c6401.shpurdp.apache.org:80,c6401.shpurdp.apache.org:443");
    replay(viewContext);
    viewURLStreamProvider = new ViewURLStreamProvider(viewContext, null);
    Assert.assertTrue(viewURLStreamProvider.isProxyCallAllowed(
        "http://c6401.shpurdp.apache.org/ws/v1/cluster/get-node-labels"));
    Assert.assertTrue(viewURLStreamProvider.isProxyCallAllowed(
        "https://c6401.shpurdp.apache.org/ws/v1/cluster/get-node-labels"));
  }
}
