...
import org.apache.shpurdp.view.NoSuchResourceException;
import org.apache.shpurdp.view.ReadRequest;
import org.apache.shpurdp.view.ResourceAlreadyExistsException;
import org.apache.shpurdp.view.ResourceProvider;
import org.apache.shpurdp.view.SystemException;
import org.apache.shpurdp.view.UnsupportedPropertyException;
import org.apache.shpurdp.view.ViewInstanceDefinition;
import org.apache.shpurdp.view.migration.ViewDataMigrationException;
import org.apache.shpurdp.view.migration.ViewDataMigrator;
...
public class ViewConfigTest {
  ...
  private static String xml = "<view>\n" +
      ...
      "    <cluster-config-options>SHPURDP-ONLY</cluster-config-options>\n" +
      "    <data-migrator-class>org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyDataMigrator</data-migrator-class>" +
      "    <validator-class>org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyValidator</validator-class>" +
      "    <masker-class>org.apache.shpurdp.server.view.DefaultMasker</masker-class>" +
      "    <parameter>\n" +
      "        <name>p1</name>\n" +
      ...
      "        <resource-class>org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyResource</resource-class>\n" +
      "        <provider-class>org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyResourceProvider</provider-class>\n" +
      "        <service-class>org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyResourceService</service-class>\n" +
  ...
  private static String with_shpurdp_versions = "<view>\n" +
      "    <name>MY_VIEW</name>\n" +
      "    <label>My View!</label>\n" +
      "    <version>1.0.0</version>\n" +
      "    <min-shpurdp-version>1.6.1</min-shpurdp-version>\n" +
      "    <max-shpurdp-version>2.0.0</max-shpurdp-version>\n" +
      "</view>";
  ...
  public void testGetValidator() throws Exception {
    ViewConfig config = getConfig();
    Assert.assertEquals("org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyValidator", config.getValidator());
  }

  @Test
  public void testGetDataMigrator() throws Exception {
    ViewConfig config = getConfig();
    Assert.assertEquals("org.apache.shpurdp.server.view.configuration.ViewConfigTest$MyDataMigrator", config.getDataMigrator());
  }
  ...
  public void testMasker() throws Exception {
    ViewConfig config = getConfig();
    Assert.assertEquals("org.apache.shpurdp.server.view.DefaultMasker", config.getMasker());
  }
  ...
  @Test
  public void testGetMinShpurdpVersion() throws Exception {
    ViewConfig config = getConfig();
    Assert.assertNull(config.getMinShpurdpVersion());

    config = getConfig(with_shpurdp_versions);
    Assert.assertEquals("1.6.1", config.getMinShpurdpVersion());
  }

  @Test
  public void testGetMaxShpurdpVersion() throws Exception {
    ViewConfig config = getConfig();
    Assert.assertNull(config.getMaxShpurdpVersion());

    config = getConfig(with_shpurdp_versions);
    Assert.assertEquals("2.0.0", config.getMaxShpurdpVersion());
  }

  @Test
  public void testGetClusterConfigOptions() throws Exception {
    ViewConfig config = getConfig();
    Assert.assertEquals("SHPURDP-ONLY",config.getClusterConfigOptions());
  }
