...
public class RootServiceServiceTest extends BaseServiceTest {
  ...
  public List<ServiceTestInvocation> getTestInvocations() throws Exception {
    ...
    //getService
    service = new TestRootServiceService("SHPURDP", null, null);
    m = service.getClass().getMethod("getRootService", String.class, HttpHeaders.class, UriInfo.class, String.class);
    args = new Object[] {null, getHttpHeaders(), getUriInfo(), "SHPURDP"};
    listInvocations.add(new ServiceTestInvocation(Request.Type.GET, service, m, args, null));
    ...
    //getServiceComponent
    service = new TestRootServiceService("SHPURDP", "SHPURDP_SERVER", null);
    ...
    args = new Object[] {null, getHttpHeaders(), getUriInfo(), "SHPURDP", "SHPURDP_SERVER"};
    listInvocations.add(new ServiceTestInvocation(Request.Type.GET, service, m, args, null));
    ...
    //getRootHost
    service = new TestRootServiceService("SHPURDP", "SHPURDP_SERVER", "host1");
