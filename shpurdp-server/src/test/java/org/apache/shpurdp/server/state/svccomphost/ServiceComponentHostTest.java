...
public class ServiceComponentHostTest {
  ...
  private ClusterEntity createCluster(StackId stackId, String clusterName) throws ShpurdpException {
  ...
  private void addHostsToCluster(String clusterName, Map<String, String> hostAttributes, Set<String> hostNames) throws ShpurdpException {
    ClusterEntity clusterEntity = clusterDAO.findByName(clusterName);
  ...
  private ServiceComponentHost createNewServiceComponentHost(String clusterName,
      String svc,
      String svcComponent,
      String hostName, boolean isClient) throws ShpurdpException{
  ...
  @Test
  public void testGetAndSetBasicInfo() throws ShpurdpException {
  ...
  @Test
  public void testConvertToResponse() throws ShpurdpException {
  ...
  @Test
  public void testStopInVariousStates() throws ShpurdpException, InvalidStateTransitionException {
    ServiceComponentHost sch = createNewServiceComponentHost(clusterName, "HDFS", "DATANODE", hostName1, false);
  ...
  @Test
  public void testDisableInVariousStates() throws ShpurdpException, InvalidStateTransitionException {
   ...
   */
  private void makeConfig(Cluster cluster, String type, String tag, Map<String, String> values, Map<String, Map<String, String>> attributes) throws ShpurdpException {
