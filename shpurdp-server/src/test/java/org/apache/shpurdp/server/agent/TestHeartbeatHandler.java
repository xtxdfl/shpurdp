...
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DATANODE;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyCluster;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyClusterId;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyCurrentPingPort;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyHostStatus;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyHostname1;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyOSRelease;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyOs;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyOsType;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.DummyStackId;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.HDFS;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.HDFS_CLIENT;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.NAMENODE;
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.SECONDARY_NAMENODE;
...
import org.apache.shpurdp.server.actionmanager.ActionManagerTestHelper;
...
import org.apache.shpurdp.server.agent.HostStatus.Status;
...
//    assertEquals("responseId was not incremented", 2L, hbResponse.getResponseId());
  ...
  public void testInjectKeytabApplicableHost() throws Exception {
    ...
    kcp = testInjectKeytabSetKeytab("c6403.shpurdp.apache.org");
    Assert.assertNotNull(kcp);
    Assert.assertEquals(1, kcp.size());

    properties = kcp.get(0);
    Assert.assertNotNull(properties);
    Assert.assertEquals("c6403.shpurdp.apache.org", properties.get(KerberosIdentityDataFileWriter.HOSTNAME));
    ...
    kcp = testInjectKeytabRemoveKeytab("c6403.shpurdp.apache.org");
  ...
  public void testInjectKeytabNotApplicableHost() throws Exception {
    ...
    List<Map<String, String>> kcp;
    kcp = testInjectKeytabSetKeytab("c6401.shpurdp.apache.org");
    Assert.assertNotNull(kcp);
    Assert.assertTrue(kcp.isEmpty());

    kcp = testInjectKeytabRemoveKeytab("c6401.shpurdp.apache.org");
    Assert.assertNotNull(kcp);
    Assert.assertTrue(kcp.isEmpty());
  }
  ...
  private File createTestKeytabData(AgentCommandsPublisher agentCommandsPublisher, boolean removeKeytabs) throws Exception {
    ...
    if(removeKeytabs) {
      ...
      expect(resolvedKerberosPrincipal.getHostName()).andReturn("c6403.shpurdp.apache.org");
    ...
    File hostDirectory = new File(dataDirectory, "c6403.shpurdp.apache.org");
    File keytabFile;
   ...
   */
  private Service addService(Cluster cluster, String serviceName) throws ShpurdpException {
