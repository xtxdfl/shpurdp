...
public class ShpurdpBasicAuthenticationFilterTest extends EasyMockSupport {

  private ShpurdpAuthenticationEventHandler eventHandler;

  private ShpurdpEntryPoint entryPoint;
  ...
  public void ensureNonNullEventHandler() {
    new ShpurdpBasicAuthenticationFilter(authenticationManager, entryPoint, null);
  }
  ...
  public void testDoFilterSuccessful() throws IOException, ServletException {
    ...
    replayAll();
    // WHEN
    ShpurdpAuthenticationFilter filter = new ShpurdpBasicAuthenticationFilter(authenticationManager, entryPoint, eventHandler);
