...
import org.apache.shpurdp.server.state.CredentialStoreInfo;
...
import org.apache.shpurdp.server.state.SingleSignOnInfo;
...
public class ServiceModuleTest {
  ...
  private ServiceModule resolveService(ServiceInfo info, ServiceInfo parentInfo) throws ShpurdpException {
  ...
  private void resolveService(ServiceModule service, ServiceModule parent) throws ShpurdpException {
