...
import static org.apache.shpurdp.server.upgrade.UpgradeCatalog271.CLUSTERS_BLUEPRINT_PROVISIONING_STATE_COLUMN;
import static org.apache.shpurdp.server.upgrade.UpgradeCatalog271.CLUSTERS_TABLE;
...
public class UpgradeCatalog271Test {
  ...
  public void testExecuteDMLUpdates() throws Exception {
    ...
    Method renameShpurdpInfraInConfigGroups = UpgradeCatalog271.class.getDeclaredMethod("renameShpurdpInfraService");
    ...
    UpgradeCatalog271 upgradeCatalog271 = createMockBuilder(UpgradeCatalog271.class)
      ...
      .addMockedMethod(renameShpurdpInfraInConfigGroups)
    ...
    upgradeCatalog271.renameShpurdpInfraService();
    expectLastCall().once();
  ...
  public void testUpdateRangerKmsDbUrl() throws Exception {
    ...
    Map<String, String> rangerKmsPropertiesConfig = new HashMap<String, String>() {
      {
        put("DB_FLAVOR", "MYSQL");
        put("db_host", "c6401.shpurdp.apache.org");
      }
    };

    Map<String, String> rangerKmsDbksPropertiesConfig = new HashMap<String, String>() {
      {
        put("ranger.ks.jpa.jdbc.url", "jdbc:mysql://c6401.shpurdp.apache.org:3546");
      }
    };
    ...
    Assert.assertEquals(updatedRangerKmsEnvConfig.get("ranger_kms_privelege_user_jdbc_url"), "jdbc:mysql://c6401.shpurdp.apache.org:3546");
  }
