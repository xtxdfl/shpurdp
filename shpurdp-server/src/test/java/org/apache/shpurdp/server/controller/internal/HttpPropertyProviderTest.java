...
public class HttpPropertyProviderTest {
  ...
  public void testReadResourceManagerHA() throws Exception {
    ...
    map.put("yarn.resourcemanager.hostname.rm1", "lc6402.shpurdp.apache.org");
    map.put("yarn.resourcemanager.hostname.rm2", "lc6403.shpurdp.apache.org");
    map.put("yarn.resourcemanager.webapp.address.rm1", "lc6402.shpurdp.apache.org:8099");
    map.put("yarn.resourcemanager.webapp.address.rm2", "lc6403.shpurdp.apache.org:8099");
    map.put("yarn.resourcemanager.webapp.https.address.rm1", "lc6402.shpurdp.apache.org:8066");
    map.put("yarn.resourcemanager.webapp.https.address.rm2", "lc6403.shpurdp.apache.org:8066");
    ...
    resource.setProperty(PROPERTY_ID_HOST_NAME, "lc6402.shpurdp.apache.org");
    resource.setProperty(PROPERTY_ID_PUBLIC_HOST_NAME, "lc6402.shpurdp.apache.org");
    resource.setProperty(PROPERTY_ID_CLUSTER_NAME, "testCluster");
    resource.setProperty(PROPERTY_ID_COMPONENT_NAME, "RESOURCEMANAGER");
    ...
    Assert.assertTrue(resource.getPropertiesMap().get("HostRoles").get("ha_state").equals("ACTIVE"));
    Assert.assertTrue(streamProvider.getLastSpec().equals("https://lc6402.shpurdp.apache.org:8066" +
        "/ws/v1/cluster/info"));
  }
