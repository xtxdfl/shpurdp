...
public class UpgradeCatalogTest {
  ...
  private static class UpgradeCatalog201 extends AbstractUpgradeCatalog {
    ...
    @Override
    public void executeDDLUpdates() throws ShpurdpException, SQLException {
      // do nothing: only for path testing
    }

    @Override
    public void executePreDMLUpdates() throws ShpurdpException, SQLException {

    }

    @Override
    public void executeDMLUpdates() throws ShpurdpException, SQLException {
