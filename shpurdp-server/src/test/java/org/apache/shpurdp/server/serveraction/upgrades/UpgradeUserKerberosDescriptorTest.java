...
import org.apache.shpurdp.server.state.kerberos.KerberosDescriptorUpdateHelper;
...
public class UpgradeUserKerberosDescriptorTest {
  ...
  public void setup() throws Exception {
    ...
    shpurdpMetaInfo = EasyMock.createMock(ShpurdpMetaInfo.class);
  ...
  public void testUpgrade() throws Exception {
    ...
    expect(shpurdpMetaInfo.getKerberosDescriptor("HDP","2.5", false)).andReturn(newDescriptor).atLeastOnce();
    expect(shpurdpMetaInfo.getKerberosDescriptor("HDP","2.4",false)).andReturn(previousDescriptor).atLeastOnce();
    ...
    replay(artifactDAO, entity, shpurdpMetaInfo, kerberosDescriptorFactory, updatedKerberosDescriptor);
  ...
  public void testDowngrade() throws Exception {
    ...
    replay(artifactDAO, entity, shpurdpMetaInfo, kerberosDescriptorFactory);
  ...
  private void prepareFields() throws NoSuchFieldException {
    String[] fieldsNames = { "artifactDAO", "m_clusters", "shpurdpMetaInfo",
  ...
  private void injectFields(UpgradeUserKerberosDescriptor action) throws IllegalAccessException {
    ...
    fields.get("shpurdpMetaInfo").set(action, shpurdpMetaInfo);
