...
public class HealthCheckTest {
  ...
  @Test
  public void testWarningWhenNoAlertsExist() throws ShpurdpException {
  ...
  @Test
  public void testWarningWhenCriticalAlertExists() throws ShpurdpException {
    expectWarning(AlertState.CRITICAL);
  }

  @Test
  public void testWarningWhenWarningAlertExists() throws ShpurdpException {
    expectWarning(AlertState.WARNING);
  }

  private void expectWarning(AlertState alertState) throws ShpurdpException {
