...
public class PropertyInfoTest {
  ...
  public void testUpgradeBehaviorTag() throws JAXBException {
    ...
    String xml =
      ...
      "  <on-shpurdp-upgrade add=\"true\" update=\"true\" delete=\"true\"/>\n" +
      "</property>";
    ...
    // then
    assertTrue(propertyInfo.getPropertyShpurdpUpgradeBehavior().isAdd());
    assertTrue(propertyInfo.getPropertyShpurdpUpgradeBehavior().isUpdate());
    assertTrue(propertyInfo.getPropertyShpurdpUpgradeBehavior().isDelete());
  }
  ...
  public void testBehaviorWithoutUpgradeTags() throws JAXBException {
    ...
    assertTrue(propertyInfo.getPropertyShpurdpUpgradeBehavior().isAdd());
    assertFalse(propertyInfo.getPropertyShpurdpUpgradeBehavior().isUpdate());
    assertFalse(propertyInfo.getPropertyShpurdpUpgradeBehavior().isDelete());
  }
