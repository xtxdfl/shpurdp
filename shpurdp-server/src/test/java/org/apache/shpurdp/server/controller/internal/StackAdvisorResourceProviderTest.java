...
import static org.apache.shpurdp.server.controller.internal.StackAdvisorResourceProvider.CONFIGURATIONS_PROPERTY_ID;
import static org.apache.shpurdp.server.controller.internal.StackAdvisorResourceProvider.USER_CONTEXT_OPERATION_DETAILS_PROPERTY;
import static org.apache.shpurdp.server.controller.internal.StackAdvisorResourceProvider.USER_CONTEXT_OPERATION_PROPERTY;
...
public class StackAdvisorResourceProviderTest {
  ...
  private RecommendationResourceProvider createRecommendationResourceProvider() {
    ...
    return new RecommendationResourceProvider(shpurdpManagementController);
  }
  ...
  public void testStackAdvisorWithEmptyHosts() {
    ShpurdpManagementController shpurdpManagementController = mock(ShpurdpManagementController.class);
    RecommendationResourceProvider provider = new RecommendationResourceProvider(shpurdpManagementController);
