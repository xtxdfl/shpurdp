...
public class TestShellCommandUtil {
  ...
  public void testHideOpenSslPassword(){
    ...
    String command_key = "openssl ca -create_serial -out /var/lib/shpurdp-server/keys/ca.crt -days 365 -keyfile /var/lib/shpurdp-server/keys/ca.key " +
        "-key 1234 -selfsign -extensions jdk7_ca " +
        "-config /var/lib/shpurdp-server/keys/ca.config -batch " +
        "-infiles /var/lib/shpurdp-server/keys/ca.csr";
