...
import org.apache.shpurdp.server.stack.upgrade.ConfigUpgradeChangeDefinition.InsertType;
...
import org.apache.shpurdp.server.stack.upgrade.TransferCoercionType;
...
public class ConfigureActionTest {
  ...
  private ServiceComponentHost createNewServiceComponentHost(Cluster cluster, String serviceName,
      String svcComponent, String hostName) throws ShpurdpException {
