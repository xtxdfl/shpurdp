...
public class CreateKeytabFilesServerActionTest {
  ...
  @Test
  public void testEnsureShpurdpOnlyAccess() throws Exception {
    ...
    new CreateKeytabFilesServerAction().ensureShpurdpOnlyAccess(directory);
    ...
    new CreateKeytabFilesServerAction().ensureShpurdpOnlyAccess(file);
