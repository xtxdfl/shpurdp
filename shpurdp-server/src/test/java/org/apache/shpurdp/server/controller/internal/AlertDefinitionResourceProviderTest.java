...
/**
  ...
  public void testUpdateResourcesWithNumbersAsStrings() throws Exception {
    ...
    // Shpurdp converts all request bodies into Map<String,String>, even they are
   ...
   * @return
   */
  private AlertDefinitionResourceProvider createProvider(ShpurdpManagementController amc) {
