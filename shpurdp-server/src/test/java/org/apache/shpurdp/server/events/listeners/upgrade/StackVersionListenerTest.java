...
public class StackVersionListenerTest extends EasyMockSupport {
  ...
  @Mock
  private Provider<ShpurdpMetaInfo> shpurdpMetaInfoProvider;
  ...
  public void setup() throws Exception {
    ...
    expect(shpurdpMetaInfoProvider.get()).andReturn(shpurdpMetaInfo).atLeastOnce();
    expect(m_hostLevelParamsHolder.get()).andReturn(hostLevelParamsHolder).anyTimes();
    expect(shpurdpMetaInfo.getComponent(STACK_NAME, STACK_VERSION, SERVICE_NAME,
    ...
    listener = new StackVersionListener(publisher, shpurdpMetaInfoProvider, m_hostLevelParamsHolder);
    injectMocks(listener);
  }

  @Test
  public void testRecalculateHostVersionStateWhenVersionIsNullAndNewVersionIsNotBlank() throws ShpurdpException {
  ...
  @Test
  public void testRecalculateHostVersionStateWhenVersionIsUnknownAndNewVersionIsNotBlank() throws ShpurdpException {
  ...
  @Test
  public void testRecalculateClusterVersionStateWhenVersionIsNullAndNewVersionIsValid() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(null);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
  ...
  @Test
  public void testRecalculateClusterVersionStateWhenVersionIsUnknownAndNewVersionIsValid() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(UNKNOWN_VERSION);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
    sch.setVersion(VALID_NEW_VERSION);
    expectLastCall().once();
  ...
  @Test
  public void testRecalculateHostVersionStateWhenComponentDesiredVersionIsUnknownAndNewVersionIsNotValid() throws ShpurdpException {
  ...
  @Test
  public void testRecalculateClusterVersionStateWhenComponentDesiredVersionIsUnknownAndNewVersionIsValid() throws ShpurdpException {
    expect(serviceComponent.getDesiredVersion()).andReturn(UNKNOWN_VERSION);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
    sch.setUpgradeState(UpgradeState.NONE);
    expectLastCall().once();
  ...
  @Test
  public void testRecalculateClusterVersionStateWhenVersionNotAdvertised() throws ShpurdpException {
  ...
  @Test
  public void testNoActionTakenOnNullVersion() throws ShpurdpException {
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
    resetAll();
    replayAll();
  ...
  @Test
  public void testSetUpgradeStateToCompleteWhenUpgradeIsInProgressAndNewVersionIsEqualToComponentDesiredVersion() throws ShpurdpException {
  ...
  @Test
  public void testSetUpgradeStateToNoneWhenNoUpgradeAndNewVersionIsEqualToComponentDesiredVersion() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(VALID_PREVIOUS_VERSION);
    expect(sch.getUpgradeState()).andReturn(UpgradeState.IN_PROGRESS);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
    sch.setUpgradeState(UpgradeState.NONE);
  ...
  @Test
  public void testSetUpgradeStateToVersionMismatchWhenUpgradeIsInProgressAndNewVersionIsNotEqualToComponentDesiredVersion() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(VALID_PREVIOUS_VERSION);
    expect(sch.getUpgradeState()).andReturn(UpgradeState.IN_PROGRESS);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
  ...
  @Test
  public void testSetUpgradeStateToCompleteWhenHostHasVersionMismatchAndNewVersionIsEqualToComponentDesiredVersionAndClusterUpgradeIsInProgress() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(VALID_PREVIOUS_VERSION);
  ...
  @Test
  public void testSetUpgradeStateToNoneWhenHostHasVersionMismatchAndNewVersionIsEqualToComponentDesiredVersion() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(VALID_PREVIOUS_VERSION);
    expect(sch.getUpgradeState()).andReturn(UpgradeState.VERSION_MISMATCH);
    expect(serviceComponent.getDesiredVersion()).andStubReturn(VALID_NEW_VERSION);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
  ...
  @Test
  public void testSetUpgradeStateToVersionMismatchByDefaultWhenHostAndNewVersionsAreValid() throws ShpurdpException {
    expect(sch.getVersion()).andReturn(VALID_PREVIOUS_VERSION);
    expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
    sch.setUpgradeState(UpgradeState.VERSION_MISMATCH);
    expectLastCall().once();
  ...
  private void sendEventAndVerify(String newVersion) throws ShpurdpException {
