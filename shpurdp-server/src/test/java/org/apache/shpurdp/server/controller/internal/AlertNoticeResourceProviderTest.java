...
public class AlertNoticeResourceProviderTest {
  ...
  protected void testGetResourcesClusterPredicate(Authentication authentication) throws Exception {
    ...
    ShpurdpManagementController amc = m_injector.getInstance(ShpurdpManagementController.class);
  ...
  private AlertNoticeResourceProvider createProvider() {
    return new AlertNoticeResourceProvider(m_injector.getInstance(ShpurdpManagementController.class));
  }
  ...
  private class MockModule implements Module {
    ...
    */
    ...
    public void configure(Binder binder) {
      ...
      ShpurdpManagementController amc = createMock(ShpurdpManagementController.class);
      expect(amc.getClusters()).andReturn(clusters).anyTimes();

      binder.bind(AlertDispatchDAO.class).toInstance(m_dao);
      binder.bind(Clusters.class).toInstance(clusters);
      binder.bind(ShpurdpManagementController.class).toInstance(amc);
