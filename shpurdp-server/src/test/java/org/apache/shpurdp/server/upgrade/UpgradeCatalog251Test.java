...
public class UpgradeCatalog251Test {
  ...
  public void testExecuteDDLUpdates() throws Exception {
    ...
    Injector injector = getInjector(createNiceMock(Clusters.class), createNiceMock(ShpurdpManagementControllerImpl.class));//Guice.createInjector(module);
  ...
  public void testUpdateKAFKAConfigs() throws Exception{
    ...
    final Injector mockInjector = getInjector(mockClusters, mockShpurdpManagementController);

    expect(mockShpurdpManagementController.getClusters()).andReturn(mockClusters).atLeastOnce();
    ...
    // Execute the first time... upgrading to Shpurdp 2.4.0
    upgradeCatalog251.updateKAFKAConfigs();

    // Test reentry... upgrading from Shpurdp 2.4.0
    upgradeCatalog251.updateKAFKAConfigs();
