...
public class EntityConfigTest {
  ...
  private final static String xml = "<view>\n" +
      ...
      "    <persistence>\n" +
      "      <entity>\n" +
      "        <class>org.apache.shpurdp.server.view.TestEntity1</class>\n" +
      "        <id-property>id</id-property>\n" +
      "      </entity>\n" +
      "      <entity>\n" +
      "        <class>org.apache.shpurdp.server.view.TestEntity2</class>\n" +
  ...
  public void testGetClassName() throws Exception {
    ...
    Assert.assertEquals("org.apache.shpurdp.server.view.TestEntity1", entities.get(0).getClassName());
    Assert.assertEquals("org.apache.shpurdp.server.view.TestEntity2", entities.get(1).getClassName());
  }
