...
public class ConfigHelperTest {
  public static class RunWithInMemoryDefaultTestModule {
    ...
    private static ShpurdpManagementController managementController;
    private static ShpurdpMetaInfo metaInfo;
    ...
    public void setup() throws Exception {
      ...
      managementController = injector.getInstance(ShpurdpManagementController.class);
    ...
    Long addConfigGroup(String name, String tag, List<String> hosts,
                        List<Config> configs) throws ShpurdpException {
    ...
    public void testEffectiveTagsForHost() throws Exception {
      ...
      cr5.setVersionTag("version1");
      cr5.setProperties(new HashMap<String, String>() {{
        put("metrics_collector_log_dir", "/var/log/shpurdp-metrics-collector");
        put("metrics_collector_pid_dir", "/var/run/shpurdp-metrics-collector");
      }});
      cr5.setPropertiesAttributes(null);
  ...
  public void testCalculateRefreshCommands() throws Exception {
    ...
    public void testFindChangedKeys() throws ShpurdpException, AuthorizationException, NoSuchMethodException,
  ...
  public static class RunWithCustomModule {
    ...
    public void setup() throws Exception {
      injector = Guice.createInjector(new AbstractModule() {
        ...
        protected void configure() {
          final ShpurdpMetaInfo mockMetaInfo = createNiceMock(ShpurdpMetaInfo.class);
          final ClusterController clusterController = createStrictMock(ClusterController.class);

          PartialNiceMockBinder.newBuilder().addShpurdpMetaInfoBinding().addFactoriesInstallBinding().addLdapBindings().build().configure(binder());
          ...
          bind(ShpurdpMetaInfo.class).toInstance(mockMetaInfo);
    ...
    public void testGetServicePropertiesSimpleInvocation() throws Exception {
      ...
      ShpurdpMetaInfo mockShpurdpMetaInfo = injector.getInstance(ShpurdpMetaInfo.class);
      ...
      expect(mockShpurdpMetaInfo.getService("HDP", "2.2", "SERVICE")).andReturn(mockServiceInfo).once();

      expect(mockServiceInfo.getProperties()).andReturn(serviceProperties).once();

      replay(mockShpurdpMetaInfo, mockCluster, mockService, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
      ...
      verify(mockShpurdpMetaInfo, mockCluster, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
    }
    ...
    public void testGetServicePropertiesDoNoRemoveExcluded() throws Exception {
      ...
      replay(mockShpurdpMetaInfo, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
      ...
      verify(mockShpurdpMetaInfo, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
    }
