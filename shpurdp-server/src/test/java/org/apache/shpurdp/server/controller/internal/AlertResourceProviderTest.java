...
import static org.apache.shpurdp.server.configuration.Configuration.JDBC_IN_MEMORY_DRIVER;
import static org.apache.shpurdp.server.configuration.Configuration.JDBC_IN_MEMORY_URL;
...
import org.apache.shpurdp.server.api.query.render.AlertStateSummary;
import org.apache.shpurdp.server.api.query.render.AlertSummaryGroupedRenderer;
import org.apache.shpurdp.server.api.query.render.AlertSummaryGroupedRenderer.AlertDefinitionSummary;
import org.apache.shpurdp.server.api.query.render.AlertSummaryRenderer;
...
public class AlertResourceProviderTest {
  ...
  private ShpurdpManagementController m_amc;
  ...
  public void before() throws Exception {
    ...
    m_amc = m_injector.getInstance(ShpurdpManagementController.class);
  ...
  private class MockModule implements Module {
    ...
    public void configure(Binder binder) {
      ...
      binder.bind(ShpurdpManagementController.class).toInstance(createMock(ShpurdpManagementController.class));
