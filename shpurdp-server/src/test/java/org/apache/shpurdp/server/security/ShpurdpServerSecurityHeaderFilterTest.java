...
public class ShpurdpServerSecurityHeaderFilterTest extends AbstractSecurityHeaderFilterTest {
  ...
  public ShpurdpServerSecurityHeaderFilterTest() {
    super(ShpurdpServerSecurityHeaderFilter.class, PROPERTY_NAME_MAP, DEFAULT_PROPERTY_VALUE_MAP);
  }
