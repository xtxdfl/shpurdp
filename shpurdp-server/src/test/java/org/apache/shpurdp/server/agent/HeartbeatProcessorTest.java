...
import static org.apache.shpurdp.server.agent.DummyHeartbeatConstants.HBASE_MASTER;
...
public class HeartbeatProcessorTest {
  ...
  @Inject
  private ShpurdpMetaInfo metaInfo;
  ...
  @Test
  public void testCommandReport() throws ShpurdpException {
    injector.injectMembers(this);
  ...
  public void testHeartBeatWithAlertAndInvalidCluster() throws Exception {
    ...
    // should NOT throw ShpurdpException from alerts.
