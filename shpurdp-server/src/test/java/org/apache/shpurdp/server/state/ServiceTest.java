...
public class ServiceTest {
  ...
  @Test
  public void testGetAndSetServiceInfo() throws ShpurdpException {
  ...
  @Test
  public void testAddGetDeleteServiceComponents() throws ShpurdpException {
    String serviceName = "HDFS";
    Service s = serviceFactory.createNew(cluster, serviceName, repositoryVersion);
    cluster.addService(s);
  ...
  @Test
  public void testClusterConfigsUnmappingOnDeleteAllServiceConfigs() throws ShpurdpException {
    String serviceName = "HDFS";
    Service s = serviceFactory.createNew(cluster, serviceName, repositoryVersion);
    cluster.addService(s);
  ...
  @Test
  public void testDeleteAllServiceConfigGroups() throws ShpurdpException {
    String serviceName = "HDFS";
    Service s = serviceFactory.createNew(cluster, serviceName, repositoryVersion);
    cluster.addService(s);
