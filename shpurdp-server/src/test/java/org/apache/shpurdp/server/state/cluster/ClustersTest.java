...
public class ClustersTest {
  ...
  @Test
  public void testGetInvalidCluster() throws ShpurdpException {
    try {
  ...
  @Test
  public void testAddAndGetCluster() throws ShpurdpException {
  ...
  @Test
  public void testAddAndGetClusterWithSecurityType() throws ShpurdpException {
    StackId stackId = new StackId("HDP-2.1.1");
  ...
  @Test
  public void testAddAndGetHost() throws ShpurdpException {
    String h1 = "h1";
    String h2 = "h2";
    String h3 = "h3";
  ...
  @Test
  public void testClusterHostMapping() throws ShpurdpException {
    String c1 = "c1";
    String c2 = "c2";
    String h1 = "h1";
    String h2 = "h2";
  ...
  @Test
  public void testDebugDump() throws ShpurdpException {
    String c1 = "c1";
    String c2 = "c2";
    String h1 = "h1";
    String h2 = "h2";
  ...
  @Test
  public void testNullHostNamesInTopologyRequests() throws ShpurdpException {
  ...
  private void addHostToCluster(String hostName, String clusterName) throws ShpurdpException {
  ...
  private Cluster createCluster(String clusterName) throws ShpurdpException {
    StackId stackId = new StackId("HDP-0.1");
