...
public class UpdateActiveRepoVersionOnStartupTest {
  ...
  public void init(boolean addClusterVersion) throws Exception {
    ...
    final ShpurdpMetaInfo metaInfo = mock(ShpurdpMetaInfo.class);
    ...
    repoOsEntity1.setShpurdpManaged(true);
    ...
    repoOsEntity2.setShpurdpManaged(true);
    ...
    InMemoryDefaultTestModule testModule = new InMemoryDefaultTestModule() {
      ...
      protected void configure() {
        ...
        bind(ShpurdpMetaInfo.class).toProvider(new Provider<ShpurdpMetaInfo>() {
          @Override
