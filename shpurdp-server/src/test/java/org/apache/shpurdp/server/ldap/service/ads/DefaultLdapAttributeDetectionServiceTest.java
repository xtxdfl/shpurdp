...
import org.apache.shpurdp.server.ldap.service.ads.detectors.ChainedAttributeDetector;
...
public class DefaultLdapAttributeDetectionServiceTest extends EasyMockSupport {
  ...
  public void shouldLdapUserAttributeDetection() throws Exception {
    ...
    configMap.put(ShpurdpServerConfigurationKey.USER_SEARCH_BASE.key(), "dc=example,dc=com");
    ShpurdpLdapConfiguration ldapConfiguration = new ShpurdpLdapConfiguration(configMap);
    ...
    // WHEN
    replayAll();
    ShpurdpLdapConfiguration decorated = defaultLdapAttributeDetectionService.detectLdapUserAttributes(ldapConfiguration);
  ...
  public void testShouldUserAttributeDetectionFailWhenLdapOerationFails() throws Exception {
    ...
    EasyMock.expect(ldapConnectionTemplateFactoryMock.create(ldapConfiguration)).andThrow(new ShpurdpLdapException("Testing ..."));
  ...
  public void shouldLdapGroupAttributeDetection() throws Exception {
    ...
    // WHEN
    replayAll();
    ShpurdpLdapConfiguration decorated = defaultLdapAttributeDetectionService.detectLdapGroupAttributes(ldapConfiguration);
