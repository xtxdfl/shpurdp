...
public class VariableReplacementHelperTest {
  ...
  @Test
  public void testReplaceVariables() throws ShpurdpException {
    ...
    try {
      ...
      Assert.fail(String.format("%s expected to be thrown", ShpurdpRuntimeException.class.getName()));
    } catch (ShpurdpRuntimeException e) {
      // This is expected...
    }
  }
  @Test
  public void testReplaceVariablesRecursive() throws ShpurdpException {
    Map<String, Map<String, String>> configurations = new HashMap<String, Map<String, String>>() {
      {
        put("", new HashMap<String, String>());
  ...
  @Test
  public void testReplaceComplicatedVariables() throws ShpurdpException {
    Map<String, Map<String, String>> configurations = new HashMap<String, Map<String, String>>() {
      {
        put("", new HashMap<String, String>() {{
          put("host", "c6401.shpurdp.apache.org");
          put("realm", "EXAMPLE.COM");
        }});
      }
    };

    assertEquals("hive.metastore.local=false,hive.metastore.uris=thrift://c6401.shpurdp.apache.org:9083,hive.metastore.sasl.enabled=true,hive.metastore.execute.setugi=true,hive.metastore.warehouse.dir=/apps/hive/warehouse,hive.exec.mode.local.auto=false,hive.metastore.kerberos.principal=hive/_HOST@EXAMPLE.COM",
    ...
    assertEquals("$c6401.shpurdp.apache.org",
      helper.replaceVariables("$${host}", configurations));
  }

  @Test
  public void testReplaceVariablesWithFunctions() throws ShpurdpException {
    Map<String, Map<String, String>> configurations = new HashMap<String, Map<String, String>>() {
      {
        put("", new HashMap<String, String>() {{
          put("delimited.data", "one,two,three,four");
          put("realm", "UNIT.TEST");
          put("admin_server_host", "c7401.shpurdp.apache.org");
          put("admin_server_host_port", "c7401.shpurdp.apache.org:8080");
        }});
    ...
    assertEquals("kadmin/c7401.shpurdp.apache.org", helper.replaceVariables("kadmin/${admin_server_host|stripPort()}", configurations));
    assertEquals("kadmin/c7401.shpurdp.apache.org", helper.replaceVariables("kadmin/${admin_server_host_port|stripPort()}", configurations));
  }

  @Test
  public void testReplacePrincipalWithPrimary() throws ShpurdpException {
