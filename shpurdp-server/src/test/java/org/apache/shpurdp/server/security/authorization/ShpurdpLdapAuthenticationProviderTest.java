...
public class ShpurdpLdapAuthenticationProviderTest extends EasyMockSupport {
  private static final String ALLOWED_USER_NAME = "allowedUser";
  private static final String ALLOWED_USER_DN = "uid=alloweduser,ou=people,dc=shpurdp,dc=apache,dc=org";
  ...
  public void testBadCredential() throws Exception {
    ...
    ShpurdpLdapConfigurationProvider ldapConfigurationProvider = createMock(ShpurdpLdapConfigurationProvider.class);
    ShpurdpLdapAuthoritiesPopulator authoritiesPopulator = createMock(ShpurdpLdapAuthoritiesPopulator.class);
    ...
    ShpurdpLdapAuthenticationProvider authenticationProvider = createMockBuilder(ShpurdpLdapAuthenticationProvider.class)
  ...
  public void testAuthenticate() throws Exception {
    ...
    assertTrue(result instanceof ShpurdpUserAuthentication);
