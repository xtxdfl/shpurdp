...
import static org.apache.shpurdp.server.state.ConfigHelper.CLUSTER_ENV_STACK_FEATURES_PROPERTY;
import static org.apache.shpurdp.server.state.ConfigHelper.CLUSTER_ENV_STACK_NAME_PROPERTY;
import static org.apache.shpurdp.server.state.ConfigHelper.CLUSTER_ENV_STACK_PACKAGES_PROPERTY;
import static org.apache.shpurdp.server.state.ConfigHelper.CLUSTER_ENV_STACK_ROOT_PROPERTY;
import static org.apache.shpurdp.server.state.ConfigHelper.CLUSTER_ENV_STACK_TOOLS_PROPERTY;
...
import org.apache.shpurdp.server.topology.AdvisedConfiguration;
import org.apache.shpurdp.server.topology.ShpurdpContext;
import org.apache.shpurdp.server.topology.Blueprint;
import org.apache.shpurdp.server.topology.Cardinality;
import org.apache.shpurdp.server.topology.ClusterTopology;
import org.apache.shpurdp.server.topology.ClusterTopologyImpl;
import org.apache.shpurdp.server.topology.Component;
import org.apache.shpurdp.server.topology.ConfigRecommendationStrategy;
import org.apache.shpurdp.server.topology.Configuration;
import org.apache.shpurdp.server.topology.HostGroup;
import org.apache.shpurdp.server.topology.HostGroupImpl;
import org.apache.shpurdp.server.topology.HostGroupInfo;
import org.apache.shpurdp.server.topology.InvalidTopologyException;
...
public class BlueprintConfigurationProcessorTest extends EasyMockSupport {
  ...
  public void init() throws Exception {
    ...
    serviceComponents.put("SHPURDP_METRICS", amsComponents);
    ...
    expect(shpurdpContext.getConfigHelper()).andReturn(configHelper).anyTimes();
   ...
   stackProperties.put(ConfigHelper.CLUSTER_ENV, defaultClusterEnvProperties);
    ...
    expect(shpurdpContext.isClusterKerberosEnabled(1)).andReturn(true).once();
    expect(shpurdpContext.getClusterName(1L)).andReturn("clusterName").anyTimes();
    PowerMock.mockStatic(ShpurdpServer.class);
    expect(ShpurdpServer.getController()).andReturn(controller).anyTimes();
  ...
  public void tearDown() {
    reset(bp, serviceInfo, stack, shpurdpContext, configHelper);
  }
  ...
  public void testFalconConfigExport() throws Exception {
    final String expectedHostName = "c6401.apache.shpurdp.org";
  ...
  public void testDoNameNodeHighAvailabilityExportWithHAEnabledMultipleServices() throws Exception {
    ...
    final String expectedHostNameOne = "c6401.apache.shpurdp.org";
    final String expectedHostNameTwo = "c6402.apache.shpurdp.org";
...
//    hosts.add("serverTwo");
  ...
  public void testHiveConfigExported() throws Exception {
    final String expectedHostName = "c6401.apache.shpurdp.org";
    final String expectedHostNameTwo = "c6402.shpurdp.apache.org";
    final String expectedPortNum = "808080";
    final String expectedHostGroupName = "host_group_1";
  ...
  public void testOozieConfigExported() throws Exception {
    final String expectedHostName = "c6401.apache.shpurdp.org";
    final String expectedHostNameTwo = "c6402.shpurdp.apache.org";
    final String expectedExternalHost = "c6408.shpurdp.apache.org";
    final String expectedHostGroupName = "host_group_1";
    final String expectedHostGroupNameTwo = "host_group_2";
...
//    multiOozieSiteMap.put("hadoop.proxyuser.knox.hosts", new MultipleHostTopologyUpdater("KNOX_GATEWAY"));
  ...
  public void testHiveConfigClusterUpdateSpecifyingHostNamesHiveServer2HA() throws Exception {
    ...
    final String expectedMetaStoreURIs = "thrift://c6401.shpurdp.apache.org:9083,thrift://c6402.shpurdp.apache.org:9083";
  ...
  private void testHiveMetastoreHA(String separator) throws InvalidTopologyException, ConfigurationTopologyException {
    ...
    final String[] hostNames = new String[]{"c6401.shpurdp.apache.org", "example.com", "c6402.shpurdp.apache.org"};
  ...
  public void testDoUpdateForClusterCreate_Storm_Nimbus_HA_Enabled__FQDN_ValuesSpecified_YAML() throws Exception {
    final String expectedValue = "[c6401.shpurdp.apache.org, c6402.shpurdp.apache.org]";
    Map<String, Map<String, String>> properties = new HashMap<>();
    Map<String, String> typeProps = new HashMap<>();
  ...
  public void testExcludedPropertiesShouldBeAddedWhenServiceIsInBlueprint() throws Exception {
    ...
    hosts.add("c6401.apache.shpurdp.org");
    hosts.add("serverTwo");
  ...
  public void testHiveConfigClusterUpdateDefaultValue() throws Exception {
    final String expectedHostGroupName = "host_group_1";
    final String expectedHostName = "c6401.shpurdp.apache.org";
  ...
  public void testAtlas() throws Exception {
    ...
    final String host1 = "c6401.shpurdp.apache.org";
    final String host2 = "c6402.shpurdp.apache.org";
    final String host3 = "c6403.shpurdp.apache.org";
    ...
    atlasProperties.put("atlas.graph.index.search.solr.zookeeper-url", "localhost:2181/shpurdp-solr");
    ...
    List<String> expected =
      Arrays.asList("c6401.shpurdp.apache.org:6667", "c6402.shpurdp.apache.org:6667");
  ...
  public void testDoUpdateForClusterWithNameNodeFederationEnabled() throws Exception {
    ...
    final String expectedHostName = "c6401.apache.shpurdp.org";
    final String expectedHostNameTwo = "c6402.apache.shpurdp.org";
    final String expectedHostNameThree = "c6403.apache.shpurdp.org";
    final String expectedHostNameFour = "c6404.apache.shpurdp.org";
    final String expectedPortNum = "808080";
    final String expectedNodeOne = "nn1";
    final String expectedNodeTwo = "nn2";
  ...
  public void testDoUpdateForClusterWithNameNodeFederationEnabledErrorClusterNameNotFound() throws Exception {
    ...
    ShpurdpContext mockShpurdpContext = mockSupport.createMock(ShpurdpContext.class);

    // configure mock to return null cluster name (error condition)
    expect(mockShpurdpContext.getClusterName(1)).andReturn(null).anyTimes();
    ...
    ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups, mockShpurdpContext);
    BlueprintConfigurationProcessor updater = new BlueprintConfigurationProcessor(topology);
  ...
  public void testHawqConfigClusterUpdate() throws Exception {
    final String expectedHostNameHawqMaster = "c6401.apache.shpurdp.org";
    final String expectedHostNameHawqStandby = "c6402.apache.shpurdp.org";
    final String expectedHostNameNamenode = "c6403.apache.shpurdp.org";
  ...
  private ClusterTopology createClusterTopology(Blueprint blueprint, Configuration configuration,
                                                Collection<TestHostGroup> hostGroups, ShpurdpContext shpurdpContextReplacement)
    throws InvalidTopologyException {


    replay(stack, serviceInfo, shpurdpContext, configHelper, controller, kerberosHelper, kerberosDescriptor, clusters, cluster);
    ...
    if (shpurdpContextReplacement != null) {
      // override the mock ShpurdpContext setup in the default Before method
      // Note, this should only be used in a small number of test cases to verify exception
      // behavior when the ShpurdpContext returns an unexpected value
      shpurdpContext = shpurdpContextReplacement;
    }

    ClusterTopology topology = new ClusterTopologyImpl(shpurdpContext, topologyRequestMock);
    topology.setConfigRecommendationStrategy(ConfigRecommendationStrategy.NEVER_APPLY);
