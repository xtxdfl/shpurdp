...
import org.apache.shpurdp.server.serveraction.upgrades.ManualStageAction;
...
public class ServerActionExecutorTest {
  ...
  public void testServerAction() throws Exception {
    ...
    s.getHostRoleCommand(SERVER_HOST_NAME, Role.SHPURDP_SERVER_ACTION.toString()).setStatus(HostRoleStatus.QUEUED);
  ...
  public void testServerActionManualStage() throws Exception {
    ...
    stage.addServerActionCommand(ManualStageAction.class.getName(),
        null, Role.SHPURDP_SERVER_ACTION, RoleCommand.EXECUTE, "cluster1",
    ...
    // Force the task to be QUEUED
    stage.getHostRoleCommand(SERVER_HOST_NAME, Role.SHPURDP_SERVER_ACTION.toString()).setStatus(HostRoleStatus.QUEUED);
  ...
  private HostRoleStatus getTaskStatus(Stage stage) {
    return stage.getHostRoleStatus(SERVER_HOST_NAME, "SHPURDP_SERVER_ACTION");
  }
        ...
        andAnswer(new IAnswer<Stage>() {
          ...
          public Stage answer() throws Throwable {
            ...
            stage.addServerActionCommand(MockServerAction.class.getName(), null,
                Role.SHPURDP_SERVER_ACTION, RoleCommand.EXECUTE, "cluster1",
