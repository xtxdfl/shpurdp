...
public class JwtAuthenticationPropertiesTest {
  ...
  public void testSetEmptyAudiences() {
    ...
    configurationMap.put(ShpurdpServerConfigurationKey.SSO_JWT_AUDIENCES.key(), "");
  ...
  public void testSetValidAudiences() {
    ...
    final Map<String, String> configurationMap = new HashMap<>();
    configurationMap.put(ShpurdpServerConfigurationKey.SSO_JWT_AUDIENCES.key(), "first,second,third");
