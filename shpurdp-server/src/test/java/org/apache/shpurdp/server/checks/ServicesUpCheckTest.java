...
public class ServicesUpCheckTest {
  ...
  public void testPerform() throws Exception {
    ...
    servicesUpCheck.shpurdpMetaInfo = new Provider<ShpurdpMetaInfo>() {
      @Override
    ...
    servicesUpCheck.checkHelperProvider = new Provider<CheckHelper>() {
      ...
      public CheckHelper get() {
        ...
        mockCheckHelper.setMetaInfoProvider(servicesUpCheck.shpurdpMetaInfo);
    ...
    Mockito.when(HostComponentSummary.getHostComponentSummaries("SHPURDP_METRICS", "METRICS_COLLECTOR")).thenReturn(Arrays.asList(hcsMetricsCollector));
    Mockito.when(HostComponentSummary.getHostComponentSummaries("SHPURDP_METRICS", "METRICS_MONITOR")).thenReturn(Arrays.asList(hcsMetricsMonitor));
