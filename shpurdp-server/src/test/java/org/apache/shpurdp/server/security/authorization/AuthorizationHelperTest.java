...
public class AuthorizationHelperTest  extends EasyMockSupport {
  ...
  public void testAuthId() throws Exception {
    ...
    Authentication auth = new ShpurdpUserAuthentication(null, new ShpurdpUserDetailsImpl(user, null, null));
    SecurityContextHolder.getContext().setAuthentication(auth);
  ...
  public void testIsAuthorized() {
    ...
    administratorRoleAuthorizationEntity.setAuthorizationId(RoleAuthorization.SHPURDP_MANAGE_USERS.getId());

    ResourceTypeEntity shpurdpResourceTypeEntity = new ResourceTypeEntity();
    shpurdpResourceTypeEntity.setId(1);
    shpurdpResourceTypeEntity.setName(ResourceType.SHPURDP.name());
    ...
    ResourceEntity shpurdpResourceEntity = new ResourceEntity();
    shpurdpResourceEntity.setResourceType(shpurdpResourceTypeEntity);
    shpurdpResourceEntity.setId(1L);
    ...
    administratorPrivilegeEntity.setResource(shpurdpResourceEntity);

    GrantedAuthority readOnlyAuthority = new ShpurdpGrantedAuthority(readOnlyPrivilegeEntity);
    GrantedAuthority readOnly2Authority = new ShpurdpGrantedAuthority(readOnly2PrivilegeEntity);
    GrantedAuthority privilegedAuthority = new ShpurdpGrantedAuthority(privilegedPrivilegeEntity);
    GrantedAuthority privileged2Authority = new ShpurdpGrantedAuthority(privileged2PrivilegeEntity);
    GrantedAuthority administratorAuthority = new ShpurdpGrantedAuthority(administratorPrivilegeEntity);

    Authentication noAccessUser = new TestAuthentication(Collections.<ShpurdpGrantedAuthority>emptyList());
    ...
    assertFalse(AuthorizationHelper.isAuthorized(noAccessUser, ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
    ...
    assertFalse(AuthorizationHelper.isAuthorized(readOnlyUser, ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
    ...
    assertFalse(AuthorizationHelper.isAuthorized(privilegedUser, ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
    ...
    assertFalse(AuthorizationHelper.isAuthorized(privileged2User, ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
    ...
    assertTrue(AuthorizationHelper.isAuthorized(administratorUser, ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
    ...
    assertFalse(AuthorizationHelper.isAuthorized(ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.CLUSTER_TOGGLE_KERBEROS)));
    assertFalse(AuthorizationHelper.isAuthorized(ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
    ...
    assertTrue(AuthorizationHelper.isAuthorized(ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.CLUSTER_VIEW_METRICS)));
    assertTrue(AuthorizationHelper.isAuthorized(ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.CLUSTER_TOGGLE_KERBEROS)));
    assertTrue(AuthorizationHelper.isAuthorized(ResourceType.CLUSTER, 1L, EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_USERS)));
  }
  ...
  public void testIsAuthorizedForSpecificView() {
    ...
    GrantedAuthority readOnlyAuthority = new ShpurdpGrantedAuthority(readOnlyPrivilegeEntity);
    GrantedAuthority viewUseAuthority = new ShpurdpGrantedAuthority(viewUsePrivilegeEntity);
    GrantedAuthority administratorAuthority = new ShpurdpGrantedAuthority(administratorPrivilegeEntity);
