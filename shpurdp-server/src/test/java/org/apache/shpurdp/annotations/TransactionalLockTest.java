...
public class TransactionalLockTest {
  ...
  public void testLockAreaEnabled() throws Exception {
    ...
    shpurdpProperties.put(Configuration.SERVER_HRC_STATUS_SUMMARY_CACHE_ENABLED.getKey(), "true");
  ...
  public void testLockAreaEnabledDisabled() throws Exception {
    final Properties shpurdpProperties = new Properties();
    shpurdpProperties.put(Configuration.SERVER_HRC_STATUS_SUMMARY_CACHE_ENABLED.getKey(), "false");
    Configuration configuration = new Configuration(shpurdpProperties);
