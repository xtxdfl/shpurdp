...
class TestBasicAdvisor(TestCase):
  def setUp(self):
    ...
    shpurdpConfigurationPath = os.path.abspath(
      os.path.join(stacksPath, "shpurdp_configuration.py")
    )
    with open(shpurdpConfigurationPath, "rb") as fp:
      imp.load_module(
        "shpurdp_configuration",
        fp,
        shpurdpConfigurationPath,
        (".py", "rb", imp.PY_SOURCE),
      )
      ...
      "items": [
        ...
        },
        {
          "Hosts": {
            ...
            "public_host_name": "c6402.shpurdp.apache.org",
            "host_name": "c6402.shpurdp.apache.org",
          },
        },
      ]
    }
