...
class TestHookBeforeStart(RMFTestCase):
  def test_hook_default(self):
    ...
    self.assertResourceCalled(
      "File",
      "/var/lib/shpurdp-agent/lib/fast-hdfs-resource.jar",
  ...
  def test_hook_refresh_topology_custom_directories(self):
    ...
    default_json["serviceName"] = "HDFS"
    default_json["configurations"]["core-site"]["net.topology.script.file.name"] = (
      "/home/myhadoop/hadoop/conf.hadoop/topology_script.py"
    )
