...
from shpurdp_commons import yaml_utils
...
class TestYAMLUtils(TestCase):
  ...
  def test_convert_yaml_array(self):
    ...
    expected_values.append("c6401.shpurdp.apache.org")
    values = yaml_utils.get_values_from_yaml_array("['c6401.shpurdp.apache.org']")
    self.assertEqual(expected_values, values)

    expected_values.append("c6402.shpurdp.apache.org")
  ...
  def test_yaml_property_escaping(self):
    ...
    map = """
      storm-cluster:
        hosts:
          [c6401.shpurdp.apache.org, c6402.shpurdp.apache.org, c6403-master.shpurdp.apache.org]
        groups:
