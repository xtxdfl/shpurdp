...
from cluster_blueprint import ShpurdpBlueprint
import logging
import pprint
...
class TestClusterBlueprint(TestCase):
  ...
  @patch.object(ShpurdpBlueprint, "performPostOperation")
  ...
  def test_importBlueprint(self, get_server_info_mock, performPostOperationMock):
    ...
    ShpurdpBlueprint.SILENT = True

    shpurdpBlueprint = ShpurdpBlueprint()
    shpurdpBlueprint.importBlueprint(self.TEST_BLUEPRINT, self.BLUEPRINT_HOSTS, "c1")
  ...
  @patch("builtins.open")
  @patch.object(ShpurdpBlueprint, "performGetOperation")
  @patch.object(cluster_blueprint, "get_server_info")
  def test_exportBlueprint(
    self, get_server_info_mock, performGetOperationMock, openMock
  ):
    performGetOperationMock.return_value = "200"

    blueprintUrl = (
      "http://localhost:8080/api/v1/clusters/blueprint"
    ...
    shpurdpBlueprint = ShpurdpBlueprint()
    shpurdpBlueprint.exportBlueprint("blueprint-multinode-default", "/tmp/test")
