...
class TestSensitiveDataEncryption(TestCase):
  ...
  @patch("shpurdp_server.setupSecurity.find_jdk")
  @patch("shpurdp_server.setupSecurity.get_shpurdp_properties")
  @patch("shpurdp_server.setupSecurity.run_os_command")
  def test_sensitive_data_encryption(
    ...
    find_properties_file_mock.return_value = "/tmp/shpurdp.properties"
    ...
    run_os_command_mock.assert_called_with(
      "None -cp test:path12 org.apache.shpurdp.server.security.encryption.SensitiveDataEncryption encription > /var/log/shpurdp-server/shpurdp-server.out 2>&1",
      environ,
    )
    pass

  @patch("shpurdp_server.setupSecurity.print_error_msg")
  @patch("shpurdp_server.setupSecurity.find_jdk")
  ...
  def test_sensitive_data_decryption_not_persisted(
    ...
    run_os_command_mock.assert_called_with(
      "None -cp test:path12 org.apache.shpurdp.server.security.encryption.SensitiveDataEncryption decryption > /var/log/shpurdp-server/shpurdp-server.out 2>&1",
      environ,
    )
    pass
  ...
  @patch("shpurdp_server.setupSecurity.read_shpurdp_user")
  @patch("shpurdp_server.setupSecurity.save_passwd_for_alias")
  @patch("shpurdp_server.setupSecurity.read_passwd_for_alias")
  ...
  @patch("shpurdp_server.setupSecurity.sensitive_data_encryption")
  @patch("shpurdp_server.setupSecurity.get_original_master_key")
  def test_reset_master_key_not_persisted(
    ...
    read_shpurdp_user_method.return_value = None
    ...
    get_shpurdp_properties_method.return_value = p
  ...
  @patch("shpurdp_server.setupSecurity.get_shpurdp_properties")
  @patch("shpurdp_server.setupSecurity.is_root")
  def test_setup_sensitive_data_encryption_no_shpurdp_prop_not_root(
    self, is_root_method, get_shpurdp_properties_method
  ):
    is_root_method.return_value = False
    get_shpurdp_properties_method.return_value = -1
    options = self._create_empty_options_mock()
  ...
  @patch("shpurdp_server.setupSecurity.get_is_secure")
  @patch("shpurdp_server.setupSecurity.get_is_persisted")
  @patch("shpurdp_server.setupSecurity.remove_password_file")
  @patch("shpurdp_server.setupSecurity.save_passwd_for_alias")
  @patch("shpurdp_server.setupSecurity.read_master_key")
  @patch("shpurdp_server.setupSecurity.read_shpurdp_user")
  @patch("shpurdp_server.setupSecurity.update_properties_2")
  @patch("shpurdp_server.setupSecurity.save_master_key")
  @patch("shpurdp_server.setupSecurity.get_YN_input")
  ...
  @patch("shpurdp_server.setupSecurity.is_root")
  @patch("shpurdp_server.setupSecurity.sensitive_data_encryption")
  @patch("shpurdp_server.setupSecurity.adjust_directory_permissions")
  def test_setup_sensitive_data_encryption_not_persist(
    ...
    read_shpurdp_user_method.return_value = "asd"
    save_passwd_for_alias_method.return_value = 0
    ...
    self.assertTrue(read_shpurdp_user_method.called)
    self.assertTrue(update_properties_method.called)
    self.assertFalse(save_master_key_method.called)
