...
import socket
import subprocess
from shpurdp_commons import inet_utils, OSCheck
...
class TestCheckHost(TestCase):
  ...
  def testDBConnectionCheck(
    ...
    mock_config.return_value = {
      ...
      "shpurdpLevelParams": {"custom_mysql_jdbc_name": "mysql-connector-java.jar"},
    ...
    self.assertEqual(
      structured_out_mock.call_args[0][0],
      {
        "db_connection_check": {
          ...
          "DBConnectionVerification.jar from Shpurdp Server resources. Check network access to Shpurdp "
          "Server.\ntest exception",
          "exit_code": 1,
        }
      },
    ...
    mock_config.return_value = {
      ...
      "agentLevelParams": {"agentCacheDir": "/nonexistent_tmp"},
      "shpurdpLevelParams": {"custom_oracle_jdbc_name": "oracle-jdbc-driver.jar"},
    }
    ...
    self.assertEqual(
      ...
      "Error: Shpurdp Server cannot download the database JDBC driver "
      "and is unable to test the database connection. You must run shpurdp-server setup "
      "--jdbc-db={db_name} --jdbc-driver=/path/to/your/{db_name}/driver.jar on the Shpurdp "
    ...
    mock_config.return_value = {
      ...
      "agentLevelParams": {"agentCacheDir": "/nonexistent_tmp"},
      "shpurdpLevelParams": {"custom_postgres_jdbc_name": "oracle-jdbc-driver.jar"},
    }
    format_mock.reset_mock()
    download_file_mock.reset_mock()
    ...
    self.assertEqual(
      ...
      "{jdbc_jar_path} -Djava.library.path={java_library_path} org.apache.shpurdp.server.DBConnectionVerification"
    ...
    mock_config.return_value = {
      ...
      "agentLevelParams": {"agentCacheDir": "/nonexistent_tmp"},
      "shpurdpLevelParams": {"custom_postgres_jdbc_name": "test-postgres-jdbc.jar"},
    }
    ...
    structured_out_mock.assert_called_with(
      {
        "host_resolution_check": {
          "failures": [
            {"cause": (), "host": "c6401.shpurdp.apache.org", "type": "FORWARD_LOOKUP"},
            {"cause": (), "host": "c6402.shpurdp.apache.org", "type": "FORWARD_LOOKUP"},
            {"cause": (), "host": "c6403.shpurdp.apache.org", "type": "FORWARD_LOOKUP"},
  ...
  @patch.object(Script, "get_tmp_dir")
  @patch("resource_management.libraries.script.Script.put_structured_out")
  @patch("shpurdp_agent.HostInfo.HostInfoLinux.javaProcs")
  @patch("shpurdp_agent.HostInfo.HostInfoLinux.checkLiveServices")
  @patch("shpurdp_agent.HostInfo.HostInfoLinux.getUMask")
  @patch("shpurdp_agent.HostInfo.HostInfoLinux.getTransparentHugePage")
  @patch("shpurdp_agent.HostInfo.HostInfoLinux.checkFirewall")
  @patch("shpurdp_agent.HostInfo.HostInfoLinux.checkReverseLookup")
  @patch("time.time")
  ...
  @patch.object(Script, "get_tmp_dir")
  @patch("resource_management.libraries.script.Script.put_structured_out")
  @patch("shpurdp_agent.HostInfo.HostInfoWindows.javaProcs")
  @patch("shpurdp_agent.HostInfo.HostInfoWindows.checkLiveServices")
  @patch("shpurdp_agent.HostInfo.HostInfoWindows.getUMask")
  @patch("shpurdp_agent.HostInfo.HostInfoWindows.checkFirewall")
  @patch("shpurdp_agent.HostInfo.HostInfoWindows.checkReverseLookup")
  @patch("time.time")
  def testLastAgentEnv(
    self,
    time_mock,
  ...
  @patch.object(HostCheckReportFileHandler, "resolve_shpurdp_config")
  @patch("resource_management.libraries.script.Script.put_structured_out")
  @patch.object(Script, "get_tmp_dir")
  @patch.object(Script, "get_config")
  @patch("os.path.isfile")
