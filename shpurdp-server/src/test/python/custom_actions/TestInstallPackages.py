...
class TestInstallPackages(RMFTestCase):
  ...
  def test_get_installed_package_version(self):
    ...
    from shpurdp_commons.shell import SubprocessCallResult

    r = SubprocessCallResult("3.1.0.0-54.el7.centos", "", 0)

    pkg_manager = ManagerFactory.get_new_instance(OSConst.REDHAT_FAMILY)
    with patch("shpurdp_commons.shell.subprocess_executor") as checked_call_mock:
  ...
  @patch("shpurdp_commons.repo_manager.ManagerFactory.get")
  @patch("resource_management.libraries.script.Script.put_structured_out")
  @patch("resource_management.libraries.functions.stack_select.get_stack_versions")
  @patch(
    "resource_management.libraries.functions.repo_version_history.read_actual_version_from_history_file"
  )
  @patch(
    "resource_management.libraries.functions.repo_version_history.write_actual_version_to_history_file"
  )
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_normal_flow_rhel(
    self,
    ...
    with patch.object(pkg_manager, "all_packages") as all_packages, patch.object(
      pkg_manager, "available_packages"
    ) as available_packages, patch.object(
      pkg_manager, "installed_packages"
    ) as installed_packages, patch.object(
      pkg_manager, "_check_existence"
    ) as check_existence:
      ...
      self.assertEqual(
        put_structured_out_mock.call_args[0][0],
        {
  ...
  @patch("shpurdp_commons.os_check.OSCheck.is_suse_family")
  @patch("shpurdp_commons.repo_manager.ManagerFactory.get")
  @patch("resource_management.libraries.script.Script.put_structured_out")
  @patch("resource_management.libraries.functions.stack_select.get_stack_versions")
  @patch(
  ...
  @patch("shpurdp_commons.os_check.OSCheck.is_redhat_family")
  @patch("resource_management.libraries.script.Script.put_structured_out")
  @patch("shpurdp_commons.repo_manager.ManagerFactory.get")
  @patch("resource_management.libraries.functions.stack_select.get_stack_versions")
  @patch(
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_exclude_existing_repo(
    self,
    subprocess_with_timeout,
    write_actual_version_to_history_file_mock,
    read_actual_version_from_history_file_mock,
  ...
  def test_fail(
    ...
    with patch.object(pkg_manager, "all_packages") as all_packages, patch.object(
      ...
      self.assertEqual(
        put_structured_out_mock.call_args[0][0],
        {"repository_version_id": 1, "package_installation_result": "FAIL"},
      )
      self.assertResourceCalled(
        "Repository",
        "HDP-UTILS-1.1.0.20",
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_format_package_name_via_repositoryFile(
    self,
    subprocess_with_timeout,
    write_actual_version_to_history_file_mock,
    read_actual_version_from_history_file_mock,
    ...
    with patch.object(pkg_manager, "all_packages") as all_packages, patch.object(
      ...
      config_file = (
        self.get_src_folder()
        + "/test/python/custom_actions/configs/install_packages_repository_file.json"
      )
      with open(config_file, "r") as f:
        command_json = json.load(f)
      ...
      repo_file_name = "shpurdp-hdp-4"
      use_repos = {
        "HDP-UTILS-1.1.0.20-repo-4": repo_file_name,
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_version_reporting__build_number_defined(
    self,
    subprocess_with_timeout,
    write_actual_version_to_history_file_mock,
    read_actual_version_from_history_file_mock,
    ...
    with patch.object(pkg_manager, "all_packages") as all_packages, patch.object(
      ...
      self.assertEqual(
        write_actual_version_to_history_file_mock.call_args[0],
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_version_reporting__build_number_not_defined_stack_root_present__no_components_installed(
    self,
    subprocess_with_timeout,
    exists_mock,
    write_actual_version_to_history_file_mock,
    ...
    with patch.object(pkg_manager, "all_packages") as all_packages, patch.object(
      ...
      self.assertTrue(put_structured_out_mock.called)
      self.assertEqual(
        put_structured_out_mock.call_args_list[-1][0][0],
        {
  ...
  @patch("os.path.exists")
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_version_reporting__build_number_not_defined_stack_root_absent(
    self,
    subprocess_with_timeout,
    exists_mock,
    write_actual_version_to_history_file_mock,
    ...
    with patch.object(pkg_manager, "all_packages") as all_packages, patch.object(
      ...
      self.assertEqual(
        put_structured_out_mock.call_args_list[-1][0][0],
        {"package_installation_result": "FAIL", "repository_version_id": 1},
      )
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_version_reporting__build_number_not_defined_stack_root_present(
    self,
    subprocess_with_timeout,
    write_actual_version_to_history_file_mock,
    read_actual_version_from_history_file_mock,
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_version_reporting__wrong_build_number_specified_stack_root_present(
    self,
    subprocess_with_timeout,
    write_actual_version_to_history_file_mock,
    read_actual_version_from_history_file_mock,
    ...
    command_json["repositoryFile"]["repoVersion"] = (
      "2.2.0.1-500"  # User specified wrong build number
    )
  ...
  @patch("os.path.exists")
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_version_reporting__wrong_build_number_specified_stack_root_absent(
    self,
    subprocess_with_timeout,
    exists_mock,
    write_actual_version_to_history_file_mock,
  ...
  @patch("shpurdp_commons.shell.launch_subprocess")
  def test_normal_flow_rhel_with_command_repo(
    self,
    subprocess_with_timeout,
    write_actual_version_to_history_file_mock,
    read_actual_version_from_history_file_mock,
