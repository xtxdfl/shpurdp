...
newtmpdirpath = os.path.join(oldtmpdirpath, "shpurdp-test")
...
def main():
  ...
  shpurdp_server_folder = get_parent_path(pwd, "shpurdp-server")
  shpurdp_agent_folder = os.path.normpath(
    os.path.join(shpurdp_server_folder, "../shpurdp-agent")
  )
  shpurdp_common_folder = os.path.normpath(
    os.path.join(shpurdp_server_folder, "../shpurdp-common")
  )
  sys.path.append(os.path.join(shpurdp_common_folder, "src/main/python"))
  sys.path.append(os.path.join(shpurdp_common_folder, "src/main/python/shpurdp_jinja2"))
  sys.path.append(os.path.join(shpurdp_common_folder, "src/test/python"))
  sys.path.append(os.path.join(shpurdp_agent_folder, "src/main/python"))
  sys.path.append(os.path.join(shpurdp_server_folder, "src/test/python"))
  sys.path.append(os.path.join(shpurdp_server_folder, "src/main/python"))
  sys.path.append(os.path.join(shpurdp_server_folder, "src/main/resources/scripts"))
  sys.path.append(
    os.path.join(shpurdp_server_folder, "src/main/resources/custom_actions/scripts")
  )
  sys.path.append(os.path.join(shpurdp_server_folder, "src/main/resources/host_scripts"))
  ...
  # run base shpurdp-server tests
  sys.stderr.write("Running tests for shpurdp-server\n")
  ...
  test_dirs = [
    ...
    (pwd, "\nRunning tests for shpurdp-server\n"),
  ]
