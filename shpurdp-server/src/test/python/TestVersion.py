...
class TestVersion(TestCase):
  ...
  of both Shpurdp (which use 3 digits separated by dots) and stacks (which use 4 digits separated by dots).
  """
  ...
  def setUp(self):
    ...
    test_file_path = os.path.join(
      self.test_directory,
      "../../../../shpurdp-common/src/main/python/resource_management/libraries/functions/version.py",
    )
