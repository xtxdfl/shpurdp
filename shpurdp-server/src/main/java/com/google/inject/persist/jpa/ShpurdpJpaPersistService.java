 ...
 */
public class ShpurdpJpaPersistService extends JpaPersistService {

  private final AtomicBoolean jpaStarted = new AtomicBoolean(false);

  @Inject
  public ShpurdpJpaPersistService(@Jpa String persistenceUnitName, @Jpa Map<?, ?> persistenceProperties) {
