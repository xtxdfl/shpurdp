...
import static org.apache.shpurdp.server.controller.spi.Resource.InternalType.Component;
import static org.apache.shpurdp.server.controller.spi.Resource.InternalType.HostComponent;
import static org.apache.shpurdp.server.controller.utilities.PropertyHelper.AGGREGATE_FUNCTION_IDENTIFIERS;
...
import org.apache.shpurdp.server.controller.MpackRequest;
import org.apache.shpurdp.server.controller.MpackResponse;
...
import org.apache.shpurdp.server.customactions.ActionDefinitionManager;
import org.apache.shpurdp.server.events.AlertDefinitionDisabledEvent;
...
import org.apache.shpurdp.server.metadata.ShpurdpServiceAlertDefinitions;
import org.apache.shpurdp.server.mpack.MpackManager;
...
import org.apache.shpurdp.server.stack.StackManager;
import org.apache.shpurdp.server.stack.StackManagerFactory;
import org.apache.shpurdp.server.stack.upgrade.ConfigUpgradePack;
...
import org.apache.shpurdp.server.state.alert.ScriptSource;
import org.apache.shpurdp.server.state.alert.Source;
import org.apache.shpurdp.server.state.alert.SourceType;
...
public class ShpurdpMetaInfo {
  ...
  private final static Logger LOG = LoggerFactory.getLogger(ShpurdpMetaInfo.class);
   ...
   */
  @Inject
  private ShpurdpServiceAlertDefinitions shpurdpServiceAlertDefinitions;
  ...
  */
  ...
  /**
   * Shpurdp Meta Info Object
   *
   * @param conf Configuration API to be used.
   * @throws Exception
   */
  @Inject
  public ShpurdpMetaInfo(Configuration conf) throws Exception {
    this.conf = conf;
  ...
  /**
   * Initialize the Shpurdp Meta Info
   *
  ...
  public ComponentInfo getComponent(String stackName, String version, String serviceName,
                                    String componentName) throws ShpurdpException {
   ...
   * @throws ShpurdpException if unable to obtain the dependencies for the component
   */
   ...
   * @throws ShpurdpException if unable to obtain the requested dependency
   */
  public DependencyInfo getComponentDependency(String stackName, String version, String service,
                                               String component, String dependencyName) throws ShpurdpException {
  ...
  public Map<String, List<RepositoryInfo>> getRepository(String stackName,
                                                         String version) throws ShpurdpException {
  ...
  public List<RepositoryInfo> getRepositories(String stackName,
                                              String version, String osType) throws ShpurdpException {
  ...
  public RepositoryInfo getRepository(String stackName,
                                      String version, String osType, String repoId) throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  public Map<String, ServiceInfo> getServices(String stackName, String version) throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  public ServiceInfo getService(Service service) throws ShpurdpException {
    StackId stackId = service.getDesiredStackId();
    return getService(stackId.getStackName(), stackId.getStackVersion(), service.getName());
  }

  public ServiceInfo getService(String stackName, String version, String serviceName) throws ShpurdpException {
  ...
  public boolean isServiceRemovedInStack(String stackName, String version, String serviceName) throws ShpurdpException{
    StackInfo stack = getStack(stackName, version);
    List<String> removedServices = stack.getRemovedServices();
    return removedServices.contains(serviceName);
  }

  public boolean isServiceWithNoConfigs(String stackName, String version, String serviceName) throws ShpurdpException{
    StackInfo stack = getStack(stackName, version);
   ...
   *
   * @throws ShpurdpException if the service set can not be acquired
   */
  ...
  public Collection<StackInfo> getStacks(String stackName) throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  public StackInfo getStack(StackId stackId) throws ShpurdpException {
    return getStack(stackId.getStackName(), stackId.getStackVersion());
  }

  public StackInfo getStack(String stackName, String version) throws ShpurdpException {
    StackInfo stackInfoResult = stackManager.getStack(stackName, version);

    if (stackInfoResult == null) {
      throw new StackAccessException("Stack " + stackName + " " + version + " is not found in Shpurdp metainfo");
    }
  ...
  public Collection<ExtensionInfo> getExtensions(String extensionName) throws ShpurdpException {
  ...
  public ExtensionInfo getExtension(String extensionName, String version) throws ShpurdpException {
    ExtensionInfo result = stackManager.getExtension(extensionName, version);

    if (result == null) {
      throw new StackAccessException("Extension " + extensionName + " " + version + " is not found in Shpurdp metainfo");
    }
  ...
  private void readServerVersion() throws Exception {
    ...
    if (!versionFile.exists()) {
      throw new ShpurdpException("Server version file does not exist.");
    }
  ...
  private void getCustomActionDefinitions(File customActionDefinitionRoot) throws JAXBException, ShpurdpException {
   ...
   */
  public void addActionDefinition(ActionDefinition ad) throws ShpurdpException {
  ...
  public Map<String, Map<String, List<MetricDefinition>>> getServiceMetrics(String stackName,
            String stackVersion, String serviceName) throws ShpurdpException {
    ...
    if (null == map) {
      ...
      try {
        ...
        throw new ShpurdpException("Could not read metrics file", e);
      }
    }
  ...
  public Set<AlertDefinition> getAlertDefinitions(String stackName, String stackVersion,
                                                  String serviceName) throws ShpurdpException {
   ...
   */
  public void reconcileAlertDefinitions(Clusters clusters, boolean updateScriptPaths)  throws ShpurdpException {
   ...
   *        with possibly new paths from the stack definition
   */
  public void reconcileAlertDefinitions(Cluster cluster, boolean updateScriptPaths) throws ShpurdpException {
      if (null == cluster) {
        return;
      }
      ...
      // shpurdp agent host-only alert definitions
      persist.addAll(getDefinitionsForMerge(shpurdpServiceAlertDefinitions.getAgentDefinitions(), clusterId, mappedEntities));

      // shpurdp server host-only alert definitions
      persist.addAll(getDefinitionsForMerge(shpurdpServiceAlertDefinitions.getServerDefinitions(), clusterId, mappedEntities));
      ...
      for (AlertDefinitionEntity definition : definitions) {
        ...
        // the SHPURDP service is special, skip it here
   ...
   * @throws ShpurdpException if an error occurs reading or parsing the stack's kerberos.json files
   */
  public KerberosDescriptor getKerberosDescriptor(String stackName, String stackVersion, boolean includePreconfigureData) throws ShpurdpException {
   ...
   * @throws ShpurdpException if an error occurs reading or parsing the service's kerberos.json files
   */
  public KerberosServiceDescriptor[] getKerberosDescriptor(ServiceInfo serviceInfo) throws ShpurdpException {
    ...
    if (kerberosFile != null) {
      try {
        ...
        throw new ShpurdpException("Could not read kerberos descriptor file", e);
      }
    }
  ...
  /* Return shpurdp.properties from configuration API. This is to avoid
  changing interface impls that do not use injection or use partial
  injection like Stack Advisor Commands */
  public Map<String, String> getShpurdpServerProperties() {
    return conf.getShpurdpProperties();
  }
   ...
   * @throws ShpurdpException if an error occurs reading or parsing the Kerberos descriptor file
   */
  KerberosDescriptor readKerberosDescriptorFromFile(String fileLocation) throws ShpurdpException {
    if (!StringUtils.isEmpty(fileLocation)) {
      ...
      if (file.canRead()) {
        try {
          ...
          throw new ShpurdpException(String.format("Failed to parse Kerberos descriptor file %s",
              file.getAbsolutePath()), e);
        }
      } else {
        throw new ShpurdpException(String.format("Unable to read Kerberos descriptor file %s",
