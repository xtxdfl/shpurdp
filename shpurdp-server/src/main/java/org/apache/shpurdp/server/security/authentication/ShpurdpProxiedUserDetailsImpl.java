...
/**
 * ShpurdpProxiedUserDetailsImpl is an {@link ShpurdpUserDetails} implementation that contains details
 ...
 */
public class ShpurdpProxiedUserDetailsImpl implements ShpurdpUserDetails {
   ...
   * <p>
   * This user that authenticated wth Shpurdp but specified a doAs or proxied user to be used as the acting user for operations.
   */
  private final ShpurdpProxyUserDetails proxyUserDetails;

  public ShpurdpProxiedUserDetailsImpl(UserDetails proxiedUserDetails, ShpurdpProxyUserDetails proxyUserDetails) {
  ...
  public Integer getUserId() {
    return (proxiedUserDetails instanceof ShpurdpUserDetails) ? ((ShpurdpUserDetails) proxiedUserDetails).getUserId() : null;
  }
  ...
  public ShpurdpProxyUserDetails getProxyUserDetails() {
