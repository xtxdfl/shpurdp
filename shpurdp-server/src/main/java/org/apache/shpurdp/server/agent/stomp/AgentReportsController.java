...
import org.apache.shpurdp.server.HostNotRegisteredException;
import org.apache.shpurdp.server.agent.AgentReportsProcessor;
import org.apache.shpurdp.server.agent.AgentSessionManager;
import org.apache.shpurdp.server.agent.CommandReport;
import org.apache.shpurdp.server.agent.CommandStatusAgentReport;
import org.apache.shpurdp.server.agent.ComponentStatus;
import org.apache.shpurdp.server.agent.ComponentStatusAgentReport;
import org.apache.shpurdp.server.agent.ComponentVersionAgentReport;
import org.apache.shpurdp.server.agent.HeartBeatHandler;
import org.apache.shpurdp.server.agent.HostStatusAgentReport;
import org.apache.shpurdp.server.agent.stomp.dto.AckReport;
import org.apache.shpurdp.server.agent.stomp.dto.CommandStatusReports;
import org.apache.shpurdp.server.agent.stomp.dto.ComponentStatusReport;
import org.apache.shpurdp.server.agent.stomp.dto.ComponentStatusReports;
...
public class AgentReportsController {
  ...
  public ReportsResponse handleComponentVersionReport(@Header String simpSessionId, ComponentVersionReports message)
      throws WebApplicationException, InvalidStateTransitionException, ShpurdpException {
  ...
  public ReportsResponse handleHostReportStatus(@Header String simpSessionId, HostStatusReport message) throws ShpurdpException {
  ...
  public ReportsResponse handleAlertsStatus(@Header String simpSessionId, Alert[] message) throws ShpurdpException {
