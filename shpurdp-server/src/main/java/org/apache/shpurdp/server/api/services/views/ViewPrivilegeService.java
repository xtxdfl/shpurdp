...
package org.apache.shpurdp.server.api.services.views;
...
import org.apache.shpurdp.server.controller.ViewPrivilegeResponse;
...
public class ViewPrivilegeService extends BaseService {
  ...
  public static final String PRIVILEGE_INFO_REQUEST_TYPE = "org.apache.shpurdp.server.controller.ViewPrivilegeResponse.ViewPrivilegeResponseWrapper";
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(name = "body", value = "input parameters in json form", required = true, dataType = "org.apache.shpurdp.server.controller.ViewPrivilegeRequest", paramType = "body")
  })
  @ApiResponses(value = {
