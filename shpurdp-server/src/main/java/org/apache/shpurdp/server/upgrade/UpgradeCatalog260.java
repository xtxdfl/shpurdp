...
import org.apache.shpurdp.server.state.kerberos.AbstractKerberosDescriptor;
...
/**
 * The {@link org.apache.shpurdp.server.upgrade.UpgradeCatalog260} upgrades Shpurdp from 2.5.2 to 2.6.0.
 */
public class UpgradeCatalog260 extends AbstractUpgradeCatalog {
  ...
  private void addLegacyColumn() throws ShpurdpException, SQLException {
  ...
  private void renameServiceDeletedColumn() throws ShpurdpException, SQLException {
  ...
  * will show warning about not mapped config. (SHPURDP-21795)
  * */
   ...
   * @throws ShpurdpException if cluster versions are present, but current is not selected
   * @throws SQLException
   */
  public Integer getCurrentVersionID() throws ShpurdpException, SQLException {
    ...
    if (currentVersionList.isEmpty()) {
      ...
      if (allVersionList.isEmpty()){
        ...
        throw new ShpurdpException("Unable to find any CURRENT repositories.");
      }
    } else if (currentVersionList.size() != 1) {
      throw new ShpurdpException("The following repositories were found to be CURRENT: ".concat(StringUtils.join(currentVersionList, ",")));
    }
    return currentVersionList.get(0);
  }

  // Superset is moved as an independent service in Shpurdp-2.6.
   ...
   * </ul>
   */
  void ensureZeppelinProxyUserConfigs() throws ShpurdpException {
  ...
  protected void updateHiveConfigs() throws ShpurdpException {
  ...
  protected void updateHDFSWidgetDefinition() throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  protected void updateExistingRepositoriesToBeResolved() throws ShpurdpException {
