 ...
 */
package org.apache.shpurdp.server.customactions;
...
public class ActionDefinitionManager {
  ...
  public void readCustomActionDefinitions(File customActionDefinitionRoot) throws JAXBException, ShpurdpException {
  ...
  public void addActionDefinition(ActionDefinition ad) throws ShpurdpException {
    if (!actionDefinitionMap.containsKey(ad.getActionName())) {
      ...
      throw new ShpurdpException("Action definition by name " + ad.getActionName() + " already exists.");
    }
  }
