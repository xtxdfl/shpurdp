...
public class CleanupServerAction extends KerberosServerAction {
   ...
   * @throws ShpurdpException
   */
  private void removeKerberosArtifact(Cluster cluster) throws ShpurdpException {
    ...
    try {
      ...
      throw new ShpurdpException("An unknown error occurred while trying to delete the cluster Kerberos descriptor", e);
    }
  }
