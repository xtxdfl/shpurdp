...
import org.apache.shpurdp.server.api.resources.BaseResourceDefinition;
...
/**
 * Rest endpoint for managing shpurdp root service component configurations. Supports CRUD operations.
 * Shpurdp configurations are resources that relate to the shpurdp server instance even before a cluster is provisioned.
 * <p>
 * Shpurdp configuration resources may be shared with components and services in the cluster
 ...
 *             "authentication.ldap.baseDn": "dc=shpurdp,dc=apache,dc=org"
 *             // ......
 *          }
 *        }
 *      }
 * </pre>
 */
@Api(value = "Root Service Configurations", description = "Endpoint for Shpurdp root service component configuration related operations")
public class RootServiceComponentConfigurationService extends BaseService {

  private static final String REQUEST_TYPE =
      "org.apache.shpurdp.server.api.services.RootServiceComponentConfigurationRequestSwagger";
