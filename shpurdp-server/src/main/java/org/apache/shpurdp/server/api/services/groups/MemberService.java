 ...
 */
package org.apache.shpurdp.server.api.services.groups;
...
public class MemberService extends BaseService {
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(name = "body", value = "input parameters in json form", required = true, dataType = "org.apache.shpurdp.server.controller.MemberRequest", paramType = "body")
  })
  @ApiResponses(value = {
    @ApiResponse(code = 200, message = "Successful operation"),
    @ApiResponse(code = 500, message = "Server Error")}
