...
import org.apache.shpurdp.server.audit.event.OperationStatusAuditEvent;
...
import org.apache.shpurdp.server.orm.entities.RoleSuccessCriteriaEntity;
...
public class ActionDBAccessorImpl implements ActionDBAccessor {
  ...
  /* (non-Javadoc)
   * @see org.apache.shpurdp.server.actionmanager.ActionDBAccessor#getStage(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.apache.shpurdp.server.actionmanager.ActionDBAccessor#getAllStages(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.apache.shpurdp.server.actionmanager.ActionDBAccessor#timeoutHostRole(long, long, org.apache.shpurdp.server.Role)
   */
  @Override
  ...
  public void persistActions(Request request) throws ShpurdpException {
  ...
  public void endRequest(long requestId) {
    ...
    if (requestEntity != null && requestEntity.getEndTime() == -1L) {
      ...
      requestDAO.merge(requestEntity);
      shpurdpEventPublisher.publish(new RequestFinishedEvent(requestEntity.getClusterId(), requestId));
    }
  }
