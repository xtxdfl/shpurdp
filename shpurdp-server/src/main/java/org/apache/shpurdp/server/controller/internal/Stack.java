...
import org.apache.shpurdp.server.controller.StackConfigurationRequest;
...
import org.apache.shpurdp.server.controller.StackServiceComponentRequest;
import org.apache.shpurdp.server.controller.StackServiceComponentResponse;
import org.apache.shpurdp.server.controller.StackServiceRequest;
import org.apache.shpurdp.server.controller.StackServiceResponse;
...
public class Stack {
  ...
  /**
   * Shpurdp Management Controller, used to obtain Stack definitions
   */
   ...
   */
  public Stack(StackEntity stack, ShpurdpManagementController shpurdpManagementController) throws ShpurdpException {
    this(stack.getStackName(), stack.getStackVersion(), shpurdpManagementController);
  }

  public Stack(StackId stackId, ShpurdpManagementController shpurdpManagementController) throws ShpurdpException {
    this(stackId.getStackName(), stackId.getStackVersion(), shpurdpManagementController);
  }
   ...
   *
   * @throws ShpurdpException an exception occurred getting stack information
   *                         for the specified name and version
   */
  //todo: don't pass management controller in constructor
  public Stack(String name, String version, ShpurdpManagementController controller) throws ShpurdpException {
    this.name = name;
  ...
  public ComponentInfo getComponentInfo(String component) {
    ...
    if (service != null) {
      try {
        componentInfo = controller.getShpurdpMetaInfo().getComponent(
  ...
  public Optional<ServiceInfo> getServiceInfo(String serviceName) {
    try {
      return Optional.of(controller.getShpurdpMetaInfo().getService(getName(), getVersion(), serviceName));
    } catch (ShpurdpException e) {
   ...
   * @param service  service name
   *
   * @throws ShpurdpException an exception occurred getting components from the stack definition
   */
  private void parseComponents(String service) throws ShpurdpException{
    ...
    for (StackServiceComponentResponse component : components) {
      ...
      //todo: remove usage of ShpurdpMetaInfo
      Collection<DependencyInfo> componentDependencies = controller.getShpurdpMetaInfo().getComponentDependencies(
   ...
   *
   * @throws ShpurdpException an exception occurred getting configurations from the stack definition
   */
  private void parseConfigurations(StackServiceResponse stackService) throws ShpurdpException {
  ...
  private void parseStackConfigurations () throws ShpurdpException {
