...
public class OperatingSystemResponse {
  ...
  private boolean shpurdpManagedRepos = true;
  ...
  /**
   * @param managed {@code true} if shpurdp is managing the repositories for the OS
   */
  public void setShpurdpManagedRepos(boolean managed) {
    shpurdpManagedRepos = managed;
  }

  /**
   * @return {@code true} if shpurdp is managing the repositories for the OS
   */
  public boolean isShpurdpManagedRepos() {
    return shpurdpManagedRepos;
  }
}
