...
import org.apache.shpurdp.server.serveraction.upgrades.DeleteUnsupportedServicesAndComponents;
...
public class ComponentsExistInRepoCheck extends ClusterCheck {
  ...
  private void report(UpgradeCheckResult result, UpgradeCheckRequest request, Collection<String> allUnsupported) throws ShpurdpException {
  ...
  private UpgradePack upgradePack(UpgradeCheckRequest request) throws ShpurdpException {
    Cluster cluster = clustersProvider.get().getCluster(request.getClusterName());
