...
public interface CredentialStore {
   ...
   */
  void addCredential(String alias, Credential credential) throws ShpurdpException;
   ...
   */
  Credential getCredential(String alias) throws ShpurdpException;
   ...
   */
  void removeCredential(String alias) throws ShpurdpException;
   ...
   */
  Set<String> listCredentials() throws ShpurdpException;
   ...
   * @throws ShpurdpException if an error occurs while searching forthe credential
   */
  boolean containsCredential(String alias) throws ShpurdpException;
