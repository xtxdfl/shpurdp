 ...
 * in order to make custom {@link AuditEvent}s based on {@link org.apache.shpurdp.server.api.services.Request.Type}s
 * and {@link org.apache.shpurdp.server.controller.spi.Resource.Type}
 */
public interface RequestAuditEventCreator {

  /**
   * @return the set of {@link org.apache.shpurdp.server.api.services.Request.Type}s that are handled by this creator
   */
  Set<Request.Type> getRequestTypes();

  /**
   * @return the {@link org.apache.shpurdp.server.controller.spi.Resource.Type}s that is handled by this creator
   */
