...
/**
 * Configuration for SSL communication between Shpurdp and 3rd party services.
 * Currently, the following services are supported with SSL communication:
 * <ul>
 * <li>Shpurdp metrics</li>
 * </ul>
 */
public class ComponentSSLConfiguration {
  ...
  public void init(Configuration configuration) {
    ...
    httpsEnabled = Boolean.parseBoolean(configuration.getProperty(Configuration.SHPURDP_METRICS_HTTPS_ENABLED.getKey()));
  }
  ...
  /**
   * Indicates whether or not Shpurdp Metrics is setup for SSL.
   *
