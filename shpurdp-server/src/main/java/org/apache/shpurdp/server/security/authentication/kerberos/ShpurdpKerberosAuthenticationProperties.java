...
/**
 * ShpurdpKerberosAuthenticationProperties is a container for Kerberos authentication-related
 ...
 * <p>
 * If Kerberos authentication is not enabled for Shpurdp <code>{@link #kerberosAuthenticationEnabled} == false</code>,
 * then there is no guarantee that any other property in this container is valid.
 */
public class ShpurdpKerberosAuthenticationProperties {

  /**
   * A boolean value indicating whether Kerberos authentication is enabled in Shpurdp (<code>true</code>)
  ...
  /**
   * Gets the list of {@link UserAuthenticationType}s (in preference order) to use to look up uer accounts in the Shpurdp database.
   *
