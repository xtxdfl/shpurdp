 ...
 */
package org.apache.shpurdp.server.events.jpa;
...
/**
 * The {@link JPAEvent} class is the base for all JPA events in Shpurdp. Although
 * this class could inherit from {@link ShpurdpEvent}, the publishers for
 * {@link ShpurdpEvent} instances use an asynchronous model. With JPA, we want a
