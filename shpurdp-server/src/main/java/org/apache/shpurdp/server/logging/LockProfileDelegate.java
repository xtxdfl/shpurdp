 ...
 */
package org.apache.shpurdp.server.logging;
 ...
 * trace, only including methods from org.apache.shpurdp and subpackages to eliminate the noise.
 */
final class LockProfileDelegate {
  ...
  private static String getFilteredStackTrace() {
    ...
    for (StackTraceElement element : stackTrace) {
      ...
      if (className.startsWith("org.apache.shpurdp") && !className.startsWith("org.apache.shpurdp.server.logging")) {
        sb.append(className)
