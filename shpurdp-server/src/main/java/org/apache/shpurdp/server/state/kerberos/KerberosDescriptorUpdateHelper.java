...
public class KerberosDescriptorUpdateHelper {
   ...
   * of identity names or {@link org.apache.shpurdp.server.api.services.HostKerberosIdentityService}
   * items.
   *
   * @param identities a list of {@link KerberosIdentityDescriptor}s
   * @return a map of identity names or {@link org.apache.shpurdp.server.api.services.HostKerberosIdentityService}
   */
