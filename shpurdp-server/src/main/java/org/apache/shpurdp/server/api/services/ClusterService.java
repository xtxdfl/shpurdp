...
import org.apache.shpurdp.server.api.services.parsers.BodyParseException;
import org.apache.shpurdp.server.controller.ShpurdpServer;
import org.apache.shpurdp.server.controller.ClusterArtifactResponse;
import org.apache.shpurdp.server.controller.ClusterResponse.ClusterResponseWrapper;
...
public class ClusterService extends BaseService {
  ...
  private static final String CLUSTER_REQUEST_TYPE = "org.apache.shpurdp.server.api.services.ClusterRequestSwagger";
  private static final String ARTIFACT_REQUEST_TYPE = "org.apache.shpurdp.server.controller.ClusterArtifactRequest";
  ...
  public ClusterService() {
    clusters = ShpurdpServer.getController().getClusters();
  }
  ...
  public LoggingService getLogging(@Context javax.ws.rs.core.Request request,
                                   @PathParam("clusterName") String clusterName) {
    return ShpurdpServer.getController().getLoggingService(clusterName);
  }
