...
import org.apache.shpurdp.server.orm.entities.StageEntity_;
...
public class StageDAO {
  ...
  /**
   * Finds all {@link org.apache.shpurdp.server.orm.entities.StageEntity} that match the provided
   * {@link org.apache.shpurdp.server.controller.spi.Predicate}. This method will make JPA do the heavy lifting
  ...
  /**
   * The {@link org.apache.shpurdp.server.orm.dao.StageDAO.StagePredicateVisitor} is used to convert an Shpurdp
   * {@link org.apache.shpurdp.server.controller.spi.Predicate} into a JPA {@link javax.persistence.criteria.Predicate}.
   */
