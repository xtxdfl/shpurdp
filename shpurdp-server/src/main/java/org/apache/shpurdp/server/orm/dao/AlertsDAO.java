...
import org.apache.shpurdp.server.cleanup.TimeBasedCleanupPolicy;
...
import org.apache.shpurdp.server.orm.entities.AlertCurrentEntity_;
import org.apache.shpurdp.server.orm.entities.AlertHistoryEntity;
import org.apache.shpurdp.server.orm.entities.AlertHistoryEntity_;
...
public class AlertsDAO implements Cleanable {
  ...
  public int removeCurrentByHost(String hostName) {
    ...
    } catch (Exception shpurdpException) {
  ...
  /**
   * The {@link HistoryPredicateVisitor} is used to convert an Shpurdp
  ...
  /**
   * The {@link CurrentPredicateVisitor} is used to convert an Shpurdp
   * {@link Predicate} into a JPA {@link javax.persistence.criteria.Predicate}.
   */
