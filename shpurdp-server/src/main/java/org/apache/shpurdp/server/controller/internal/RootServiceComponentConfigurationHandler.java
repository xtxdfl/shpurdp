...
abstract class RootServiceComponentConfigurationHandler {
   ...
   * @throws ShpurdpException in case an error occurred while updating category's properties
   */
  public abstract void updateComponentCategory(String categoryName, Map<String, String> properties, boolean removePropertiesIfNotSpecified) throws ShpurdpException;
