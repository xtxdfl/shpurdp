...
import org.apache.shpurdp.server.state.stack.ExtensionMetainfoXml;
...
public class ExtensionHelper {
  ...
  public static void validateDeleteLink(Clusters clusters, StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
    validateNotRequiredExtension(stack, extension);
    validateServicesNotInstalled(clusters, stack, extension);
  }

  private static void validateServicesNotInstalled(Clusters clusters, StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
  ...
  public static void validateCreateLink(StackManager stackManager, StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
  ...
  public static void validateUpdateLink(StackManager stackManager, StackInfo stack, ExtensionInfo oldExtension, ExtensionInfo newExtension) throws ShpurdpException {
  ...
  private static void validateSupportedStackVersion(StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
  ...
  private static void validateServiceDuplication(StackManager stackManager, StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
    validateServiceDuplication(stackManager, stack, extension, extension.getServices());
  }

  private static void validateServiceDuplication(StackManager stackManager, StackInfo stack, ExtensionInfo oldExtension, ExtensionInfo newExtension) throws ShpurdpException {
  ...
  private static void validateServiceDuplication(StackManager stackManager, StackInfo stack, ExtensionInfo extension, Collection<ServiceInfo> services) throws ShpurdpException {
  ...
  private static void validateRequiredExtensions(StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
  ...
  private static void validateNotRequiredExtension(StackInfo stack, ExtensionInfo extension) throws ShpurdpException {
