...
/**
 * Authority granted for Shpurdp privileges.
 */
public class ShpurdpGrantedAuthority implements GrantedAuthority {
  /**
   * The Shpurdp privilege.
   */
  ...
  public ShpurdpGrantedAuthority(PrivilegeEntity privilegeEntity) {
  ...
  public boolean equals(Object o) {
    ...
    ShpurdpGrantedAuthority that = (ShpurdpGrantedAuthority) o;
