...
import org.apache.shpurdp.server.agent.stomp.dto.ClusterConfigs;
...
import org.apache.shpurdp.server.events.HostComponentUpdate;
import org.apache.shpurdp.server.events.HostComponentsUpdateEvent;
...
import org.apache.shpurdp.server.orm.dao.ServiceConfigDAO;
import org.apache.shpurdp.server.orm.entities.ClusterConfigEntity;
...
import org.apache.shpurdp.server.stack.StackDirectory;
...
public class ConfigHelper {
  ...
  private ShpurdpMetaInfo shpurdpMetaInfo = null;
  ...
  @Inject
  private Provider<ShpurdpManagementControllerImpl> m_shpurdpManagementController;
  ...
  @Inject
  public ConfigHelper(Clusters c, ShpurdpMetaInfo metaInfo, Configuration configuration, ClusterDAO clusterDAO) {
    clusters = c;
  ...
  public Map<String, Map<String, String>> getEffectiveDesiredTags(
          Cluster cluster, String hostName) throws ShpurdpException {
  ...
  private Map<String, Map<String, String>> getEffectiveDesiredTags(Cluster cluster, Map<String,
    ...
    for (Entry<String, DesiredConfig> clusterEntry : clusterDesired.entrySet()) {
      ...
      if (cluster != null) {
        ...
        // SHPURDP-3672. Only consider Config groups for override tags
  ...
  public Map<String, Map<String, String>> getEffectiveConfigProperties(String clusterName, String hostName) throws ShpurdpException {
   ...
   * @param propertyName
   */
  public Set<String> findConfigTypesByPropertyName(StackId stackId, String propertyName, String clusterName) throws ShpurdpException {
    StackInfo stack = shpurdpMetaInfo.getStack(stackId.getStackName(),
                                              stackId.getStackVersion());

    Set<String> result = new HashSet<>();

    for (Service service : clusters.getCluster(clusterName).getServices().values()) {
      Set<PropertyInfo> stackProperties = shpurdpMetaInfo.getServiceProperties(stack.getName(), stack.getVersion(), service.getName());
      Set<PropertyInfo> stackLevelProperties = shpurdpMetaInfo.getStackProperties(stack.getName(), stack.getVersion());
  ...
  public Map<String, Map<String, String>> getCredentialStoreEnabledProperties(StackId stackId, Service service)
    ...
    StackInfo stack = shpurdpMetaInfo.getStack(stackId.getStackName(), stackId.getStackVersion());
    Map<String, Map<String, String>> result = new HashMap<>();
    Map<String, String> passwordProperties;
    Set<PropertyInfo> serviceProperties = shpurdpMetaInfo.getServiceProperties(stack.getName(), stack.getVersion(), service.getName());
  ...
  public Map<String, Set<String>> createUserGroupsMap(StackId stackId,
                                                      Cluster cluster, Map<String, DesiredConfig> desiredConfigs) throws ShpurdpException {
    StackInfo stack = shpurdpMetaInfo.getStack(stackId.getStackName(), stackId.getStackVersion());
    Map<String, ServiceInfo> servicesMap = shpurdpMetaInfo.getServices(stack.getName(), stack.getVersion());
    Set<PropertyInfo> stackProperties = shpurdpMetaInfo.getStackProperties(stack.getName(), stack.getVersion());
  ...
  public Map<String, Set<String>> createUserGroupsMap(
    ...
    Map<String, ServiceInfo> servicesMap, Set<PropertyInfo> stackProperties) throws ShpurdpException {
  ...
  public Map<PropertyInfo, String> getPropertiesWithPropertyType(PropertyType propertyType, Cluster cluster,
                                                                 ...
                                                                 Set<PropertyInfo> stackProperties) throws ShpurdpException {
  ...
  public Set<String> getPropertyValuesWithPropertyType(StackId stackId, PropertyType propertyType,
                                                       ...
                                                       DesiredConfig> desiredConfigs) throws ShpurdpException {
    StackInfo stack = shpurdpMetaInfo.getStack(stackId.getStackName(), stackId.getStackVersion());
    Map<String, ServiceInfo> servicesMap = shpurdpMetaInfo.getServices(stack.getName(), stack.getVersion());
    Set<PropertyInfo> stackProperties = shpurdpMetaInfo.getStackProperties(stack.getName(), stack.getVersion());
  ...
  public void checkAllStageConfigsPresentInDesiredConfigs(Cluster cluster) throws ShpurdpException {
    StackId stackId = cluster.getDesiredStackVersion();
    Set<String> stackConfigTypes = shpurdpMetaInfo.getStack(stackId.getStackName(),
    ...
    for (String stackConfigType : stackConfigTypes) {
      if (!actualConfigs.containsKey(stackConfigType)) {
        LOG.error(String.format("Unable to find stack configuration %s in shpurdp configs!", stackConfigType));
      }
    }
   ...
   * @throws ShpurdpException
   */
  public String getPropertyValueFromStackDefinitions(Cluster cluster, String configType, String propertyName) throws ShpurdpException {
    ...
    for (StackId stackId : stackIds) {
      ...
      for (ServiceInfo serviceInfo : stack.getServices()) {
        Set<PropertyInfo> serviceProperties = shpurdpMetaInfo.getServiceProperties(stack.getName(), stack.getVersion(), serviceInfo.getName());
        Set<PropertyInfo> stackProperties = shpurdpMetaInfo.getStackProperties(stack.getName(), stack.getVersion());
   ...
   * @throws ShpurdpException if there was a problem parsing the placeholder or retrieving the
   *                         referenced value.
   */
  ...
  public ServiceInfo getPropertyOwnerService(Cluster cluster, String configType, String propertyName) throws ShpurdpException {
  ...
  public Set<PropertyInfo> getServiceProperties(Cluster cluster, String serviceName) throws ShpurdpException {
   ...
   * @throws ShpurdpException if the requested stack or the requested service is not found
   */
  public Set<PropertyInfo> getServiceProperties(StackId stackId, String serviceName, boolean removeExcluded)
      throws ShpurdpException {
    ServiceInfo service = shpurdpMetaInfo.getService(stackId.getStackName(), stackId.getStackVersion(), serviceName);
    ...
    if (removeExcluded) {
      ...
      // excludedConfigTypes can be null since org.apache.shpurdp.server.state.ServiceInfo.setExcludedConfigTypes()
  ...
  public Set<PropertyInfo> getStackProperties(Cluster cluster) throws ShpurdpException {
    ...
    for (StackId stackId : stackIds) {
      StackInfo stack = shpurdpMetaInfo.getStack(stackId.getStackName(), stackId.getStackVersion());
      propertySets.addAll(shpurdpMetaInfo.getStackProperties(stack.getName(), stack.getVersion()));
    }

    return propertySets;
  }

  public void updateConfigType(Cluster cluster, StackId stackId, ShpurdpManagementController controller,
                               String configType, Map<String, String> updates,
                               Collection<String> removals,
                               String authenticatedUserName,
                               String serviceVersionNote)  throws ShpurdpException {
  ...
  public void updateBulkConfigType(Cluster cluster, StackId stackId, ShpurdpManagementController controller,
                                   Iterable<String> configTypes,
                                   Map<String, Map<String, String>> updates,
                                   Map<String, Collection<String>> removals,
                                   String authenticatedUserName,
                                   String serviceVersionNote) throws ShpurdpException, ShpurdpRuntimeException {
    ...
    configTypes.forEach(configType -> {
      try {
        ...
        throw new ShpurdpRuntimeException(e);
      }
    });
   ...
   * @throws ShpurdpException
   */
  public Boolean updateConfigType(Cluster cluster, StackId stackId, ShpurdpManagementController controller,
                                  String configType, Map<String, String> updates,
                                  Collection<String> removals,
                                  String authenticatedUserName,
                                  String serviceVersionNote,
                                  @Nullable Map<String, DesiredConfig> desiredConfig,
                                  Boolean doUpdateAgentConfigs) throws ShpurdpException {
  ...
  public void createConfigType(Cluster cluster, StackId stackId,
      ShpurdpManagementController controller, String configType, Map<String, String> properties,
      String authenticatedUserName, String serviceVersionNote) throws ShpurdpException {
  ...
  public boolean createConfigTypes(Cluster cluster, StackId stackId,
      ShpurdpManagementController controller, Map<String, Map<String, String>> batchProperties,
      String authenticatedUserName, String serviceVersionNote) throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  Config createConfig(Cluster cluster, StackId stackId, ShpurdpManagementController controller,
      String type, String tag, Map<String, String> properties,
      Map<String, Map<String, String>> propertyAttributes) throws ShpurdpException {
  ...
  public Map<String, Map<String, String>> getDefaultStackProperties(StackId stack)
    ...
    Set<org.apache.shpurdp.server.state.PropertyInfo> stackConfigurationProperties = shpurdpMetaInfo.getStackProperties(
  ...
  public Map<String, Map<String, String>> getDefaultProperties(StackId stack, String serviceName)
    ...
    Set<org.apache.shpurdp.server.state.PropertyInfo> serviceConfigurationProperties = shpurdpMetaInfo.getServiceProperties(
  ...
  private boolean calculateIsStaleConfigs(ServiceComponentHost sch, Map<String, DesiredConfig> desiredConfigs,
                                          HostComponentDesiredStateEntity hostComponentDesiredStateEntity) throws ShpurdpException {
    ...
    StackInfo stackInfo = shpurdpMetaInfo.getStack(stackId);
   ...
   * @throws ShpurdpException
   */
  public void updateAgentConfigs(Set<String> updatedClusters) throws ShpurdpException {
    ...
    for (Cluster cluster : clustersInUse) {
      ...
      m_metadataHolder.get().updateData(m_shpurdpManagementController.get().getClusterMetadataOnConfigsUpdate(cluster));
  ...
  public void checkStaleConfigsStatusOnConfigsUpdate(Long clusterId, String serviceName,
                                                     Map<Long, Map<String, Collection<String>>> changedConfigs) throws ShpurdpException {
  ...
  public boolean checkStaleConfigsStatusForHostComponent(ServiceComponentHost sch,
                                                         Map<String, Collection<String>> changedConfigs) throws ShpurdpException {
    HostComponentDesiredStateEntity hostComponentDesiredStateEntity = sch.getDesiredStateEntity();
    if (sch.isRestartRequired(hostComponentDesiredStateEntity)) {
      return true;
    }
  ...
  public String getRefreshConfigsCommand(Cluster cluster, String hostName, String serviceName, String componentName) throws ShpurdpException {
  ...
  public String getRefreshConfigsCommand(Cluster cluster, ServiceComponentHost sch) throws ShpurdpException {
  ...
  private boolean hasGroupSpecificConfigsForType(Cluster cluster, String hostname, String type) {
    try {
      ...
      LOG.warn("Could not determine group configuration for host. Details: " + shpurdpException.getMessage());
    }
    return false;
  }
   ...
   * @throws ShpurdpException
   */
  public AgentConfigsUpdateEvent getHostActualConfigs(Long hostId) throws ShpurdpException {
    return getHostActualConfigsExcludeCluster(hostId, null);
  }

  public AgentConfigsUpdateEvent getHostActualConfigsExcludeCluster(Long hostId, Long clusterId) throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  public Map<String, Map<String, String>> calculateExistingConfigurations(ShpurdpManagementController shpurdpManagementController, Cluster cluster) throws ShpurdpException {
    final Map<String, Map<String, String>> configurations = new HashMap<>();
    for (Host host : cluster.getHosts()) {
      configurations.putAll(calculateExistingConfigurations(
              shpurdpManagementController,
              cluster,
              host.getHostName(),
              null
      ));
   ...
   *
   * @param shpurdpManagementController the Shpurdp management controller
   * @param cluster  the cluster
  ...
  public Map<String, Map<String, String>> calculateExistingConfigurations(
          ShpurdpManagementController shpurdpManagementController, Cluster cluster,  String hostname,
          @Nullable Map<String, DesiredConfig> desiredConfigs) throws ShpurdpException {
    ...
    final Map<String, Map<String, String>> configurations = new HashMap<>();
    final Map<String, Map<String, String>> configurationTags = shpurdpManagementController
   ...
   */
  public Pair<Map<String, Map<String, String>>, Map<String, Map<String, Map<String, String>>>> calculateExistingConfigs(Cluster cluster) throws ShpurdpException {
