...
/**
 * The {@link org.apache.shpurdp.server.events.listeners.upgrade.DistributeRepositoriesActionListener} class
 * handles {@link org.apache.shpurdp.server.events.ActionFinalReportReceivedEvent}
...
public class DistributeRepositoriesActionListener {
   ...
   */
  @Inject
  public DistributeRepositoriesActionListener(ShpurdpEventPublisher publisher) {
