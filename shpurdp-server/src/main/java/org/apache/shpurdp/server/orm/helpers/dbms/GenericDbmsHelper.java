...
package org.apache.shpurdp.server.orm.helpers.dbms;
...
public class GenericDbmsHelper implements DbmsHelper {
  ...
  public StringBuilder writeColumnType(StringBuilder builder, DBAccessor.DBColumnInfo columnInfo) {
    ...
    try {
      databasePlatform.printFieldTypeSize(writer, definition, fieldType, false); //Shpurdp doesn't use identity fields
