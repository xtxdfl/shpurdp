...
public class WidgetResourceProvider extends AbstractControllerResourceProvider {
   ...
   *
   */
  public WidgetResourceProvider(ShpurdpManagementController managementController) {
  ...
  public RequestStatus createResources(final Request request)
    ...
    for (final Map<String, Object> properties : request.getProperties()) {
      WidgetEntity widgetEntity = createResources(new Command<WidgetEntity>() {
        ...
        @Override
        public WidgetEntity invoke() throws ShpurdpException {
      ...
      public Void invoke() throws ShpurdpException {
        for (Map<String, Object> propertyMap : propertyMaps) {
          ...
          try {
            ...
            throw new ShpurdpException("Widget should have numerical id");
          }
          ...
          if (StringUtils.isNotBlank(ObjectUtils.toString(propertyMap.get(WIDGET_SCOPE_PROPERTY_ID)))) {
            ...
            if (!isScopeAllowedForUser(scope, clusterName)) {
              throw new ShpurdpException("Only cluster operator can create widgets with cluster scope");
            }
            entity.setScope(scope);
          }
  ...
  private boolean isScopeAllowedForUser(String scope, String clusterName) throws ShpurdpException {
