...
public abstract class AbstractRootServiceResponseFactory {
   ...
   */
  public abstract Set<RootServiceResponse> getRootServices(RootServiceRequest request) throws ShpurdpException;
   ...
   * @throws  ShpurdpException if the resources cannot be read
   */
  public abstract Set<RootServiceComponentResponse> getRootServiceComponents(RootServiceComponentRequest request) throws ShpurdpException;
  ...
  public abstract Set<RootServiceHostComponentResponse> getRootServiceHostComponent(RootServiceHostComponentRequest request,
      Set<HostResponse> hosts) throws ShpurdpException;
}
