...
public abstract class GangliaPropertyProvider extends MetricsPropertyProvider {
   ...
   *
   * @throws org.apache.shpurdp.server.controller.spi.SystemException if unable to get the Ganglia Collector host name
   */
  ...
  private class RRDRequest {
     ...
     *
     * @throws org.apache.shpurdp.server.controller.spi.SystemException if unable to populate the resources
     */
