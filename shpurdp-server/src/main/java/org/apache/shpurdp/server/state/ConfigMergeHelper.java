...
public class ConfigMergeHelper {
  ...
  public Map<String, Map<String, ThreeWayValue>> getConflicts(String clusterName, StackId targetStack) throws ShpurdpException {
    ...
    for (String serviceName : cluster.getServices().keySet()) {
      try {
        Set<PropertyInfo> newStackProperties = m_shpurdpMetaInfo.get().getServiceProperties(
      ...
      Set<PropertyInfo> oldStackProperties = m_shpurdpMetaInfo.get().getServiceProperties(
    ...
    Set<PropertyInfo> set = m_shpurdpMetaInfo.get().getStackProperties(
        oldStack.getStackName(), oldStack.getStackVersion());
    addToMap(oldMap, set);

    set = m_shpurdpMetaInfo.get().getStackProperties(
