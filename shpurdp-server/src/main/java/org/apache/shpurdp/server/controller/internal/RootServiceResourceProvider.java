...
import org.apache.shpurdp.server.controller.RootServiceRequest;
...
public class RootServiceResourceProvider extends ReadOnlyResourceProvider {
  ...
  protected RootServiceResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<RootServiceResponse> responses = getResources(new Command<Set<RootServiceResponse>>() {
      @Override
      public Set<RootServiceResponse> invoke() throws ShpurdpException {
