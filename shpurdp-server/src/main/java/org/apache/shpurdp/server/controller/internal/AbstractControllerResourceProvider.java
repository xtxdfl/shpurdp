...
public abstract class AbstractControllerResourceProvider extends AbstractAuthorizedResourceProvider {
  ...
  AbstractControllerResourceProvider(Resource.Type type, Set<String> propertyIds,
      Map<Resource.Type, String> keyPropertyIds, ShpurdpManagementController managementController) {
   ...
   */
  protected ShpurdpManagementController getManagementController() {
   ...
   * @throws ShpurdpException if the named cluster does not exist
   */
  protected Long getClusterId(String clusterName) throws ShpurdpException {
   ...
   * @throws ShpurdpException if the named cluster does not exist
   */
  protected Long getClusterResourceId(String clusterName) throws ShpurdpException {
    Cluster cluster = (clusterName == null) ? null : managementController.getClusters().getCluster(clusterName);
   ...
   * @return the resource id or null if not found
   * @throws ShpurdpException if the cluster does not exist
   */
  protected Long getClusterResourceId(Long clusterId) throws ShpurdpException {
