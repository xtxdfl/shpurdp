...
public class CommandRepository {
  ...
  /**
   * {@code true} if Shpurdp believes that this repository has reported back it's
  ...
  public void setRepoFileName(String stackName, Long repoVersionId) {
    this.m_repoFileName = String.format("shpurdp-%s-%s", stackName.toLowerCase(), repoVersionId.toString());
  }
  ...
  public static class Repository {
    ...
    @SerializedName("shpurdpManaged")
    @JsonProperty("shpurdpManaged")
    private boolean m_shpurdpManaged = true;
    ...
    public boolean isShpurdpManaged() {
      return m_shpurdpManaged;
    }
