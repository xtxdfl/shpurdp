...
/**
 * ShpurdpAuthenticationProvider is an abstract class to be extended by Shpurdp authentication providers.
 * <p>
 * This class contains common methods that may be used by authentication providers.
 */
public abstract class ShpurdpAuthenticationProvider implements AuthenticationProvider {
  private static final Logger LOG = LoggerFactory.getLogger(ShpurdpAuthenticationProvider.class);
  ...
  protected ShpurdpAuthenticationProvider(Users users, Configuration configuration) {
    this.users = users;
