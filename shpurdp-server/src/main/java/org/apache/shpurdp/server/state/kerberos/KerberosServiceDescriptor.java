 ...
 * encapsulates an Shpurdp service and it components.
 * <p/>
 * A KerberosServiceDescriptor has the following properties:
 * <ul>
 * <li>name</li>
 * <li>components</li>
 * <li>identities ({@link org.apache.shpurdp.server.state.kerberos.AbstractKerberosDescriptorContainer})</li>
 * <li>configurations ({@link org.apache.shpurdp.server.state.kerberos.AbstractKerberosDescriptorContainer})</li>
 * </ul>
 * <p/>
 ...
 *      "description": "Describes an Shpurdp service",
 *      "type": "object",
 ...
 *        },
 *        "components": {
 *          "description": "A list of Shpurdp component descriptors",
 *          "type": "array",
 *          "items": {
 *            "title": "KerberosComponentDescriptor"
 *            "type": "{@link org.apache.shpurdp.server.state.kerberos.KerberosComponentDescriptor}"
 *          }
 *        },
 *        "identities": {
 ...
 * {@link org.apache.shpurdp.server.state.kerberos.AbstractKerberosDescriptor#name} will hold the
...
public class KerberosServiceDescriptor extends AbstractKerberosDescriptorContainer {
   ...
   * <p/>
   * See {@link org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor} for the JSON
   ...
   * {@link org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor}
   *
