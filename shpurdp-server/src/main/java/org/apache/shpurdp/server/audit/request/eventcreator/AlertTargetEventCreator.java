    ...
    switch (request.getRequestType()) {
      case POST:
        return AddAlertTargetRequestAuditEvent.builder()
          ...
          .withEmailRecipients(RequestAuditEventCreatorHelper.getNamedPropertyList(request, AlertTargetResourceProvider.ALERT_TARGET_PROPERTIES + "/" + AlertNoticeDispatchService.SHPURDP_DISPATCH_RECIPIENTS))
          .build();
      case PUT:
