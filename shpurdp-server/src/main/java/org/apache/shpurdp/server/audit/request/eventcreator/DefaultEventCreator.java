...
import org.apache.shpurdp.server.audit.event.request.DefaultRequestAuditEvent;
...
public class DefaultEventCreator implements RequestAuditEventCreator {
  ...
  /**
   * Set of {@link org.apache.shpurdp.server.api.services.Request.Type}s that are handled by this plugin
