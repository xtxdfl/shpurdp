 ...
 *          "type": "{@link org.apache.shpurdp.server.state.kerberos.KerberosPrincipalDescriptor}",
 *        }
 *        "keytab": {
 *          "description": "Details about this identity's keytab",
 *          "type": "{@link org.apache.shpurdp.server.state.kerberos.KerberosKeytabDescriptor}",
 *          }
 *        }
 *      }
 *   }
...
public class KerberosIdentityDescriptor extends AbstractKerberosDescriptor {
   ...
   * Creates a new KerberosIdentityDescriptor
   * <p/>
   * See {@link org.apache.shpurdp.server.state.kerberos.KerberosIdentityDescriptor} for the JSON
   * Schema that may be used to generate this map.
   *
   * @param data a Map of values use to populate the data for the new instance
   * @see org.apache.shpurdp.server.state.kerberos.KerberosIdentityDescriptor
   */
   ...
   * {@link org.apache.shpurdp.server.state.kerberos.KerberosIdentityDescriptor}
   *
