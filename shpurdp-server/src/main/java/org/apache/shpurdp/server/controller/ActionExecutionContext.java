...
public class ActionExecutionContext {
  ...
  /**
   * If {@code true}, instructs Shpurdp not to worry about whether or not the
  ...
  /**
   * Gets whether Shpurdp should skip all kinds of command verifications while
  ...
  /**
   * Sets whether Shpurdp should skip all kinds of command verifications while
   * scheduling since this command runs in the future and might not be
   * considered "valid".
   * <p/>
   * A use case for this would be during an upgrade where trying to schedule
   ...
   *          {@code true} to have Shpurdp skip verification of things like
