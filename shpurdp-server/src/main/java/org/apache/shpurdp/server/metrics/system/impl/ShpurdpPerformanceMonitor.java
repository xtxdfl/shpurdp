...
/**
 * Class to extend the EclipseLink PerformanceMonitor, and dump the collected metrics to the ShpurdpServer Database Metrics source.
 */
@Singleton
public class ShpurdpPerformanceMonitor extends PerformanceMonitor {
  private static final Logger LOG = LoggerFactory.getLogger(ShpurdpPerformanceMonitor.class);
  ...
  public ShpurdpPerformanceMonitor() {
    super();
    LOG.info("ShpurdpPerformanceMonitor instantiated");
    init();
  }
   ...
   private void init() {
    ...
    if (metricsSource != null) {
      LOG.info("ShpurdpPerformanceMonitor initialized");
      ...
      LOG.info("ShpurdpPerformanceMonitor not yet initialized.");
    }
  }
