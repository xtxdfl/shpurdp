 ...
 */
package org.apache.shpurdp.server.agent.stomp.dto;
...
public class ExecutionCommandsCluster {
  ...
  private List<org.apache.shpurdp.server.agent.ExecutionCommand> executionCommands = new ArrayList<>();

  @JsonProperty("cancelCommands")
  private List<CancelCommand> cancelCommands = new ArrayList<>();

  public ExecutionCommandsCluster(List<org.apache.shpurdp.server.agent.ExecutionCommand> executionCommands, List<CancelCommand> cancelCommands) {
    this.executionCommands = executionCommands;
    this.cancelCommands = cancelCommands;
  }

  public List<org.apache.shpurdp.server.agent.ExecutionCommand> getExecutionCommands() {
    return executionCommands;
  }

  public void setExecutionCommands(List<org.apache.shpurdp.server.agent.ExecutionCommand> executionCommands) {
    this.executionCommands = executionCommands;
  }
