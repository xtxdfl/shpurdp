...
import org.apache.shpurdp.spi.net.HttpURLConnectionProvider;
...
public class URLStreamProvider implements StreamProvider {
   ...
   * {@link HttpURLConnection} which is able to use Shpurdp's cookie store,
   * truststore, and timeout values.
   */
  public static final class ShpurdpHttpUrlConnectionProvider implements HttpURLConnectionProvider {
     ...
     *
     */
    public ShpurdpHttpUrlConnectionProvider() {
