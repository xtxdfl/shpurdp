...
import org.apache.shpurdp.server.controller.ActiveWidgetLayoutResponse;
import org.apache.shpurdp.server.controller.ShpurdpManagementController;
import org.apache.shpurdp.server.controller.WidgetResponse;
...
public class ActiveWidgetLayoutResourceProvider extends AbstractControllerResourceProvider {
   ...
   *
   */
  public ActiveWidgetLayoutResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    boolean isUserAdministrator = AuthorizationHelper.isAuthorized(ResourceType.SHPURDP, null,
        ...
        for (Map<String, Object> propertyMap : propertyMaps) {
          ...
          for (HashMap<String, String> widgetLayout : widgetLayouts) {
            ...
            try {
              ...
              throw new ShpurdpException("WidgetLayout should have numerical id");
            }
            final WidgetLayoutEntity entity = widgetLayoutDAO.findById(layoutId);
            if (entity == null) {
              throw new ShpurdpException("There is no widget layout with id " + layoutId);
            }
          }
