...
public class ClusterImpl implements Cluster {
  ...
  /**
   * The associated Shpurdp cluster.
   */
  private final org.apache.shpurdp.server.state.Cluster cluster;


  // ----- Constructors ------------------------------------------------------

  /**
   * Create a view associated cluster from an Shpurdp cluster.
   *
   * @param cluster  the Shpurdp cluster
   */
  public ClusterImpl(org.apache.shpurdp.server.state.Cluster cluster) {
