...
public class HostResourceProvider extends AbstractControllerResourceProvider {
   ...
   */
  @AssistedInject
  HostResourceProvider(@Assisted ShpurdpManagementController managementController) {
  ...
  protected Set<HostResponse> getHosts(Set<HostRequest> requests) throws ShpurdpException {
   ...
   */
  protected static Set<HostResponse> getHosts(ShpurdpManagementController controller, HostRequest request, OsFamily osFamily)
      throws ShpurdpException {
  ...
  protected synchronized void updateHosts(Set<HostRequest> requests) throws ShpurdpException, AuthorizationException {
  ...
  private void processDeleteHostRequests(List<HostRequest> requests,  Clusters clusters, DeleteStatusMetaData deleteStatusMetaData) throws ShpurdpException {
  ...
  private void validateHostInDeleteFriendlyState(HostRequest hostRequest, Clusters clusters) throws ShpurdpException {
    ...
    for (String clusterName : clusterNamesForHost) {
      ...
      if (!list.isEmpty()) {
        ...
        if (!componentsStarted.isEmpty()) {
          ...
          throw new ShpurdpException(reason.toString());
        }
      }
    }
  }
   ...
   */
  private void removeHostFromClusterTopology(Clusters clusters, HostRequest hostRequest) throws ShpurdpException{
    if (hostRequest.getClusterName() == null) {
