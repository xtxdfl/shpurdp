...
import org.apache.shpurdp.server.bootstrap.BSResponse.BSRunStat;
...
public class BootStrapImpl {
  ...
  @Inject
  public BootStrapImpl(Configuration conf, ShpurdpMetaInfo shpurdpMetaInfo) throws IOException {
    ...
    projectVersion = shpurdpMetaInfo.getServerVersion();
