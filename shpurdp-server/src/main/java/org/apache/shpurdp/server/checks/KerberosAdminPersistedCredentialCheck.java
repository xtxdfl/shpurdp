...
import static org.apache.shpurdp.server.stack.upgrade.Task.Type.REGENERATE_KEYTABS;
...
public class KerberosAdminPersistedCredentialCheck extends ClusterCheck {
  ...
  static final UpgradeCheckDescription KERBEROS_ADMIN_CREDENTIAL_CHECK = new UpgradeCheckDescription("KERBEROS_ADMIN_CREDENTIAL_CHECK",
      ...
      "The KDC administrator credentials need to be stored in Shpurdp persisted credential store.",
      new ImmutableMap.Builder<String, String>()
          .put(KerberosAdminPersistedCredentialCheck.KEY_PERSISTED_STORE_NOT_CONFIGURED,
              "Shpurdp's credential store has not been configured.  " +
  ...
  public UpgradeCheckResult perform(UpgradeCheckRequest request) throws ShpurdpException {
    ...
    // Perform the check only if Shpurdp is managing the Kerberos identities
