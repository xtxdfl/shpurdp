...
public class GuiceJpaInitializer {
   ...
   * <p>
   * Starts the JPA service and holds on to an {@link ShpurdpEventPublisher} for future use.
   *
   * @param service   the persist service
   * @param publisher the Shpurdp event publisher
   */
  @Inject
  public GuiceJpaInitializer(PersistService service, ShpurdpEventPublisher publisher) {
