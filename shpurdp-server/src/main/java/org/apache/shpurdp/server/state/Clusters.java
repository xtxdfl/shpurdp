...
public interface Clusters {
  ...
  /**
   * Get all hosts being tracked by the Shpurdp server
   ...
   * @throws ShpurdpException
   */
  Host getHost(String hostname) throws ShpurdpException;
  ...
  /**
   * Get a Host object managed by this server
   * @param hostId Host Id from the {@link org.apache.shpurdp.server.orm.entities.HostEntity} objecty
   * @return Host object
   * @throws ShpurdpException
   */
  Host getHostById(Long hostId) throws ShpurdpException;
   ...
   * @throws ShpurdpException
   */
  void addHost(String hostname) throws ShpurdpException;
   ...
   * @throws ShpurdpException
   */
  Cluster getClusterById(long id) throws ShpurdpException;
   ...
   * @param hostname
   */
  void deleteHost(String hostname) throws ShpurdpException;
