...
public class ServiceComponentImpl implements ServiceComponent {
  ...
  @Override
  public void updateComponentInfo() throws ShpurdpException {
    StackId stackId = service.getDesiredStackId();
    try {
      ComponentInfo compInfo = shpurdpMetaInfo.getComponent(stackId.getStackName(),
  ...
  public void addServiceComponentHosts(
      Map<String, ServiceComponentHost> hostComponents) throws ShpurdpException {
    // TODO validation
  ...
  public void addServiceComponentHost(
      ServiceComponentHost hostComponent) throws ShpurdpException {
    ...
    try {
      ...
      if (hostComponents.containsKey(hostComponent.getHostName())) {
        throw new ShpurdpException("Cannot add duplicate ServiceComponentHost" + ", clusterName="
  ...
  @Override
  public ServiceComponentHost addServiceComponentHost(String hostName) throws ShpurdpException {
  ...
  public void deleteAllServiceComponentHosts(DeleteHostComponentStatusMetaData deleteMetaData) {
    ...
    try {
      ...
      for (ServiceComponentHost sch : hostComponents.values()) {
        if (!sch.canBeRemoved()) {
          deleteMetaData.setShpurdpException(new ShpurdpException("Found non removable hostcomponent " + " when trying to delete"
  ...
  @Override
  public void deleteServiceComponentHosts(String hostname, DeleteHostComponentStatusMetaData deleteMetaData) throws ShpurdpException {
    readWriteLock.writeLock().lock();
    try {
  ...
  @Override
  @Transactional
  public void updateRepositoryState(String reportedVersion) throws ShpurdpException {
