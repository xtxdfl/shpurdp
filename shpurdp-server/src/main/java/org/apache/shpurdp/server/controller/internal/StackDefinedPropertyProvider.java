...
import org.apache.shpurdp.server.controller.metrics.RestMetricsPropertyProvider;
...
import org.apache.shpurdp.server.state.UriInfo;
...
public class StackDefinedPropertyProvider implements PropertyProvider {
  ...
  @Inject
  private static ShpurdpMetaInfo metaInfo = null;
