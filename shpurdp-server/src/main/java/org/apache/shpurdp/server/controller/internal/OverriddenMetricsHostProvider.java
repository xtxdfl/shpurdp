...
public class OverriddenMetricsHostProvider implements MetricHostProvider {
  ...
  private Map<String, Map<String, String>> config(String clusterName) throws ShpurdpException {
    return configHelper.getEffectiveConfigProperties(clusterName, null);
  }

  private String hostName(String resolvedHost) throws ShpurdpException {
