...
public class KerberosPrincipalDescriptor extends AbstractKerberosDescriptor {
   ...
   * Creates a new KerberosPrincipalDescriptor
   * <p/>
   * See {@link org.apache.shpurdp.server.state.kerberos.KerberosPrincipalDescriptor} for the JSON
   * Schema that may be used to generate this map.
   *
   * @param data a Map of values use to populate the data for the new instance
   * @see org.apache.shpurdp.server.state.kerberos.KerberosPrincipalDescriptor
   */
   ...
   * {@link org.apache.shpurdp.server.state.kerberos.KerberosPrincipalDescriptor}
   *
