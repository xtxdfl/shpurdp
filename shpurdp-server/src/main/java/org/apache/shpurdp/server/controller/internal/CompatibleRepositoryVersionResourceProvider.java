...
public class CompatibleRepositoryVersionResourceProvider extends ReadOnlyResourceProvider {
  ...
  @Inject
  private static Provider<ShpurdpMetaInfo> s_shpurdpMetaInfo;

  /**
   * Create a new resource provider.
   */
  public CompatibleRepositoryVersionResourceProvider(ShpurdpManagementController amc) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Map<String, UpgradePack> packs = s_shpurdpMetaInfo.get().getUpgradePacks(
    ...
    for (CompatibleRepositoryVersion entity : compatibleRepositoryVersionsMap.values()) {
      ...
      try {
        stack = s_shpurdpMetaInfo.get().getStack(repositoryVersionEntity.getStackName(), repositoryVersionEntity.getStackVersion());
