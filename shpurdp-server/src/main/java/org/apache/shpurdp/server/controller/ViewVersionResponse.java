...
import org.apache.shpurdp.server.api.services.views.ViewVersionService;
import org.apache.shpurdp.server.controller.internal.ViewVersionResourceProvider;
...
public class ViewVersionResponse implements ApiModel {
  ...
  public static class ViewVersionInfo implements ApiModel {
    ...
    private final String maxShpurdpVersion;
    private final String minShpurdpVersion;
     ...
     * @param maxShpurdpVersion      maximum shpurdp version
     * @param minShpurdpVersion      minimum shpurdp version
    ...
    public ViewVersionInfo(String archive, String buildNumber, boolean clusterConfigurable, String description,
                           String label, String maskerClass, String maxShpurdpVersion, String minShpurdpVersion,
      ...
      this.maxShpurdpVersion = maxShpurdpVersion;
      this.minShpurdpVersion = minShpurdpVersion;
    ...
    /**
     * Returns maximum shpurdp version
     * @return maximum shpurdp version
     */
    @ApiModelProperty(name = ViewVersionResourceProvider.MAX_SHPURDP_VERSION_PROPERTY_ID)
    public String getMaxShpurdpVersion() {
      return maxShpurdpVersion;
    }

    /**
     * Returns minimum shpurdp version
     * @return minimum shpurdp version
     */
    @ApiModelProperty(name = ViewVersionResourceProvider.MIN_SHPURDP_VERSION_PROPERTY_ID)
    public String getMinShpurdpVersion() {
      return minShpurdpVersion;
    }
