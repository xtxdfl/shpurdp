...
public class PropertyHelper {
   ...
   */
  public static Map<String, org.apache.shpurdp.server.state.stack.Metric> processRpcMetricDefinition(String metricType,
      String componentName, String propertyId, org.apache.shpurdp.server.state.stack.Metric metric) {
    Map<String, org.apache.shpurdp.server.state.stack.Metric> replacementMap = null;
      ...
      for (Map.Entry<String, List<String>> entry : RPC_METRIC_SUFFIXES.entrySet()) {
        ...
        if (propertyId.startsWith(prefix)) {
          ...
          for (String suffix : entry.getValue()) {
            ...
            org.apache.shpurdp.server.state.stack.Metric newMetric = new org.apache.shpurdp.server.state.stack.Metric(
              newMetricName,
