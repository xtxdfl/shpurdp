...
import org.apache.shpurdp.server.orm.entities.HostGroupConfigEntity;
...
public class BlueprintImpl implements Blueprint {
   ...
   * @throws GPLLicenseNotAcceptedException shpurdp was configured to use gpl software, but gpl license is not accepted
   */
  @Override
  ...
  private void parseStack(StackEntity stackEntity) throws NoSuchStackException {
    try {
      ...
      stack = new Stack(stackEntity.getStackName(), stackEntity.getStackVersion(), ShpurdpServer.getController());
