...
import org.apache.shpurdp.server.scheduler.AbstractLinearExecutionJob;
...
public class BatchRequestJob extends AbstractLinearExecutionJob {
  ...
  @Override
  protected void doWork(Map<String, Object> properties) throws ShpurdpException {
    ...
    if (executionId == null || batchId == null) {
      throw new ShpurdpException("Unable to retrieve persisted batch request"
    ...
    if (requestId != null) {
      ...
      if (executionScheduleManager.hasToleranceThresholdExceeded
        ...
        throw new ShpurdpException("Task failure tolerance limit exceeded"
            + ", execution_id = " + executionId
