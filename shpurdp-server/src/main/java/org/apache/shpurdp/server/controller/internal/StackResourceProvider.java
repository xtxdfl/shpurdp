...
import org.apache.shpurdp.server.controller.StackRequest;
...
public class StackResourceProvider extends ReadOnlyResourceProvider {
  ...
  protected StackResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<StackResponse> responses = getResources(new Command<Set<StackResponse>>() {
      @Override
      public Set<StackResponse> invoke() throws ShpurdpException {
