 ...
 */
package org.apache.shpurdp.server.stack.upgrade;
...
import org.apache.shpurdp.server.controller.internal.OperatingSystemResourceProvider;
import org.apache.shpurdp.server.controller.internal.RepositoryResourceProvider;
...
public class RepositoryVersionHelper {
  ...
  @Inject
  private Provider<ShpurdpMetaInfo> ami;
  ...
  public List<RepoOsEntity> parseOperatingSystems(String repositoriesJson) throws Exception {
    ...
    for (JsonElement operatingSystemJson: rootJson) {
      ...
      if (osObj.has(OperatingSystemResourceProvider.OPERATING_SYSTEM_SHPURDP_MANAGED_REPOS)) {
        operatingSystemEntity.setShpurdpManaged(osObj.get(
            OperatingSystemResourceProvider.OPERATING_SYSTEM_SHPURDP_MANAGED_REPOS).getAsBoolean());
      }
  ...
  public List<RepoOsEntity> createRepoOsEntities(List<RepositoryInfo> repositories) {
    ...
    for (Entry<String, Collection<RepositoryInfo>> operatingSystem : operatingSystems.asMap().entrySet()) {
      ...
      for (RepositoryInfo repository : operatingSystem.getValue()) {
        ...
        operatingSystemEntity.setShpurdpManaged(repository.isShpurdpManagedRepositories());
      }
   ...
   * @throws ShpurdpException if no upgrade packs suit the requirements
   */
  public String getUpgradePackageName(String stackName, String stackVersion, String repositoryVersion, UpgradeType upgradeType) throws ShpurdpException {
    ...
    throw new ShpurdpException("There were no suitable upgrade packs for stack " + stackName + " " + stackVersion +
   ...
   */
  public Map<String, String> buildRoleParams(ShpurdpManagementController amc, RepositoryVersionEntity repoVersion, String osFamily, Set<String> servicesOnHost)
  ...
  public CommandRepository getCommandRepository(final Cluster cluster, final Service service, final Host host,
                                                final String componentName) throws ShpurdpException {
  ...
  public void addRepoInfoToHostLevelParams(final Cluster cluster, final ActionExecutionContext actionContext,
                                           ...
                                           final String hostName) throws ShpurdpException {
   ...
   *
   * @throws ShpurdpException if the repository information can not be obtained
   */
  public String getRepoInfoString(Cluster cluster, ServiceComponent component, Host host) throws ShpurdpException, SystemException {
