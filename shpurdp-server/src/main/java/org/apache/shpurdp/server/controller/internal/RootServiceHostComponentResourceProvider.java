...
import org.apache.shpurdp.server.controller.RootServiceHostComponentRequest;
...
public class RootServiceHostComponentResourceProvider extends ReadOnlyResourceProvider {
  ...
  public RootServiceHostComponentResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<RootServiceHostComponentResponse> responses = getResources(new Command<Set<RootServiceHostComponentResponse>>() {
      @Override
      public Set<RootServiceHostComponentResponse> invoke() throws ShpurdpException {
  ...
  protected Set<RootServiceHostComponentResponse> getRootServiceHostComponents(
      Set<RootServiceHostComponentRequest> requests) throws ShpurdpException {
  ...
  private Set<RootServiceHostComponentResponse> getRootServiceHostComponents(
      RootServiceHostComponentRequest request) throws ShpurdpException{
