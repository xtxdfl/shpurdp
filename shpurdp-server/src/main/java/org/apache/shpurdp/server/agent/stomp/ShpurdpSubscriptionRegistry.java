 ...
 */
public class ShpurdpSubscriptionRegistry extends AbstractSubscriptionRegistry {
  private static final Logger LOG = LoggerFactory.getLogger(ShpurdpSubscriptionRegistry.class);
  ...
  public ShpurdpSubscriptionRegistry(int cacheLimit) {
