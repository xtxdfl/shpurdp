...
public class DeleteHostComponentStatusMetaData extends DeleteStatusMetaData {
  ...
  private ShpurdpException shpurdpException;
  ...
  public ShpurdpException getShpurdpException() {
    return shpurdpException;
  }

  public void setShpurdpException(ShpurdpException shpurdpException) {
    this.shpurdpException = shpurdpException;
  }
