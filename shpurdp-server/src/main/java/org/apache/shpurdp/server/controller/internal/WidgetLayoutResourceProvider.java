...
public class WidgetLayoutResourceProvider extends AbstractControllerResourceProvider {
   ...
   *
   */
  public WidgetLayoutResourceProvider(ShpurdpManagementController managementController) {
  ...
  public RequestStatus createResources(final Request request)
    ...
    for (final Map<String, Object> properties : request.getProperties()) {
      WidgetLayoutEntity widgetLayoutEntity = createResources(new Command<WidgetLayoutEntity>() {
        ...
        @Override
        public WidgetLayoutEntity invoke() throws ShpurdpException {
          ...
          for (Object widgetObject : widgetsSet) {
            ...
            if (widgetEntity == null) {
              throw new ShpurdpException("Widget with id " + widget.get("id") + " does not exists");
            }
