...
/**
 * The ShpurdpDelegatingAuthenticationFilter is an authentication filter that holds zero or more
 * {@link org.apache.shpurdp.server.security.authorization.ShpurdpAuthorizationFilter}s.
 * <p>
 ...
 */
@Component
public class ShpurdpDelegatingAuthenticationFilter implements Filter {
  private static final Logger LOG = LoggerFactory.getLogger(ShpurdpDelegatingAuthenticationFilter.class);

  /**
   * The ordered collections of {@link org.apache.shpurdp.server.security.authorization.ShpurdpAuthorizationFilter}s
   */
  private final Collection<ShpurdpAuthenticationFilter> filters;

  /**
   * Constructor.
   *
   * @param filters an ordered collections of {@link org.apache.shpurdp.server.security.authorization.ShpurdpAuthorizationFilter}s
   */
  public ShpurdpDelegatingAuthenticationFilter(Collection<ShpurdpAuthenticationFilter> filters) {
    ...
    if (this.filters.isEmpty()) {
      ...
      for (ShpurdpAuthenticationFilter filter : this.filters) {
        filterNames.append("\n\t");
  ...
  /**
   * Iterates over the contained {@link org.apache.shpurdp.server.security.authorization.ShpurdpAuthorizationFilter}s
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    for (ShpurdpAuthenticationFilter filter : filters) {
