...
@Table(name = "mpacks")
@Entity
@TableGenerator(name = "mpack_id_generator", table = "shpurdp_sequences", pkColumnName = "sequence_name", valueColumnName = "sequence_value", pkColumnValue = "mpack_id_seq", initialValue = 1)
@NamedQueries({
