...
public class AlertLifecycleListener {
   ...
   */
  @Inject
  public AlertLifecycleListener(ShpurdpEventPublisher publisher) {
  ...
  public void onShpurdpEvent(AlertDefinitionRegistrationEvent event) {
  ...
  @Subscribe
  @AllowConcurrentEvents
  public void onShpurdpEvent(AlertDefinitionChangedEvent event) {
    LOG.debug("Received event {}", event);
  ...
  @Subscribe
  @AllowConcurrentEvents
  public void onShpurdpEvent(AlertDefinitionDeleteEvent event) {
    LOG.debug("Received event {}", event);
