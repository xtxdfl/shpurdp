...
/**
 * Remote Shpurdp Service to Remote Cluster Mapping
 */
@Table(name = "remoteshpurdpclusterservice")
...
@Entity
public class RemoteShpurdpClusterServiceEntity {
  ...
  private RemoteShpurdpClusterEntity cluster;
   ...
   * @return cluster
   */
  public RemoteShpurdpClusterEntity getCluster() {
    return cluster;
  }
   ...
   * @param cluster
   */
  public void setCluster(RemoteShpurdpClusterEntity cluster) {
