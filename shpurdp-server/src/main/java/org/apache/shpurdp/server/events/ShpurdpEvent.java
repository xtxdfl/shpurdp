...
/**
 * The {@link ShpurdpEvent} class is the base for all events in Shpurdp.
 */
public abstract class ShpurdpEvent {

  /**
   * The {@link ShpurdpEventType} defines the type of Shpurdp event.
   */
  public enum ShpurdpEventType {
    /**
    ...
    /**
     * Shpurdp configuration changed event;
     */
    SHPURDP_CONFIGURATION_CHANGED,

    /**
     * Shpurdp properties changed event;
     */
    SHPURDP_PROPERTIES_CHANGED,
   ...
   */
  protected final ShpurdpEventType m_eventType;
   ...
   */
  public ShpurdpEvent(ShpurdpEventType eventType) {
    m_eventType = eventType;
  }

  /**
   * Gets the type of {@link ShpurdpEvent}.
   *
   * @return the event type (never {@code null}).
   */
  public ShpurdpEventType getType() {
    return m_eventType;
  }
