...
/**
 * The {@link UpgradeCatalog280} upgrades Shpurdp from 2.7.2 to 2.8.0.
 */
public class UpgradeCatalog280 extends AbstractUpgradeCatalog {
  ...
  protected void executeDDLUpdates() throws ShpurdpException, SQLException {
    ...
    modifyPropertyValueColumnInShpurdpConfigurationTable();
  }

  private void modifyPropertyValueColumnInShpurdpConfigurationTable() throws SQLException {
    dbAccessor.alterColumn(SHPURDP_CONFIGURATION_TABLE, new DBAccessor.DBColumnInfo(SHPURDP_CONFIGURATION_PROPERTY_VALUE_COLUMN, String.class, 4000, null, false));
    LOG.info("Altered {}.{} to NOT NULL and extended its length to 4000", SHPURDP_CONFIGURATION_TABLE, SHPURDP_CONFIGURATION_PROPERTY_VALUE_COLUMN);
  }
