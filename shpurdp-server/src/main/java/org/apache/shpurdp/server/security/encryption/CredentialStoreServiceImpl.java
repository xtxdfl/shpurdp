...
import org.apache.shpurdp.server.security.SecurePasswordHelper;
...
public class CredentialStoreServiceImpl implements CredentialStoreService {
  ...
  public synchronized void initializeTemporaryCredentialStore(long retentionDuration, TimeUnit units, boolean activelyPurge) throws ShpurdpException {
    if (isInitialized(CredentialStoreType.TEMPORARY)) {
      throw new ShpurdpException("This temporary CredentialStore has already been initialized");
    }
  ...
  public synchronized void initializePersistedCredentialStore(File credentialStoreLocation, MasterKeyService masterKeyService) throws ShpurdpException {
    if (isInitialized(CredentialStoreType.PERSISTED)) {
      throw new ShpurdpException("This persisted CredentialStore has already been initialized");
    }
   ...
   */
  @Override
  public void setCredential(String clusterName, String alias, Credential credential, CredentialStoreType credentialStoreType) throws ShpurdpException {
  ...
  @Override
  public Credential getCredential(String clusterName, String alias) throws ShpurdpException {
  ...
  @Override
  public Credential getCredential(String clusterName, String alias, CredentialStoreType credentialStoreType) throws ShpurdpException {
  ...
  @Override
  public void removeCredential(String clusterName, String alias) throws ShpurdpException {
  ...
  @Override
  public void removeCredential(String clusterName, String alias, CredentialStoreType credentialStoreType) throws ShpurdpException {
  ...
  @Override
  public boolean containsCredential(String clusterName, String alias) throws ShpurdpException {
  ...
  @Override
  public boolean containsCredential(String clusterName, String alias, CredentialStoreType credentialStoreType) throws ShpurdpException {
    return isInitialized(credentialStoreType) &&
        getCredentialStore(credentialStoreType).containsCredential(canonicalizeAlias(clusterName, alias));
  }

  @Override
  public CredentialStoreType getCredentialStoreType(String clusterName, String alias) throws ShpurdpException {
    if (containsCredential(clusterName, alias, CredentialStoreType.TEMPORARY)) {
      ...
      throw new ShpurdpException("The alias was not found in either the persisted or temporary credential stores");
    }
  }

  @Override
  public Map<String, CredentialStoreType> listCredentials(String clusterName) throws ShpurdpException {
    if (!isInitialized()) {
      throw new ShpurdpException("This CredentialStoreService has not yet been initialized");
    }
   ...
   *
   * @param credentialStoreType a CredentialStoreType indicating which credential store facility to use
   * @throws ShpurdpException if the requested store has not been initialized
   */
  private void validateInitialized(CredentialStoreType credentialStoreType) throws ShpurdpException {
    if (!isInitialized(credentialStoreType)) {
      throw new ShpurdpException(String.format("The %s CredentialStore for this CredentialStoreService has not yet been initialized",
