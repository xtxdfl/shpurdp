...
public class StackServiceDirectory extends ServiceDirectory {
   ...
   * @throws org.apache.shpurdp.server.ShpurdpException if unable to parse the service directory
   */
  public StackServiceDirectory(String servicePath) throws ShpurdpException {
    super(servicePath);
  }
