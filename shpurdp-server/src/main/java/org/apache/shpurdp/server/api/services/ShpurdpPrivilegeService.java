...
/**
 *  Service responsible for Shpurdp privilege resource requests.
 */
@Path("/privileges/")
public class ShpurdpPrivilegeService extends PrivilegeService {

  // ----- PrivilegeService --------------------------------------------------

  @Override
  protected ResourceInstance createPrivilegeResource(String privilegeId) {
    return createResource(Resource.Type.ShpurdpPrivilege,
        Collections.singletonMap(Resource.Type.ShpurdpPrivilege, privilegeId));
  }
}
