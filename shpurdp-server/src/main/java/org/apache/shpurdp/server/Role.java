...
/**
 * Role defines the components that are available to Shpurdp.  It has a few
...
public class Role {
  ...
  public static final Role SHPURDP_SERVER_ACTION = valueOf("SHPURDP_SERVER_ACTION");
  ...
  public static final Role AMS_SERVICE_CHECK = valueOf("SHPURDP_METRICS_SERVICE_CHECK");
