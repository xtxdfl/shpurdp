...
/**
 * ShpurdpUserDetails is an implementation of {@link ShpurdpUserDetails}
 * <p>
 ...
 */
public class ShpurdpUserDetailsImpl implements ShpurdpUserDetails {

  private final User user;
  private final String password;
  private final Collection<? extends GrantedAuthority> grantedAuthorities;

  public ShpurdpUserDetailsImpl(User user, String password, Collection<? extends GrantedAuthority> grantedAuthorities) {
    this.user = user;
