...
public class SecretReference {
  ...
  public SecretReference(String reference, Cluster cluster) throws ShpurdpException{
    ...
    if(refConfig == null)
      throw new ShpurdpException(String.format("Error when parsing secret reference. Cluster: %s does not contain ConfigType: %s ConfigVersion: %s",
    ...
    if(!refProperties.containsKey(propertyName))
      throw new ShpurdpException(String.format("Error when parsing secret reference. Cluster: %s ConfigType: %s ConfigVersion: %s does not contain property '%s'",
