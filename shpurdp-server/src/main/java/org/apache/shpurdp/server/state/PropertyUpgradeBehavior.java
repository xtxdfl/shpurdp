...
/**
 * Represents a behavior used during shpurdp upgrade for property
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class PropertyUpgradeBehavior {

  /**
   * If true, add property during shpurdp-upgrade. If config type does
  ...
  /**
   * If true, then remove this property during shpurdp-upgrade
   */
  @XmlAttribute(name="delete", required = false)
  private boolean delete = false;

  /**
   * If true, during shpurdp upgrade property value will be blindly overwritten
   * with default value
   */
