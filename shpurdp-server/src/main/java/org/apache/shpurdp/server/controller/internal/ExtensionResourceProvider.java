...
import org.apache.shpurdp.server.controller.ExtensionRequest;
import org.apache.shpurdp.server.controller.ExtensionResponse;
...
public class ExtensionResourceProvider extends ReadOnlyResourceProvider {
  ...
  protected ExtensionResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<ExtensionResponse> responses = getResources(new Command<Set<ExtensionResponse>>() {
      @Override
      public Set<ExtensionResponse> invoke() throws ShpurdpException {
