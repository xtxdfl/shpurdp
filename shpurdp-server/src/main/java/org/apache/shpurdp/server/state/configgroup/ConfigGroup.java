...
/**
 * Configuration group or Config group is a type of Shpurdp resource that
...
public interface ConfigGroup {
   ...
   */
  void addHost(Host host) throws ShpurdpException;
   ...
   * @throws ShpurdpException
   */
  ConfigGroupResponse convertToResponse() throws ShpurdpException;
   ...
   * @param configs
   */
  void setConfigurations(Map<String, Config> configs) throws ShpurdpException;

  /**
   * Remove host mapping
   */
  void removeHost(Long hostId) throws ShpurdpException;
