...
public abstract class AbstractSecurityHeaderFilter implements Filter {
  ...
  /**
   * The Configuration object used to determine how Shpurdp is configured
   */
  @Inject
  private Configuration configuration;

  /**
   * Indicates whether Shpurdp is configured for SSL (true) or not (false).  By default true is assumed
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    ...
    if (configuration == null) {
      LOG.warn("The Shpurdp configuration object is not available, all default options will be assumed.");
    } else {
