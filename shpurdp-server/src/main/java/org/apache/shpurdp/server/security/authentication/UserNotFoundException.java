 ...
 * when the user specified in an authentication attempt is not found in the Shpurdp user database.
 */
public class UserNotFoundException extends ShpurdpAuthenticationException {
