...
import org.apache.shpurdp.server.orm.entities.AlertNoticeEntity_;
...
public class AlertDispatchDAO {
   ...
   * service is not valid, then this will throw an {@link ShpurdpException}.
   *
   * @param clusterId
  ...
  /**
   * The {@link NoticePredicateVisitor} is used to convert an Shpurdp
