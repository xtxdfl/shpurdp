...
public class ExecutionCommand extends AgentCommand {
  ...
  public interface KeyNames {
    ...
    String SHPURDP_JAVA_HOME = "shpurdp_java_home";
    String SHPURDP_JDK_NAME = "shpurdp_jdk_name";
    String SHPURDP_JCE_NAME = "shpurdp_jce_name";
    String SHPURDP_JAVA_VERSION = "shpurdp_java_version";
    ...
    String SHPURDP_DB_RCA_URL = "shpurdp_db_rca_url";
    String SHPURDP_DB_RCA_DRIVER = "shpurdp_db_rca_driver";
    String SHPURDP_DB_RCA_USERNAME = "shpurdp_db_rca_username";
    String SHPURDP_DB_RCA_PASSWORD = "shpurdp_db_rca_password";
   ...
   */
  public void setComponentVersions(Cluster cluster) throws ShpurdpException {
