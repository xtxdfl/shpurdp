...
import org.apache.shpurdp.server.controller.ExtensionVersionRequest;
import org.apache.shpurdp.server.controller.ExtensionVersionResponse;
...
public class ExtensionVersionResourceProvider extends ReadOnlyResourceProvider {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<ExtensionVersionResponse> responses = getResources(new Command<Set<ExtensionVersionResponse>>() {
      @Override
      public Set<ExtensionVersionResponse> invoke() throws ShpurdpException {
