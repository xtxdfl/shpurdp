...
/**
 * The {@link ShpurdpJpaLocalTxnInterceptor} is used to intercept method calls
 ...
 * "parent" transaction.
 */
public class ShpurdpJpaLocalTxnInterceptor implements MethodInterceptor {

  private static final Logger LOG = LoggerFactory.getLogger(ShpurdpJpaLocalTxnInterceptor.class);
  ...
  @Inject
  private final ShpurdpJpaPersistService emProvider = null;
