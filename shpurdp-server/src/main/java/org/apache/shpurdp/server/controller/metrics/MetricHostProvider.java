...
public interface MetricHostProvider {
   ...
   *
   * @throws org.apache.shpurdp.server.controller.spi.SystemException if unable to get the metrics server host name
   */
   ...
   * @throws org.apache.shpurdp.server.controller.spi.SystemException
   ...
   * @return the metrics server
   *
   * @throws org.apache.shpurdp.server.controller.spi.SystemException if unable to get the metrics server port
   */
  ...
  /**
   * If a component is installed to a host that is managed outside of Shpurdp (for example OneFS) then this method will return the external hostname.
   */
