...
import org.apache.shpurdp.server.ldap.service.ShpurdpLdapFacade;
...
import org.apache.shpurdp.server.ldap.service.ads.DefaultLdapAttributeDetectionService;
import org.apache.shpurdp.server.ldap.service.ads.DefaultLdapConfigurationService;
import org.apache.shpurdp.server.ldap.service.ads.DefaultLdapConnectionConfigService;
import org.apache.shpurdp.server.ldap.service.ads.detectors.AttributeDetectorFactory;
import org.apache.shpurdp.server.ldap.service.ads.detectors.GroupMemberAttrDetector;
import org.apache.shpurdp.server.ldap.service.ads.detectors.GroupNameAttrDetector;
import org.apache.shpurdp.server.ldap.service.ads.detectors.GroupObjectClassDetector;
import org.apache.shpurdp.server.ldap.service.ads.detectors.UserGroupMemberAttrDetector;
import org.apache.shpurdp.server.ldap.service.ads.detectors.UserNameAttrDetector;
import org.apache.shpurdp.server.ldap.service.ads.detectors.UserObjectClassDetector;
...
public class LdapModule extends AbstractModule {
  ...
  protected void configure() {
    bind(LdapFacade.class).to(ShpurdpLdapFacade.class);
    ...
    bind(ShpurdpLdapConfiguration.class).toProvider(ShpurdpLdapConfigurationProvider.class);
