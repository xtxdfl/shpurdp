...
import org.apache.shpurdp.server.controller.OperatingSystemRequest;
import org.apache.shpurdp.server.controller.OperatingSystemResponse;
...
public class OperatingSystemResourceProvider extends ReadOnlyResourceProvider {
  ...
  public static final String OPERATING_SYSTEM_SHPURDP_MANAGED_REPOS              = "OperatingSystems/shpurdp_managed_repositories";
  ...
  public static final Set<String> propertyIds = ImmutableSet.of(
      ...
      OPERATING_SYSTEM_SHPURDP_MANAGED_REPOS);
  ...
  protected OperatingSystemResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<OperatingSystemResponse> responses = getResources(new Command<Set<OperatingSystemResponse>>() {
      @Override
      public Set<OperatingSystemResponse> invoke() throws ShpurdpException {
    ...
    for (OperatingSystemResponse response : responses) {
      ...
      setResourceProperty(resource, OPERATING_SYSTEM_SHPURDP_MANAGED_REPOS, response.isShpurdpManagedRepos(),
          requestedIds);
