...
public class GroupService extends BaseService {
   ...
   */
   ...
   @ApiImplicitParams({
     @ApiImplicitParam(name = "body", value = "input parameters in json form", required = true, dataType = "org.apache.shpurdp.server.controller.GroupRequest", paramType = "body")
   })
   @ApiResponses(value = {
