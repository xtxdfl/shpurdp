...
import static org.apache.shpurdp.server.state.kerberos.AbstractKerberosDescriptor.nullToEmpty;
...
public class UsedIdentities {
  ...
  public static UsedIdentities none() throws ShpurdpException {
   ...
   */
  public static UsedIdentities populate(Cluster cluster, ServiceExclude serviceExclude, ComponentExclude componentExclude, KerberosHelper kerberosHelper) throws ShpurdpException {
