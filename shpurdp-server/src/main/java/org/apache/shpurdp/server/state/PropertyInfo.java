...
public class PropertyInfo {
  ...
  @XmlElement(name="on-shpurdp-upgrade", required = true)
  private PropertyUpgradeBehavior propertyShpurdpUpgradeBehavior;
  ...
  public PropertyInfo() {
    propertyShpurdpUpgradeBehavior = new PropertyUpgradeBehavior();
  }
  ...
  public PropertyUpgradeBehavior getPropertyShpurdpUpgradeBehavior() {
    return propertyShpurdpUpgradeBehavior;
  }

  public void setPropertyShpurdpUpgradeBehavior(PropertyUpgradeBehavior propertyShpurdpUpgradeBehavior) {
    this.propertyShpurdpUpgradeBehavior = propertyShpurdpUpgradeBehavior;
  }
  ...
  public Map<String, String> getAttributesMap() {
    ...
    // inject "hidden" property_value_attribute into property_attributes, see SHPURDP-17223
