...
import org.apache.shpurdp.server.collections.Predicate;
import org.apache.shpurdp.server.collections.PredicateUtils;
...
import org.apache.shpurdp.server.controller.internal.ShpurdpServerLDAPConfigurationHandler;
import org.apache.shpurdp.server.controller.internal.ShpurdpServerSSOConfigurationHandler;
...
import org.apache.shpurdp.server.events.ServiceRemovedEvent;
...
import org.apache.shpurdp.server.orm.entities.ServiceDesiredStateEntityPK;
...
public class ServiceImpl implements Service {
   ...
   */
  private final ShpurdpEventPublisher eventPublisher;
  ...
  ServiceImpl(@Assisted Cluster cluster, @Assisted String serviceName,
              ...
              ServiceComponentFactory serviceComponentFactory, ShpurdpMetaInfo shpurdpMetaInfo,
              ShpurdpEventPublisher eventPublisher) throws ShpurdpException {
    ...
    this.shpurdpMetaInfo = shpurdpMetaInfo;
    ...
    ServiceInfo sInfo = shpurdpMetaInfo.getService(stackId.getStackName(),
   ...
   */
  @Override
  public void updateServiceInfo() throws ShpurdpException {
    try {
      ServiceInfo serviceInfo = shpurdpMetaInfo.getService(this);
  ...
  public void addServiceComponents(
      Map<String, ServiceComponent> components) throws ShpurdpException {
  ...
  @Override
  public void addServiceComponent(ServiceComponent component) throws ShpurdpException {
    if (components.containsKey(component.getName())) {
      throw new ShpurdpException("Cannot add duplicate ServiceComponent"
          + ", clusterName=" + cluster.getClusterName()
  ...
  public ServiceResponse convertToResponse() {
    ...
    try {
      existingConfigurations = configHelper.calculateExistingConfigurations(shpurdpManagementController, cluster);
  ...
  @Transactional
  void deleteAllServiceConfigs() throws ShpurdpException {
  ...
  void deleteAllServiceConfigGroups() throws ShpurdpException {
    ...
    try {
      ...
      for (ServiceComponent component : components.values()) {
        if (!component.canBeRemoved()) {
          deleteMetaData.setShpurdpException(new ShpurdpException("Found non removable component when trying to"
  ...
  public void deleteServiceComponent(String componentName, DeleteHostComponentStatusMetaData deleteMetaData)
    ...
    try {
      ...
      // FIXME check dependencies from meta layer
      if (!component.canBeRemoved()) {
        throw new ShpurdpException("Could not delete component from cluster"
            + ", clusterName=" + cluster.getClusterName()
            + ", serviceName=" + getName()
  ...
  public void delete(DeleteHostComponentStatusMetaData deleteMetaData) {
    ...
    try {
      ...
      deleteMetaData.setShpurdpException(e);
      return;
    }
  ...
  private boolean isSsoIntegrationDesired() {
    return shpurdpServerSSOConfigurationHandler.getSSOEnabledServices().contains(serviceName);
  }
  ...
  private boolean isLdapIntegrationDesired() {
    return shpurdpServerLDAPConfigurationHandler.getLDAPEnabledServices().contains(serviceName);
  }
}
