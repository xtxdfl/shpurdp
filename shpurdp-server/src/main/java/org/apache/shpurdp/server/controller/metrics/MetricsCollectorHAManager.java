...
public class MetricsCollectorHAManager {
  ...
  public MetricsCollectorHAManager() {
    ...
    if (null == eventPublisher && null != ShpurdpServer.getController()) {
      eventPublisher = ShpurdpServer.getController().getShpurdpEventPublisher();
      if (eventPublisher != null) {
        eventPublisher.register(this);
      } else {
        LOG.error("Unable to retrieve ShpurdpEventPublisher for Metric collector host event listening.");
      }
    }
  }
