...
import org.apache.shpurdp.server.api.services.stackadvisor.recommendations.RecommendationResponse.BindingHostGroup;
import org.apache.shpurdp.server.api.services.stackadvisor.recommendations.RecommendationResponse.HostGroup;
...
public class RecommendationResourceProvider extends StackAdvisorResourceProvider {
  ...
  protected RecommendationResourceProvider(ShpurdpManagementController managementController) {
  ...
  public RequestStatus createResources(final Request request) throws SystemException,
    ...
    Resource recommendation = createResources(new Command<Resource>() {
      @Override
      public Resource invoke() throws ShpurdpException {
