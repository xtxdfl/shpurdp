...
public class ComponentInfo {
   ...
   * at the moment. For instance, ZKFC has the same version as NameNode, while SHPURDP_METRICS and KERBEROS do not have a mechanism.
   *
  ...
  */
   ...
   * If you call this function, you must still call {@see org.apache.shpurdp.server.stack.ComponentModule#resolve()}.
