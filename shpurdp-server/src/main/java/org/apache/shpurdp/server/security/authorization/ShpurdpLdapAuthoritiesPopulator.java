 ...
 */
public class ShpurdpLdapAuthoritiesPopulator implements LdapAuthoritiesPopulator {
  private static final Logger log = LoggerFactory.getLogger(ShpurdpLdapAuthoritiesPopulator.class);
  ...
  @Inject
  public ShpurdpLdapAuthoritiesPopulator(AuthorizationHelper authorizationHelper,
