...
package org.apache.shpurdp.server.state.quicklinksprofile;
 ...
 * <p>When a quick link profile is set in Shpurdp, then each quick link's visibility flag is updated according to the profile
 * before being returned by {@link org.apache.shpurdp.server.controller.internal.QuickLinkArtifactResourceProvider}.</p>
...
public class QuickLinksProfile {
  ...
  /**
   * The name of the Shpurdp setting that stores the quick links profile
   */
  public static final String SETTING_NAME_QUICKLINKS_PROFILE = "QuickLinksProfile";
  /**
   * The type of the Shpurdp setting that stores the quick links profile
   */
  public static final String SETTING_TYPE_SHPURDP_SERVER = "shpurdp-server";
