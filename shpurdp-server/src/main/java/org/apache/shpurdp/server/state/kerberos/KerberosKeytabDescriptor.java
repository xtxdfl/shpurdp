 ...
 *                          Shpurdp server (true) or not (false)",
 *          "type": "boolean"
 *        }
 *      }
 *   }
...
public class KerberosKeytabDescriptor extends AbstractKerberosDescriptor {
  ...
  /**
   * A boolean value indicating whether the generated keytab is allowed to be cached by the Shpurdp
   * server or not.
   */
   ...
   * @param cachable      true if the keytab may be cached by Shpurdp; otherwise false
   */
   ...
   * Creates a new KerberosKeytabDescriptor
   * <p/>
   * See {@link org.apache.shpurdp.server.state.kerberos.KerberosKeytabDescriptor} for the JSON
   * Schema that may be used to generate this map.
   *
   * @param data a Map of values use to populate the data for the new instance
   * @see org.apache.shpurdp.server.state.kerberos.KerberosKeytabDescriptor
   */
  ...
  /**
   * Indicates whether the generated keytab is allowed to be cached by the Shpurdp server or not
   *
  ...
  /**
   * Sets whether the generated keytab is allowed to be cached by the Shpurdp server or not
   *
   ...
   * {@link org.apache.shpurdp.server.state.kerberos.KerberosKeytabDescriptor}
   *
