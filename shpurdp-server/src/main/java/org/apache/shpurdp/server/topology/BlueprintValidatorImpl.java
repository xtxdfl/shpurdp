...
import org.apache.shpurdp.server.state.DependencyConditionInfo;
...
public class BlueprintValidatorImpl implements BlueprintValidator {
  ...
  @Inject
  private static org.apache.shpurdp.server.configuration.Configuration configuration;
  ...
  public void validateRequiredProperties() throws InvalidTopologyException, GPLLicenseNotAcceptedException {
    ...
    if (clusterConfigurations != null) {
      ...
      // need to reject blueprints that have LZO enabled if the Shpurdp Server hasn't been configured for it
          ...
          for (Map.Entry<String, String> propertyEntry : configEntry.getValue().entrySet()) {
            ...
            if (propertyValue != null) {
              if (!gplEnabled && configType.equals("core-site")
                ...
                throw new GPLLicenseNotAcceptedException("Your Shpurdp server has not been configured to download LZO GPL software. " +
                    "Please refer to documentation to configure Shpurdp before proceeding.");
              }
