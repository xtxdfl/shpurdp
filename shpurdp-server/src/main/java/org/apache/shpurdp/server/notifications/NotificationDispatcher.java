 ...
 */
package org.apache.shpurdp.server.notifications;
...
public interface NotificationDispatcher {
  ...
  /**
   * Gets whether Shpurdp should attempt to generate the content of the
   ...
   *
   * @return {@code true} if Shpurdp should generate the {@link Notification}
