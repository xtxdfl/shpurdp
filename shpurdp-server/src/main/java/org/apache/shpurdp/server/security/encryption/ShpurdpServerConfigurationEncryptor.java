...
import org.apache.shpurdp.server.utils.TextEncoding;

import com.google.inject.Inject;

public class ShpurdpServerConfigurationEncryptor implements Encryptor<ShpurdpServerConfiguration> {

  private final Set<String> passwordConfigurations = ShpurdpServerConfigurationKey.findPasswordConfigurations();
  private final EncryptionService encryptionService;

  @Inject
  public ShpurdpServerConfigurationEncryptor(EncryptionService encryptionService) {
    this.encryptionService = encryptionService;
  }

  @Override
  public void encryptSensitiveData(ShpurdpServerConfiguration encryptible) {
  ...
  @Override
  public void decryptSensitiveData(ShpurdpServerConfiguration decryptible) {
  ...
  public String getEncryptionKey() {
    return encryptionService.getShpurdpMasterKey();
  }
