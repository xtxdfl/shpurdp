...
/**
 * Checks that all hosts are heartbeating with the Shpurdp Server. If there is a
...
public class HostsHeartbeatCheck extends ClusterCheck {
  ...
  static final UpgradeCheckDescription HOSTS_HEARTBEAT = new UpgradeCheckDescription("HOSTS_HEARTBEAT",
      ...
      "All hosts must be communicating with Shpurdp. Hosts which are not reachable should be placed in Maintenance Mode.",
      new ImmutableMap.Builder<String, String>()
        .put(UpgradeCheckDescription.DEFAULT,
            "There are hosts which are not communicating with Shpurdp.").build());
