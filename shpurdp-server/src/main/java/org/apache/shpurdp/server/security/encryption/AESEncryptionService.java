...
public class AESEncryptionService implements EncryptionService {
  ...
  public String encrypt(String toBeEncrypted, TextEncoding textEncoding) {
    return encrypt(toBeEncrypted, getShpurdpMasterKey(), textEncoding);
  }
  ...
  @Override
  public final String getShpurdpMasterKey() {
  ...
  public String decrypt(String toBeDecrypted, TextEncoding textEncoding) {
    return decrypt(toBeDecrypted, getShpurdpMasterKey(), textEncoding);
  }
