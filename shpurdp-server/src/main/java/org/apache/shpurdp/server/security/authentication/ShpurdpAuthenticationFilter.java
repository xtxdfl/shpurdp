...
/**
 * ShpurdpAuthenticationFilter is a {@link Filter} interface to be implemented
 * by authentication filters used by the Shpurdp server. More specifically, implementations
 * of this interface may be used in the {@link ShpurdpDelegatingAuthenticationFilter}.
 *
 * @see ShpurdpDelegatingAuthenticationFilter
 */
public interface ShpurdpAuthenticationFilter extends Filter {

  /**
   * Tests this ShpurdpAuthenticationFilter to see if it should be applied to the filter chain
   ...
   * @return true if this ShpurdpAuthenticationFilter should be applied to the filter chain; otherwise false.
   */
  boolean shouldApply(HttpServletRequest httpServletRequest);

  /**
   * Tests this ShpurdpAuthenticationFilter to see if authentication failures should count towards
