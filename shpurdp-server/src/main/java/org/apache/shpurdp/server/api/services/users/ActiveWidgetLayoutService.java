...
public class ActiveWidgetLayoutService extends BaseService {
  ...
  @ApiImplicitParams({
    @ApiImplicitParam(name = "body", value = "input parameters in json form", required = true, dataType = "org.apache.shpurdp.server.controller.ActiveWidgetLayoutRequest", paramType = "body")
  })
  @ApiResponses(value = {
