...
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_DIRECTION;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_FAIL_ON_CHECK_WARNINGS;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_HOST_ORDERED_HOSTS;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_PACK;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_REPO_VERSION_ID;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_REVERT_UPGRADE_ID;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_SKIP_FAILURES;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_SKIP_MANUAL_VERIFICATION;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_SKIP_PREREQUISITE_CHECKS;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_SKIP_SC_FAILURES;
import static org.apache.shpurdp.server.controller.internal.UpgradeResourceProvider.UPGRADE_TYPE;
...
import org.apache.shpurdp.server.controller.internal.PreUpgradeCheckResourceProvider;
...
import org.apache.shpurdp.spi.upgrade.UpgradeInformation;
...
public class UpgradeContext {
   ...
   */
  @Inject
  private ShpurdpMetaInfo m_metaInfo;
  ...
  private UpgradeType calculateUpgradeType(Map<String, Object> upgradeRequestMap,
                                           UpgradeEntity upgradeEntity) throws ShpurdpException{
    ...
    if (upgradeTypePassed){
      try {
        ...
        throw new ShpurdpException(String.format("Property %s has an incorrect value of %s.",
  ...
  public UpgradeContext(@Assisted Cluster cluster,
    ...
    if (m_isRevert) {
      ...
      if (!revertUpgrade.getOrchestration().isRevertable()) {
        throw new ShpurdpException(String.format("The %s repository type is not revertable",
      ...
      if (StringUtils.isEmpty(directionProperty)) {
        throw new ShpurdpException(String.format("%s is required", UPGRADE_DIRECTION));
      }
  ...
  public UpgradeContext(@Assisted Cluster cluster, @Assisted UpgradeEntity upgradeEntity,
      ShpurdpMetaInfo shpurdpMetaInfo, ConfigHelper configHelper) {
    m_metaInfo = shpurdpMetaInfo;
    ...
    m_orchestrationOptions = getOrchestrationOptions(shpurdpMetaInfo, m_upgradePack);
  }
   ...
   * it will throw an {@link ShpurdpException}.
   *
  ...
  private Set<String> getServicesForUpgrade(Cluster cluster,
      RepositoryVersionEntity repositoryVersion) throws ShpurdpException {
  ...
  private abstract class UpgradeRequestValidator {
    ...
    final void validate(Cluster cluster, Direction direction, UpgradeType type,
        UpgradePack upgradePack, Map<String, Object> requestMap) throws ShpurdpException {
  ...
  private final class PreReqCheckValidator extends UpgradeRequestValidator {
    ...
    void check(Cluster cluster, Direction direction, UpgradeType type, UpgradePack upgradePack,
        Map<String, Object> requestMap) throws ShpurdpException {
   ...
   *
   * @param metaInfo
   *          the shpurdp meta-info used to load custom classes
   * @param pack
   *          the upgrade pack
   * @return
   *          the orchestration options instance.  Can return {@code null}.
   */
  private OrchestrationOptions getOrchestrationOptions(ShpurdpMetaInfo metaInfo, UpgradePack pack) {
