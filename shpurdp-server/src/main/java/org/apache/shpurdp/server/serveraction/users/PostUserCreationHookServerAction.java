...
package org.apache.shpurdp.server.serveraction.users;
...
import org.apache.shpurdp.server.hooks.users.UserHookParams;
...
public class PostUserCreationHookServerAction extends AbstractServerAction {
  ...
  public CommandReport execute(ConcurrentMap<String, Object> requestSharedDataContext) throws ShpurdpException, InterruptedException {
    ...
    try {
      ...
      throw new ShpurdpException("Server action execution failed to complete!", e);
    }
