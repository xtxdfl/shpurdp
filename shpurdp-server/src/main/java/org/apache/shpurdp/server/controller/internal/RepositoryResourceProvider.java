...
import org.apache.shpurdp.server.controller.RepositoryRequest;
...
public class RepositoryResourceProvider extends AbstractControllerResourceProvider {
  ...
  public RepositoryResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<RepositoryResponse> responses = getResources(new Command<Set<RepositoryResponse>>() {
      @Override
      public Set<RepositoryResponse> invoke() throws ShpurdpException {
