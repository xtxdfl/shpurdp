 ...
 */
package org.apache.shpurdp.server.mpack;
...
import org.apache.shpurdp.server.orm.dao.MpackDAO;
...
public class MpackManager {
  ...
  /**
   * Parses mpackdirectories during boostrap/shpurdp-server restart
   * Reads from /var/lib/shpurdp-server/mpacks-v2/
   *
   * @throws IOException
   */
   ...
   * It is extracted into /var/lib/shpurdp-server/resources/mpack-v2/{mpack-name}/{mpack-version} directory
   *
