...
import org.apache.shpurdp.server.controller.utilities.UsedIdentities.ComponentExclude;
import org.apache.shpurdp.server.controller.utilities.UsedIdentities.ServiceExclude;
...
public class RemovableIdentities {
   ...
   */
  public static RemovableIdentities ofService(Cluster cluster, ServiceRemovedEvent event, KerberosHelper kerberosHelper) throws ShpurdpException {
   ...
   */
  public static RemovableIdentities ofComponent(Cluster cluster, ServiceComponentUninstalledEvent event, KerberosHelper kerberosHelper) throws ShpurdpException {
    if (cluster.getSecurityType() != SecurityType.KERBEROS) {
      return RemovableIdentities.none();
    }
    KerberosServiceDescriptor serviceDescriptor = kerberosHelper.getKerberosDescriptor(cluster, false).getService(event.getServiceName());
   ...
   */
  public static RemovableIdentities none() throws ShpurdpException {
  ...
  private static List<KerberosIdentityDescriptor> componentIdentities(List<String> componentNames, KerberosServiceDescriptor serviceDescriptor) throws ShpurdpException {
   ...
   */
  public void remove(KerberosHelper kerberosHelper) throws ShpurdpException, KerberosOperationException {
  ...
  private List<KerberosIdentityDescriptor> skipUsed() throws ShpurdpException {
