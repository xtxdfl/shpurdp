...
public class ShpurdpInternalAuthenticationProvider implements AuthenticationProvider {

  private final InternalTokenStorage internalTokenStorage;

  @Inject
  public ShpurdpInternalAuthenticationProvider(InternalTokenStorage internalTokenStorage) {
