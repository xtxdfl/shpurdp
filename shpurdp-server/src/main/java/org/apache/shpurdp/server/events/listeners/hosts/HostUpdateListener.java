 ...
 */
package org.apache.shpurdp.server.events.listeners.hosts;
...
import org.apache.shpurdp.server.events.HostUpdateEvent;
...
import org.apache.shpurdp.server.orm.dao.AlertSummaryDTO;
...
public class HostUpdateListener {
  ...
  @Inject
  public HostUpdateListener(ShpurdpEventPublisher shpurdpEventPublisher, AlertEventPublisher m_alertEventPublisher) {
    shpurdpEventPublisher.register(this);
    m_alertEventPublisher.register(this);
  }

  @Subscribe
  public void onHostStatusUpdate(HostStatusUpdateEvent event) throws ShpurdpException {
  ...
  @Subscribe
  public void onHostStateUpdate(HostStateUpdateEvent event) throws ShpurdpException {
    String hostName = event.getHostName();
    Long lastHeartbeatTime = m_clusters.get().getHost(hostName).getLastHeartbeatTime();
  ...
  @Subscribe
  public void onAlertsHostUpdate(AlertEvent event) throws ShpurdpException {
    String hostName;
  ...
  @Subscribe
  public void onMaintenanceStateUpdate(MaintenanceModeEvent event) throws ShpurdpException {
    Long clusterId = event.getClusterId();
  ...
  private HostUpdateEvent retrieveHostUpdateFromCache(Long clusterId, String hostName) throws ShpurdpException {
  ...
  private HostUpdateEvent createHostUpdateEvent(Long clusterId, String hostName) throws ShpurdpException {
