...
@Singleton
public class ShpurdpManagementHelper {

  private final static Logger LOG =
      LoggerFactory.getLogger(ShpurdpManagementHelper.class);
  ...
  @Inject
  public ShpurdpManagementHelper(StackDAO stackDAO, ExtensionDAO extensionDAO, ExtensionLinkDAO linkDAO) {
   ...
   */
  public void createExtensionLink(StackManager stackManager, StackInfo stackInfo, ExtensionInfo extensionInfo) throws ShpurdpException {
    ...
    try {
      ...
      throw new ShpurdpException(errorMessage, e);
    }
  }
   ...
   * the extension version.
   */
  public void createExtensionLinks(StackManager stackManager, List<ExtensionInfo> extensions) throws ShpurdpException {
   ...
   */
  private void validateCreateExtensionLinkRequest(StackInfo stackInfo, ExtensionInfo extensionInfo) throws ShpurdpException {
    if (stackInfo == null) {
    ...
    if (entity != null) {
      throw new ShpurdpException("The stack and extension are already linked"
                + ", stackName=" + stackInfo.getName()
                + ", stackVersion=" + stackInfo.getVersion()
                + ", extensionName=" + extensionInfo.getName()
                + ", extensionVersion=" + extensionInfo.getVersion());
  ...
  public void updateExtensionLink(StackManager stackManager, ExtensionLinkEntity linkEntity, StackInfo stackInfo,
                                  ExtensionInfo oldExtensionInfo, ExtensionInfo newExtensionInfo) throws ShpurdpException {
  ...
  private ExtensionLinkEntity createExtensionLinkEntity(StackInfo stackInfo, ExtensionInfo extensionInfo) throws ShpurdpException {
