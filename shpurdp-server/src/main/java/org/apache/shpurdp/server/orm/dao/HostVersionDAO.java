...
/**
 * The {@link org.apache.shpurdp.server.orm.dao.HostVersionDAO} class manages the {@link org.apache.shpurdp.server.orm.entities.HostVersionEntity}
 * instances associated with a host. Each host can have multiple stack versions in {@link org.apache.shpurdp.server.state.RepositoryVersionState#INSTALLED}
 * which are installed, exactly one stack version that is either {@link org.apache.shpurdp.server.state.RepositoryVersionState#CURRENT} or
 * {@link org.apache.shpurdp.server.state.RepositoryVersionState#INSTALLING}.
 */
@Singleton
