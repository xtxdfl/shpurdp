...
import org.apache.shpurdp.spi.exceptions.UpgradeActionException;
import org.apache.shpurdp.spi.upgrade.UpgradeAction;
import org.apache.shpurdp.spi.upgrade.UpgradeActionOperations;
import org.apache.shpurdp.spi.upgrade.UpgradeActionOperations.ChangeType;
import org.apache.shpurdp.spi.upgrade.UpgradeActionOperations.ConfigurationChanges;
import org.apache.shpurdp.spi.upgrade.UpgradeActionOperations.PropertyChange;
...
public class PluginUpgradeServerAction extends AbstractUpgradeServerAction {
   ...
   */
  private String getActionClassName() throws ShpurdpException {
    String wrappedClassName = getCommandParameterValue(ServerAction.WRAPPED_CLASS_NAME);
    if (null == wrappedClassName) {
      throw new ShpurdpException("The name of the upgrade action class to execute was not found.");
    }
