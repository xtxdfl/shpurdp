 ...
 * <p/>
 * This data matches the <code>roleauthorization</code> table in the Shpurdp database. The value field
 * of each item represents the <code>roleauthorization.authorization_id</code> value.
 */
public enum RoleAuthorization {
  SHPURDP_ADD_DELETE_CLUSTERS("SHPURDP.ADD_DELETE_CLUSTERS"),
  SHPURDP_ASSIGN_ROLES("SHPURDP.ASSIGN_ROLES"),
  SHPURDP_EDIT_STACK_REPOS("SHPURDP.EDIT_STACK_REPOS"),
  SHPURDP_MANAGE_SETTINGS("SHPURDP.MANAGE_SETTINGS"),
  SHPURDP_MANAGE_GROUPS("SHPURDP.MANAGE_GROUPS"),
  SHPURDP_MANAGE_STACK_VERSIONS("SHPURDP.MANAGE_STACK_VERSIONS"),
  SHPURDP_MANAGE_USERS("SHPURDP.MANAGE_USERS"),
  SHPURDP_MANAGE_VIEWS("SHPURDP.MANAGE_VIEWS"),
  SHPURDP_RENAME_CLUSTER("SHPURDP.RENAME_CLUSTER"),
  SHPURDP_RUN_CUSTOM_COMMAND("SHPURDP.RUN_CUSTOM_COMMAND"),
  SHPURDP_MANAGE_CONFIGURATION("SHPURDP.MANAGE_CONFIGURATION"),
  SHPURDP_VIEW_STATUS_INFO("SHPURDP.VIEW_STATUS_INFO"),
   ...
   * <p/>
   * This value represents the <code>roleauthorization.authorization_id</code> value from the Shpurdp database
   *
   * @return an string
   */
  public String getId() {
