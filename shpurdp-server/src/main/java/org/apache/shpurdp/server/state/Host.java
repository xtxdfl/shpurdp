...
public interface Host extends Comparable {
  ...
  /**
   * Last time the host registered with the Shpurdp Server
   * ( Unix timestamp )
  ...
  /**
   * Time the Shpurdp Agent was started.
   * ( Unix timestamp )
  ...
  /**
   * Last time the Shpurdp Server received a heartbeat from the Host
   * ( Unix timestamp )
  ...
  /**
   * Version of the Shpurdp Agent running on the host
   * @return the agentVersion
   */
  AgentVersion getAgentVersion();

  /**
   * Gets version of the shpurdp agent running on the host.
  ...
  Map<String, HostConfig> getDesiredHostConfigs(Cluster cluster,
      @Nullable Map<String, DesiredConfig> clusterDesiredConfigs) throws ShpurdpException;
   ...
   */
  boolean hasComponentsAdvertisingVersions(StackId stackId) throws ShpurdpException;

  void calculateHostStatus(Long clusterId) throws ShpurdpException;
