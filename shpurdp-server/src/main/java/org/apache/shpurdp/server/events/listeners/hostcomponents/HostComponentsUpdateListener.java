 ...
 */
package org.apache.shpurdp.server.events.listeners.hostcomponents;
...
public class HostComponentsUpdateListener {
  ...
  @Inject
  public HostComponentsUpdateListener(ShpurdpEventPublisher shpurdpEventPublisher,
  ...
  @Subscribe
  public void onStaleConfigsStateUpdate(StaleConfigsUpdateEvent staleConfigsUpdateEvent) throws ShpurdpException {
