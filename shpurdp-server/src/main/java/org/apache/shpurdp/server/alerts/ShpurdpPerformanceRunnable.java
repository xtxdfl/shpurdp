 ...
 */
package org.apache.shpurdp.server.alerts;
...
import org.apache.shpurdp.server.actionmanager.RequestStatus;
import org.apache.shpurdp.server.api.query.Query;
import org.apache.shpurdp.server.api.query.QueryImpl;
...
import org.apache.shpurdp.server.state.alert.ParameterizedSource.AlertParameter;
import org.apache.shpurdp.server.state.alert.ServerSource;
import org.apache.shpurdp.server.state.services.ShpurdpServerAlertService;
...
/**
 * The {@link ShpurdpPerformanceRunnable} is used by the
 * {@link ShpurdpServerAlertService} to ensure that certain areas of Shpurdp are
 ...
 * <ul>
 */
public class ShpurdpPerformanceRunnable extends AlertRunnable {

  /**
   * Logger.
   */
  private final static Logger LOG = LoggerFactory.getLogger(ShpurdpPerformanceRunnable.class);
   ...
   */
   enum PerformanceArea {
    ...
    REQUEST_BY_STATUS("Database Access (Request By Status)",
       ...
       */
      @Override
      void execute(ShpurdpPerformanceRunnable runnable, Cluster cluster) throws Exception {
     ...
     */
    abstract void execute(ShpurdpPerformanceRunnable runnable, Cluster cluster) throws Exception;
  }
   ...
   */
  public ShpurdpPerformanceRunnable(String definitionName) {
   ...
   */
  @Override
  List<Alert> execute(Cluster cluster, AlertDefinitionEntity entity) throws ShpurdpException {
