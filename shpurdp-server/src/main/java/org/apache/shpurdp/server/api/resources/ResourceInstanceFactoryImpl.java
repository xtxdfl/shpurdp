...
import org.apache.shpurdp.server.controller.internal.ClusterKerberosDescriptorResourceProvider;
...
public class ResourceInstanceFactoryImpl implements ResourceInstanceFactory {
  ...
  public static ResourceDefinition getResourceDefinition(Resource.Type type, Map<Resource.Type, String> mapIds) {
    ...
    switch (type.getInternalType()) {
      ...
      case ShpurdpPrivilege:
        resourceDefinition = new PrivilegeResourceDefinition(Resource.Type.ShpurdpPrivilege);
        break;
