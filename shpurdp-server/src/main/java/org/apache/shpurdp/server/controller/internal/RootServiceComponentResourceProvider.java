...
import org.apache.shpurdp.server.controller.RootServiceComponentRequest;
...
public class RootServiceComponentResourceProvider extends ReadOnlyResourceProvider {
  ...
  protected RootServiceComponentResourceProvider(ShpurdpManagementController managementController) {
  ...
  public Set<Resource> getResources(Request request, Predicate predicate)
    ...
    Set<RootServiceComponentResponse> responses = getResources(new Command<Set<RootServiceComponentResponse>>() {
      @Override
      public Set<RootServiceComponentResponse> invoke() throws ShpurdpException {
    ...
    for (RootServiceComponentResponse response : responses) {
      ...
      if (RootComponent.SHPURDP_SERVER.name().equals(response.getComponentName())) {
