...
public class MetadataUpdateEvent extends STOMPEvent implements Hashable {
   ...
   */
  private static final String SHPURDP_LEVEL_CLUSTER_ID = "-1";
  ...
  public MetadataUpdateEvent(SortedMap<String, MetadataCluster> metadataClusters,
                             SortedMap<String, String> shpurdpLevelParams,
                             SortedMap<String, SortedMap<String, String>> metadataAgentConfigs,
                             UpdateEventType eventType) {
    super(Type.METADATA);
    this.metadataClusters = metadataClusters;
    if (shpurdpLevelParams != null) {
      this.metadataClusters.put(SHPURDP_LEVEL_CLUSTER_ID, new MetadataCluster(null, null, false, shpurdpLevelParams, metadataAgentConfigs));
    }
