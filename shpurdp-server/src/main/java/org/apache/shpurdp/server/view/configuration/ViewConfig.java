...
public class ViewConfig {
  ...
  /**
   * The minimum Shpurdp version.
   */
  @XmlElement(name="min-shpurdp-version")
  private String minShpurdpVersion;

  /**
   * The maximum Shpurdp version.
   */
  @XmlElement(name="max-shpurdp-version")
  private String maxShpurdpVersion;
  ...
  /**
   * Get the minimum version of Shpurdp required to run this view.
   *
   * @return the minimum Shpurdp version
   */
  ...
  /**
   * Get the maximum version of Shpurdp that can run this view.
   *
   * @return the maximum Shpurdp version
   */
