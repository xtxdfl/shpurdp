...
import static org.apache.shpurdp.server.configuration.ShpurdpServerConfigurationKey.SSO_AUTHENTICATION_ENABLED;
import static org.apache.shpurdp.server.configuration.ShpurdpServerConfigurationKey.SSO_JWT_AUDIENCES;
import static org.apache.shpurdp.server.configuration.ShpurdpServerConfigurationKey.SSO_JWT_COOKIE_NAME;
import static org.apache.shpurdp.server.configuration.ShpurdpServerConfigurationKey.SSO_PROVIDER_CERTIFICATE;
import static org.apache.shpurdp.server.configuration.ShpurdpServerConfigurationKey.SSO_PROVIDER_ORIGINAL_URL_PARAM_NAME;
import static org.apache.shpurdp.server.configuration.ShpurdpServerConfigurationKey.SSO_PROVIDER_URL;
...
import org.apache.shpurdp.server.security.encryption.CertificateUtils;
 ...
 */
public class JwtAuthenticationProperties extends ShpurdpServerConfiguration {
  ...
  protected ShpurdpServerConfigurationCategory getCategory() {
    return ShpurdpServerConfigurationCategory.SSO_CONFIGURATION;
  }
  ...
  public boolean isEnabledForShpurdp() {
