...
public interface LdapAttributeDetectionService {
   ...
   *
   * @param shpurdpLdapConfiguration configuration instance holding connection details
   * @return the configuration decorated with user related attributes
   */
  ShpurdpLdapConfiguration detectLdapUserAttributes(ShpurdpLdapConfiguration shpurdpLdapConfiguration) throws ShpurdpLdapException;
   ...
   */
  ShpurdpLdapConfiguration detectLdapGroupAttributes(ShpurdpLdapConfiguration shpurdpLdapConfiguration) throws ShpurdpLdapException;
}
