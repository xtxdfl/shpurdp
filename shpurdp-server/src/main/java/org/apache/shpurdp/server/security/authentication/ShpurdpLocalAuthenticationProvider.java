 ...
 */
public class ShpurdpLocalAuthenticationProvider extends ShpurdpAuthenticationProvider {
  private static final Logger LOG = LoggerFactory.getLogger(ShpurdpLocalAuthenticationProvider.class);

  private PasswordEncoder passwordEncoder;

  @Inject
  public ShpurdpLocalAuthenticationProvider(Users users, PasswordEncoder passwordEncoder, Configuration configuration) {
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    ...
    if (authenticationEntity != null) {
      ...
      if (passwordEncoder.matches(presentedPassword, password)) {
        ...
        ShpurdpUserDetails userDetails = new ShpurdpUserDetailsImpl(users.getUser(userEntity), password, users.getUserAuthorities(userEntity));
