...
public class KerberosServiceDescriptorFactory extends AbstractKerberosDescriptorFactory {
   ...
   * @throws ShpurdpException               if the specified File does not contain valid JSON data
   * @see org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor
   */
   ...
   * @see org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor
   */
  public KerberosServiceDescriptor[] createInstances(String json) throws ShpurdpException {
    try {
   ...
   * @return an array of KerberosServiceDescriptor objects
   * @throws org.apache.shpurdp.server.ShpurdpException if an error occurs while processing the Map
   * @see org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor
   */
  public KerberosServiceDescriptor[] createInstances(Map<String, Object> map) throws ShpurdpException {
    ...
    if (map != null) {
      ...
      if (servicesData == null) {
        throw new ShpurdpException("Missing top-level \"services\" property in service-level Kerberos descriptor data");
        ...
        throw new ShpurdpException(String.format("Unexpected top-level \"services\" type in service-level Kerberos descriptor data: %s",
   ...
   * @see org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor
   */
  public KerberosServiceDescriptor createInstance(Map<String, Object> map, String name) throws ShpurdpException {
   ...
   * @throws ShpurdpException if an error occurs while parsing the JSON-formatted String
   * @see org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor
   */
  public KerberosServiceDescriptor createInstance(String name, String json) throws ShpurdpException {
   ...
   * @see org.apache.shpurdp.server.state.kerberos.KerberosServiceDescriptor
   */
  public KerberosServiceDescriptor createInstance(String name, Map<?, ?> map) throws ShpurdpException {
