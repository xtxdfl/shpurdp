...
import org.apache.shpurdp.server.controller.MpackResponse.MpackResponseWrapper;
import org.apache.shpurdp.server.controller.internal.MpackResourceProvider;
...
public class MpacksService extends BaseService {
  ...
  private static final String MPACK_REQUEST_TYPE = "org.apache.shpurdp.server.api.services.MpackRequestSwagger";
  ...
  @ApiOperation(value = "Returns all mpacks registered with this Shpurdp instance",
  ...
  @POST
  @Produces(MediaType.TEXT_PLAIN)
  @ApiOperation(value = "Registers an mpack with this Shpurdp mpack")
  @ApiImplicitParams({
  ...
  @Path("{id}")
  @Produces(MediaType.TEXT_PLAIN)
  @ApiOperation(value = "Returns information about a specific mpack that is registered with this Shpurdp instance",
