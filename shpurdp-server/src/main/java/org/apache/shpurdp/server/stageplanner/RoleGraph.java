 ...
 */
package org.apache.shpurdp.server.stageplanner;
...
public class RoleGraph {
   ...
   */
  public List<Stage> getStages() throws ShpurdpException {
   ...
   * that can cause Shpurdp enter an infinite loop while building stages.
   ...
   * when Shpurdp supports mpacks, custom services and service level role command order.
   * */
  public void breakCycleGraph() throws ShpurdpException{
