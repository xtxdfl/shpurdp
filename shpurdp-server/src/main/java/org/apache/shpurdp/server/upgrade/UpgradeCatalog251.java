...
/**
 * The {@link UpgradeCatalog251} upgrades Shpurdp from 2.5.0 to 2.5.1.
 */
public class UpgradeCatalog251 extends AbstractUpgradeCatalog {
  ...
  /**
   * Ensure that the updates from Shpurdp 2.4.0 are applied in the event the initial version is
   * Shpurdp 2.5.0, since this Kafka change failed to make it into Shpurdp 2.5.0.
   *
   * If the base version was before Shpurdp 2.5.0, this method should wind up doing nothing.
   * @throws ShpurdpException
   */
  protected void updateKAFKAConfigs() throws ShpurdpException {
