...
public class ShpurdpSendToMethodReturnValueHandler extends SendToMethodReturnValueHandler {
  ...
  public ShpurdpSendToMethodReturnValueHandler(SimpMessageSendingOperations messagingTemplate, boolean annotationRequired) {
  ...
  public String toString() {
    return "ShpurdpSendToMethodReturnValueHandler [annotationRequired=" + annotationRequired + "]";
  }
