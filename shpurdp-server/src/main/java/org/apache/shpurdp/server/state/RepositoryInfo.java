...
import org.apache.shpurdp.server.controller.RepositoryResponse;
...
public class RepositoryInfo {
  ...
  private boolean shpurdpManagedRepositories = true;
  ...
  public String toString() {
    return "[ repoInfo: "
        ...
        + ", unique=" + unique
        + ", shpurdpManagedRepositories=" + shpurdpManagedRepositories
  ...
  /**
   * @return true if repositories managed by shpurdp
   */
  public boolean isShpurdpManagedRepositories() {
    return shpurdpManagedRepositories;
  }

  /**
   * @param shpurdpManagedRepositories set is repositories managed by shpurdp
   */
  public void setShpurdpManagedRepositories(boolean shpurdpManagedRepositories) {
    this.shpurdpManagedRepositories = shpurdpManagedRepositories;
  }
