...
public class ShpurdpUserAuthorizationFilter implements Filter {

  private final InternalTokenStorage internalTokenStorage;
  private final Users users;

  @Inject
  public ShpurdpUserAuthorizationFilter(InternalTokenStorage internalTokenStorage, Users users) {
      ...
      if (internalTokenStorage.isValidInternalToken(token)) {
        ...
        if (userToken != null) {
          ...
          if (!userEntity.getActive()) {
            ...
            ShpurdpUserAuthentication authentication = new ShpurdpUserAuthentication(token, userDetails, true);
