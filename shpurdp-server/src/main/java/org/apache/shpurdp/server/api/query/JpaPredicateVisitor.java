...
import org.apache.shpurdp.server.controller.predicate.CategoryPredicate;
import org.apache.shpurdp.server.controller.predicate.ComparisonPredicate;
import org.apache.shpurdp.server.controller.predicate.PredicateVisitor;
import org.apache.shpurdp.server.controller.predicate.UnaryPredicate;
...
/**
 * The {@link JpaPredicateVisitor} is used to convert an Shpurdp
...
public abstract class JpaPredicateVisitor<T> implements PredicateVisitor {
  ...
  /**
   * Gets the {@link SingularAttribute}s mapped to the specified Shpurdp-style
   * property.
   *
   * @param propertyId
   *          the Shpurdp-style property (not {@code null}).
   ...
   * visitor is done traversing the Shpurdp {@link Predicate}.
   *
