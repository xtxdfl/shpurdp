...
/**
 * The {@link org.apache.shpurdp.server.events.listeners.upgrade.HostVersionOutOfSyncListener} class
 * handles {@link org.apache.shpurdp.server.events.ServiceInstalledEvent} and
 * {@link org.apache.shpurdp.server.events.ServiceComponentInstalledEvent}
 * to update {@link org.apache.shpurdp.server.state.RepositoryVersionState}
 */
@Singleton
@EagerSingleton
public class HostVersionOutOfSyncListener {
  ...
  @Inject
  public HostVersionOutOfSyncListener(ShpurdpEventPublisher shpurdpEventPublisher, LockFactory lockFactory) {
  ...
  private RepositoryVersionState checkAllHostComponents(StackId stackId,
      HostEntity host) throws ShpurdpException {
