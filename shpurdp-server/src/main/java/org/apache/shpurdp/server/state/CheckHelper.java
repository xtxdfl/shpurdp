...
import org.apache.shpurdp.server.checks.OrchestrationQualification;
import org.apache.shpurdp.server.checks.UpgradeTypeQualification;
...
import org.apache.shpurdp.spi.upgrade.CheckQualification;
...
public class CheckHelper {
  ...
  @Inject
  protected Provider<ShpurdpMetaInfo> metaInfoProvider;
   ...
   */
  public final VersionDefinitionXml getVersionDefinitionXml(UpgradeCheckRequest request) throws ShpurdpException {
    ...
    try {
      ...
      throw new ShpurdpException("Unable to run upgrade checks because of an invalid VDF",
          exception);
    }
  }
   ...
   */
  public final Set<String> getServicesInUpgrade(UpgradeCheckRequest request) throws ShpurdpException {
  ...
  final class ServiceQualification implements CheckQualification {
     ...
     */
    @Override
    public boolean isApplicable(UpgradeCheckRequest request) throws ShpurdpException {
