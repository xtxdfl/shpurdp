...
import org.apache.shpurdp.server.security.credential.GenericKeyCredential;
...
public class CredentialProvider {
  ...
  public CredentialProvider(String masterKey, Configuration configuration) throws ShpurdpException {
    ...
    if (!masterKeyService.isMasterKeyInitialized()) {
      throw new ShpurdpException("Master key initialization failed.");
    }
  ...
  public char[] getPasswordForAlias(String alias) throws ShpurdpException {
  ...
  public void generateAliasWithPassword(String alias) throws ShpurdpException {
