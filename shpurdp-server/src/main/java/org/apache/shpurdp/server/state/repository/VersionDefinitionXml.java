...
import org.apache.shpurdp.server.state.repository.AvailableVersion.Component;
import org.apache.shpurdp.server.state.repository.StackPackage.UpgradeDependencies;
import org.apache.shpurdp.server.state.repository.StackPackage.UpgradeDependencyDeserializer;
import org.apache.shpurdp.server.state.stack.RepositoryXml;
import org.apache.shpurdp.server.state.stack.RepositoryXml.Os;
import org.apache.shpurdp.spi.RepositoryType;
import org.apache.shpurdp.spi.stack.StackReleaseInfo;
import org.apache.shpurdp.spi.stack.StackReleaseVersion;
...
public class VersionDefinitionXml {
   ...
   */
  public ClusterVersionSummary getClusterSummary(Cluster cluster, ShpurdpMetaInfo metaInfo)
      throws ShpurdpException {
   ...
   * @throws ShpurdpException
   */
  public Set<String> getMissingDependencies(Cluster cluster, ShpurdpMetaInfo metaInfo)
      throws ShpurdpException {
  ...
  /**
   * Used to facilitate merging when multiple version definitions are provided.  Shpurdp
