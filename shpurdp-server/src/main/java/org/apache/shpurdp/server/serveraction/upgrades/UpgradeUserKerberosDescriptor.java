 ...
 *
 * @see org.apache.shpurdp.server.state.kerberos.KerberosDescriptorUpdateHelper
 */
    ...
    if (userDescriptor != null) {
      ...
      if (upgradeContext.getDirection() == Direction.DOWNGRADE) {
        ...
        if (targetStackId == null) {
          ...
          newDescriptor = shpurdpMetaInfo.getKerberosDescriptor(targetStackId.getStackName(), targetStackId.getStackVersion(), false);
        ...
        if (originalStackId == null) {
          ...
          previousDescriptor = shpurdpMetaInfo.getKerberosDescriptor(originalStackId.getStackName(), originalStackId.getStackVersion(), false);
