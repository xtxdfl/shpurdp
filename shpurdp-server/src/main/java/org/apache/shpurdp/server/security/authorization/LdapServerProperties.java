...
public class LdapServerProperties {
   ...
   *                                  User Principal Name format to filter users constructed from {@link org.apache.shpurdp.server.configuration.Configuration#LDAP_ALT_USER_SEARCH_FILTER}.
   *                                  Otherwise the filter is constructed from {@link org.apache.shpurdp.server.configuration.Configuration#LDAP_USER_SEARCH_FILTER}
