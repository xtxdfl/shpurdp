...
import org.apache.shpurdp.server.api.services.stackadvisor.validations.ValidationResponse.ValidationItem;
...
public class ValidationResourceProvider extends StackAdvisorResourceProvider {
  ...
  protected ValidationResourceProvider(ShpurdpManagementController managementController) {
