...
public class PermissionDAO {
  ...
  /**
   * Find SHPURDP.ADMINISTRATOR permission.
   *
   * @return a matching permission entity or null
   */
  @RequiresSession
  public PermissionEntity findShpurdpAdminPermission() {
    return findById(PermissionEntity.SHPURDP_ADMINISTRATOR_PERMISSION);
  }
