...
import org.apache.shpurdp.server.serveraction.kerberos.DeconstructedPrincipal;
...
/**
 * The {@link org.apache.shpurdp.server.upgrade.UpgradeCatalog252} upgrades Shpurdp from 2.5.1 to 2.5.2.
 */
public class UpgradeCatalog252 extends AbstractUpgradeCatalog {
   ...
   */
  private void resetStackToolsAndFeatures() throws ShpurdpException {
   ...
   * kerberos.json files.  In Shpurdp 2.5.2, the logic to set <code>livy.superusers</code> has been
   ...
   */
  void fixLivySuperusers() throws ShpurdpException {
    Clusters clusters = injector.getInstance(Clusters.class);
    if (clusters != null) {
      Map<String, Cluster> clusterMap = clusters.getClusters();
