...
public class ViewSubResourceProvider extends AbstractResourceProvider {
  ...
  public RequestStatus createResources(Request request)
    ...
    for (Map<String, Object> propertyMap : properties) {
      ...
      } catch (org.apache.shpurdp.view.NoSuchResourceException e) {
        throw new NoSuchParentResourceException(e.getMessage(), e);
      } catch (org.apache.shpurdp.view.UnsupportedPropertyException e) {
        throw new UnsupportedPropertyException(getResourceType(e), e.getPropertyIds());
      } catch (org.apache.shpurdp.view.ResourceAlreadyExistsException e) {
  ...
  private org.apache.shpurdp.view.ResourceProvider<?> getResourceProvider(String instanceName) {
  ...
  private Resource.Type getResourceType(org.apache.shpurdp.view.UnsupportedPropertyException e) {
   ...
   * as a bridge from the shpurdp-server API framework request to the
  ...
  private static class ViewReadRequest implements ReadRequest {
    ...
    public TemporalInfo getTemporalInfo(String id) {
      ...
      org.apache.shpurdp.server.controller.spi.TemporalInfo temporalInfo =
   ...
   * bridge from the shpurdp-server API framework temporal info object to the
  ...
  private static class ViewReadRequestTemporalInfo implements ReadRequest.TemporalInfo {
     ...
     */
    private final org.apache.shpurdp.server.controller.spi.TemporalInfo temporalInfo;
