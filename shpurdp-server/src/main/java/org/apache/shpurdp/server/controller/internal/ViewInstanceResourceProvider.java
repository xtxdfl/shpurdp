...
public class ViewInstanceResourceProvider extends AbstractAuthorizedResourceProvider {
  ...
  public ViewInstanceResourceProvider() {
    ...
    EnumSet<RoleAuthorization> requiredAuthorizations = EnumSet.of(RoleAuthorization.SHPURDP_MANAGE_VIEWS);
  ...
  private ViewInstanceEntity toEntity(Map<String, Object> properties, boolean update) throws ShpurdpException {
    ...
    if (!instanceProperties.isEmpty()) {
      ...
      } catch (org.apache.shpurdp.view.SystemException e) {
        throw new ShpurdpException("Caught exception trying to set view properties.", e);
      }
    }
  ...
  @Transactional
  void create(Map<String, Object> properties) throws ShpurdpException {
    try {
      ViewRegistry       viewRegistry   = ViewRegistry.getInstance();
      ...
      throw new ShpurdpException("Caught exception trying to create view instance.", e);
  ...
  @Transactional
  void update(Map<String, Object> properties) throws ShpurdpException {
    ...
    if (includeInstance(view.getCommonName(), view.getVersion(), instance.getInstanceName(), false)) {
      try {
        ...
        throw new ShpurdpException("Caught exception trying to update view instance.", e);
      } catch (ValidationException e) {
        // results in a BAD_REQUEST (400) response for the validation failure.
        throw new IllegalArgumentException(e.getMessage(), e);
      }
