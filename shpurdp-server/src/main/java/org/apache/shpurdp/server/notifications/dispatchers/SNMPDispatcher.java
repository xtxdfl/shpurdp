...
public class SNMPDispatcher implements NotificationDispatcher {
  ...
  public static final String BODY_OID_PROPERTY = "shpurdp.dispatch.snmp.oids.body";
  public static final String SUBJECT_OID_PROPERTY = "shpurdp.dispatch.snmp.oids.subject";
  public static final String TRAP_OID_PROPERTY = "shpurdp.dispatch.snmp.oids.trap";

  // SNMP Server port
  public static final String PORT_PROPERTY = "shpurdp.dispatch.snmp.port";

  // SNMP version
  public static final String SNMP_VERSION_PROPERTY = "shpurdp.dispatch.snmp.version";

  // Properties for community-based security model configuration
  public static final String COMMUNITY_PROPERTY = "shpurdp.dispatch.snmp.community";

  // Properties for user-based security model configuration
  public static final String SECURITY_USERNAME_PROPERTY = "shpurdp.dispatch.snmp.security.username";
  public static final String SECURITY_AUTH_PASSPHRASE_PROPERTY = "shpurdp.dispatch.snmp.security.auth.passphrase";
  public static final String SECURITY_PRIV_PASSPHRASE_PROPERTY = "shpurdp.dispatch.snmp.security.priv.passphrase";
  public static final String SECURITY_LEVEL_PROPERTY = "shpurdp.dispatch.snmp.security.level";
  ...
  /**
   * Returns {@link SnmpVersion} instance corresponding to dispatch property <code>shpurdp.dispatch.snmp.version</code> from dispatch properties.
   * @param dispatchProperties dispatch properties
  ...
  /**
   * Returns {@link TrapSecurity} instance corresponding to dispatch property <code>shpurdp.dispatch.snmp.security.level</code> from dispatch properties.
   * @param dispatchProperties dispatch properties
