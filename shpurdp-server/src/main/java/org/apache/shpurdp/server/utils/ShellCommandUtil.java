...
public class ShellCommandUtil {
  ...
  private static final String SHPURDP_SUDO = "shpurdp-sudo.sh";
  ...
  */
   ...
   * @param sudo true to execute the command using sudo (shpurdp-sudo); otherwise false
