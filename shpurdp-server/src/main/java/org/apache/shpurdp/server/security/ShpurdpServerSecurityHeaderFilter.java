...
/**
 * ShpurdpServerSecurityHeaderFilter adds security-related headers to HTTP response messages for Shpurdp Server UI
 */
@Singleton
public class ShpurdpServerSecurityHeaderFilter extends AbstractSecurityHeaderFilter {
