...
public class ServiceComponentSupport {
  private final Provider<ShpurdpMetaInfo> metaInfo;

  @Inject
  public ServiceComponentSupport(Provider<ShpurdpMetaInfo> metaInfo) {
   ...
   */
  public Set<ServiceComponent> unsupportedComponents(Cluster cluster, String stackName, String stackVersion) throws ShpurdpException {
  ...
  private boolean isComponentSupported(String serviceName, String componentName, String stackName, String stackVersion) throws ShpurdpException {
    try {
   ...
   */
  public Collection<String> allUnsupported(Cluster cluster, String stackName, String stackVersion) throws ShpurdpException {
    return union(
