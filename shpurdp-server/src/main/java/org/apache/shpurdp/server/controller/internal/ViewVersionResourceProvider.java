...
import org.apache.shpurdp.server.controller.ViewVersionResponse;
...
public class ViewVersionResourceProvider extends AbstractResourceProvider {
  ...
  public static final String MIN_SHPURDP_VERSION_PROPERTY_ID = "min_shpurdp_version";
  public static final String MAX_SHPURDP_VERSION_PROPERTY_ID = "max_shpurdp_version";
  ...
  public static final String MIN_SHPURDP_VERSION = VIEW_VERSION_INFO + PropertyHelper.EXTERNAL_PATH_SEP + MIN_SHPURDP_VERSION_PROPERTY_ID;
  public static final String MAX_SHPURDP_VERSION = VIEW_VERSION_INFO + PropertyHelper.EXTERNAL_PATH_SEP + MAX_SHPURDP_VERSION_PROPERTY_ID;
      ...
      for (ViewEntity viewDefinition : viewRegistry.getDefinitions()){
        if (viewName == null || viewName.equals(viewDefinition.getCommonName())) {
          if (viewVersion == null || viewVersion.equals(viewDefinition.getVersion())) {
            ...
            setResourceProperty(resource, MIN_SHPURDP_VERSION,
              viewVersionInfo.getMinShpurdpVersion(), requestedIds);
            setResourceProperty(resource, MAX_SHPURDP_VERSION,
              viewVersionInfo.getMaxShpurdpVersion(), requestedIds);
  ...
  public ViewVersionResponse getResponse(ViewEntity viewDefinition) {
    ...
    String maxShpurdpVersion = viewDefinition.getConfiguration().getMaxShpurdpVersion();
    String minShpurdpVersion = viewDefinition.getConfiguration().getMinShpurdpVersion();
    ...
    ViewVersionResponse.ViewVersionInfo viewVersionInfo = new ViewVersionResponse.ViewVersionInfo(archive, buildNumber,
      clusterConfigurable, description, label, maskerClass, maxShpurdpVersion, minShpurdpVersion, parameters, status,
