...
from shpurdp_server.serverConfiguration import get_shpurdp_properties, get_stack_location
...
def enable_stack_version(stack_name, stack_versions):
  if not is_root():
    err = "Shpurdp-server enable-stack should be run with " "root-level privileges"
