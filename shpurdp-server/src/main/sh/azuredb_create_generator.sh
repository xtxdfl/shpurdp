...
[[ -e "$sql_dir"/Shpurdp-DDL-SQLServer-CREATE.sql ]] || exit 1
[[ -x "$script_dir"/azuredb_create_generator.py ]] || exit 2

cat "$sql_dir"/Shpurdp-DDL-SQLServer-CREATE.sql | "$script_dir"/azuredb_create_generator.py > "$sql_dir"/Shpurdp-DDL-AzureDB-CREATE.sql
