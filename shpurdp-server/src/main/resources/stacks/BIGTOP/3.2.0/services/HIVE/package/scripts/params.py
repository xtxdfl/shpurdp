...
from shpurdp_commons.credential_store_helper import get_password_from_credential_store
...
agent_stack_retry_on_unavailability = config["shpurdpLevelParams"][
  "agent_stack_retry_on_unavailability"
]
agent_stack_retry_count = expect("/shpurdpLevelParams/agent_stack_retry_count", int)
...
hive_db_schma_name = config["configurations"]["hive-site"]["shpurdp.hive.db.schema.name"]
