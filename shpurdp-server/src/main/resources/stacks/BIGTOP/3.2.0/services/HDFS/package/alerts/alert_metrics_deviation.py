...
from shpurdp_commons.aggregate_functions import sample_standard_deviation, mean
...
from shpurdp_commons.shpurdp_metrics_helper import select_metric_collector_for_sink
...
def execute(configurations={}, parameters={}, host_name=None):
  ...
  try:
    ...
    return (
      RESULT_STATE_UNKNOWN,
      ["Unable to retrieve metrics from the Shpurdp Metrics service."],
    )
...
def _get_ssl_version():
  return ShpurdpConfig.get_resolved_config().get_force_https_protocol_value()
