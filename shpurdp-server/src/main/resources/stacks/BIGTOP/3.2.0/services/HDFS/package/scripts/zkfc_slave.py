...
class ZkfcSlaveDefault(ZkfcSlave):
  ...
  def start_static(env, upgrade_type=None):
    ...
    # The Shpurdp UI HA Wizard prompts the user to run this command
  ...
  def disable_security(self, env):
    ...
    zkmigrator.set_acls(
      params.zk_namespace
      if params.zk_namespace.startswith("/")
      else "/" + params.zk_namespace,
      "world:anyone:crdwa",
    )
  ...
  def pre_upgrade_restart(self, env, upgrade_type=None):
    ...
    if check_stack_feature(
      StackFeature.ZKFC_VERSION_ADVERTISED, params.version_for_stack_feature_checks
    ):
