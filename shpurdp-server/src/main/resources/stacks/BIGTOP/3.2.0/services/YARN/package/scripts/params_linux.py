...
nm_log_dir_to_mount_file = "/var/lib/shpurdp-agent/data/yarn/yarn_log_dir_mount.hist"
nm_local_dir_to_mount_file = "/var/lib/shpurdp-agent/data/yarn/yarn_local_dir_mount.hist"
...
if enable_ranger_yarn and is_supported_yarn_ranger:
  ...
  if stack_supports_ranger_kerberos:
    ranger_plugin_config["shpurdp.service.check.user"] = policy_user
