...
retVal=`/var/lib/shpurdp-agent/shpurdp-sudo.sh su ${smoke_test_user} -s /bin/bash - -c "$cmd"`
...
/var/lib/shpurdp-agent/shpurdp-sudo.sh rm -f ${tmp_dir}/show_db.post.txt
echo "user.name=${smoke_test_user}&exec=show databases;" > ${tmp_dir}/show_db.post.txt
/var/lib/shpurdp-agent/shpurdp-sudo.sh chown ${smoke_test_user} ${tmp_dir}/show_db.post.txt
...
/var/lib/shpurdp-agent/shpurdp-sudo.sh rm -f ${tmp_dir}/pig_post.txt
echo -n "user.name=${smoke_test_user}&file=/tmp/$ttonTestScript" > ${tmp_dir}/pig_post.txt
/var/lib/shpurdp-agent/shpurdp-sudo.sh chown ${smoke_test_user} ${tmp_dir}/pig_post.txt
