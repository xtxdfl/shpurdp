...
class ServiceCheck(Script):
  def service_check(self, env):
    ...
    topic = "shpurdp_kafka_service_check"
    create_topic_cmd_created_output = "Created topic shpurdp_kafka_service_check."
    create_topic_cmd_exists_output = (
      "Topic 'shpurdp_kafka_service_check' already exists."
    )
