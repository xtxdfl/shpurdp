...
if has_ranger_admin:
  ...
  shpurdp_ranger_admin = config["configurations"]["ranger-env"]["ranger_admin_username"]
  shpurdp_ranger_password = config["configurations"]["ranger-env"][
...
if has_ranger_admin:
  ...
  if stack_supports_ranger_audit_db:
    if xa_audit_db_flavor == "mysql":
      jdbc_jar = default("/shpurdpLevelParams/custom_mysql_jdbc_name", None)
      ...
      jdbc_jar = default("/shpurdpLevelParams/custom_oracle_jdbc_name", None)
      xa_previous_jdbc_jar_name = default(
        "/shpurdpLevelParams/previous_custom_oracle_jdbc_name", None
      )
      ...
      jdbc_jar = default("/shpurdpLevelParams/custom_postgres_jdbc_name", None)
      xa_previous_jdbc_jar_name = default(
        "/shpurdpLevelParams/previous_custom_postgres_jdbc_name", None
      )
      ...
      jdbc_jar = default("/shpurdpLevelParams/custom_mssql_jdbc_name", None)
      xa_previous_jdbc_jar_name = default(
        "/shpurdpLevelParams/previous_custom_mssql_jdbc_name", None
      )
      ...
      jdbc_jar = default("/shpurdpLevelParams/custom_sqlanywhere_jdbc_name", None)
      xa_previous_jdbc_jar_name = default(
        "/shpurdpLevelParams/previous_custom_sqlanywhere_jdbc_name", None
      )
      audit_jdbc_url = format(
...
jce_name = default("/shpurdpLevelParams/jce_name", None)
