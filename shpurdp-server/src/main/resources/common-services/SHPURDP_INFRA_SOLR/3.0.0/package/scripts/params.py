...
infra_solr_conf = "/etc/shpurdp-infra-solr/conf"
...
shpurdp_java_exec = f"{shpurdp_java_home}/bin/java"
...
solr_cloudmode = "true"
solr_dir = "/usr/lib/shpurdp-infra-solr"
solr_client_dir = "/usr/lib/shpurdp-infra-solr-client"
