...
class InfraSolr(Script):
  ...
  def start(self, env, upgrade_type=None):
    ...
    generate_logfeeder_input_config(
      "shpurdp-infra",
      Template("input.config-shpurdp-infra.json.j2", extra_imports=[default]),
    )
  ...
  def disable_security(self, env):
    ...
    zkmigrator = ZkMigrator(
      ...
      java_exec=params.shpurdp_java_exec,
      java_home=params.shpurdp_java_home,
  ...
  def upgrade_solr_instance(self, env):
    ...
    pkg_provider.remove_package("shpurdp-infra-solr", context, ignore_dependencies=True)
    pkg_provider.upgrade_package("shpurdp-infra-solr", context)
