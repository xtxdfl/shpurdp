...
/*
Schema population script for $(SHPURDPDBNAME)

Use this script in sqlcmd mode, setting the environment variables like this:
set SHPURDPDBNAME=shpurdp

sqlcmd -S localhost\SQLEXPRESS -i C:\app\shpurdp-server-1.3.0-SNAPSHOT\resources\Shpurdp-DDL-SQLServer-CREATE.sql
*/
