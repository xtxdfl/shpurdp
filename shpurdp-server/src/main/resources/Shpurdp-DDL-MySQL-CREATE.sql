...
--
-- DROP DATABASE IF EXISTS `shpurdp`;
-- DROP USER `shpurdp`;

# delimiter ;

# CREATE DATABASE `shpurdp` /*!40100 DEFAULT CHARACTER SET utf8 */;
#
# CREATE USER 'shpurdp' IDENTIFIED BY 'bigdata';
...
CREATE TABLE repo_os (
  ...
  shpurdp_managed TINYINT(1) DEFAULT 1,
...
INSERT INTO adminpermission(permission_id, permission_name, resource_type_id, permission_label, principal_id, sort_order)
  SELECT 1, 'SHPURDP.ADMINISTRATOR', 1, 'Shpurdp Administrator', 7, 1 UNION ALL
...
INSERT INTO roleauthorization(authorization_id, authorization_name)
  ...
  SELECT 'SHPURDP.MANAGE_SETTINGS', 'Manage administrative settings' UNION ALL
