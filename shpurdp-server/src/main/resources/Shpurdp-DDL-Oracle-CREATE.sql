...
CREATE TABLE repo_os (
  ...
  shpurdp_managed NUMBER(1) DEFAULT 1,
...
CREATE TABLE viewinstance (
  ...
  cluster_type VARCHAR(100) DEFAULT 'LOCAL_SHPURDP' NOT NULL,
  short_url NUMBER,
...
CREATE TABLE kerberos_keytab (
  ...
  is_shpurdp_keytab NUMBER(1) DEFAULT 0 NOT NULL,
  write_shpurdp_jaas NUMBER(1) DEFAULT 0 NOT NULL,
...
---------inserting some data-----------
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('kkp_id_seq', 0);
-- In order for the first ID to be 1, must initialize the shpurdp_sequences table with a sequence_value of 0.
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('host_role_command_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('user_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('user_authentication_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('group_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('member_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('cluster_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('host_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('configgroup_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('requestschedule_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('resourcefilter_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('viewentity_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('operation_level_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('view_instance_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('resource_type_id_seq', 4);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('resource_id_seq', 2);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('principal_type_id_seq', 8);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('principal_id_seq', 13);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('permission_id_seq', 7);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('privilege_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('config_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('host_version_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('service_config_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('alert_definition_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('alert_group_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('alert_target_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('alert_history_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('alert_notice_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('alert_current_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('repo_version_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('repo_os_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('repo_definition_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('upgrade_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('upgrade_group_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('upgrade_item_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('stack_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('mpack_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('extension_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('link_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('widget_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('widget_layout_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_host_info_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_host_request_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_host_task_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_logical_request_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_logical_task_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_request_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('topology_host_group_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('setting_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('hostcomponentstate_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('servicecomponentdesiredstate_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('upgrade_history_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('blueprint_setting_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('shpurdp_operation_history_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('remote_cluster_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('remote_cluster_service_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('servicecomponent_version_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('hostcomponentdesiredstate_id_seq', 0);

INSERT INTO metainfo("metainfo_key", "metainfo_value") values ('version', '${shpurdpSchemaVersion}');

insert into adminresourcetype (resource_type_id, resource_type_name)
  select 1, 'SHPURDP' from dual
  union all
...
insert into adminpermission(permission_id, permission_name, resource_type_id, permission_label, principal_id, sort_order)
  select 1, 'SHPURDP.ADMINISTRATOR', 1, 'Shpurdp Administrator', 7, 1 from dual
  union all
...
INSERT INTO roleauthorization(authorization_id, authorization_name)
  ...
  SELECT 'SHPURDP.ADD_DELETE_CLUSTERS', 'Create new clusters' FROM dual UNION ALL
  SELECT 'SHPURDP.RENAME_CLUSTER', 'Rename clusters' FROM dual UNION ALL
  SELECT 'SHPURDP.MANAGE_SETTINGS', 'Manage settings' FROM dual UNION ALL
  SELECT 'SHPURDP.MANAGE_CONFIGURATION', 'Manage shpurdp configuration' FROM dual UNION ALL
  SELECT 'SHPURDP.MANAGE_USERS', 'Manage users' FROM dual UNION ALL
  SELECT 'SHPURDP.MANAGE_GROUPS', 'Manage groups' FROM dual UNION ALL
  SELECT 'SHPURDP.MANAGE_VIEWS', 'Manage Shpurdp Views' FROM dual UNION ALL
  SELECT 'SHPURDP.ASSIGN_ROLES', 'Assign roles' FROM dual UNION ALL
  SELECT 'SHPURDP.MANAGE_STACK_VERSIONS', 'Manage stack versions' FROM dual UNION ALL
  SELECT 'SHPURDP.EDIT_STACK_REPOS', 'Edit stack repository URLs' FROM dual UNION ALL
  SELECT 'SHPURDP.VIEW_STATUS_INFO', 'View status information' FROM dual UNION ALL
  SELECT 'SHPURDP.RUN_CUSTOM_COMMAND', 'Perform custom administrative actions' FROM dual;
...
INSERT INTO permission_roleauthorization(permission_id, authorization_id)
  ...
  SELECT permission_id, 'SERVICE.MANAGE_ALERTS' FROM adminpermission WHERE permission_name='SHPURDP.ADMINISTRATOR' UNION ALL
  ...
  SELECT permission_id, 'CLUSTER.MANAGE_ALERTS' FROM adminpermission WHERE permission_name='SHPURDP.ADMINISTRATOR' UNION ALL
