...
-- BEGIN;
INSERT INTO shpurdp_sequences (sequence_name, sequence_value) VALUES
  ('kkp_id_seq', 0),
  ('cluster_id_seq', 1),
  ('host_id_seq', 0),
  ...
  ('shpurdp_operation_history_id_seq', 0),
...
insert into users(user_id, principal_id, user_name, display_name, local_username, create_time) VALUES
   (1, 1, 'admin', 'Administrator', 'admin', 0);
...
insert into user_authentication(user_authentication_id, user_id, authentication_type, authentication_key, create_time, update_time) VALUES
  (1, 1, 'LOCAL', '538916f8943ec225d97a9a86a2c6ec0818c1cd400e09e03b660fdaaec4af29ddbb6f2b1033b81b00', 0, 0);

insert into adminpermission(permission_id, permission_name, resource_type_id, permission_label, principal_id, sort_order) VALUES
  (1, 'SHPURDP.ADMINISTRATOR', 1, 'Shpurdp Administrator', 7, 1),
...
INSERT INTO roleauthorization(authorization_id, authorization_name) VALUES
  ('VIEW.USE', 'Use View'),
  ...
  ('CLUSTER.MANAGE_WIDGETS', 'Manage widgets'),
  ('SHPURDP.ADD_DELETE_CLUSTERS', 'Create new clusters'),
  ('SHPURDP.RENAME_CLUSTER', 'Rename clusters'),
  ('SHPURDP.MANAGE_SETTINGS', 'Manage administrative settings'),
  ('SHPURDP.MANAGE_CONFIGURATION', 'Manage shpurdp configuration'),
  ('SHPURDP.MANAGE_USERS', 'Manage users'),
  ('SHPURDP.MANAGE_GROUPS', 'Manage groups'),
  ('SHPURDP.MANAGE_VIEWS', 'Manage Shpurdp Views'),
  ('SHPURDP.ASSIGN_ROLES', 'Assign roles'),
  ('SHPURDP.MANAGE_STACK_VERSIONS', 'Manage stack versions'),
  ('SHPURDP.EDIT_STACK_REPOS', 'Edit stack repository URLs'),
  ('SHPURDP.VIEW_STATUS_INFO', 'View status information'),
  ('SHPURDP.RUN_CUSTOM_COMMAND', 'Perform custom administrative actions');
