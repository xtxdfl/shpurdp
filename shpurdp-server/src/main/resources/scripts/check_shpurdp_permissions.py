...
jar_files_to_check = [
  "/var/lib/shpurdp-server/",
  "/usr/lib/shpurdp-server/",
  "/var/lib/shpurdp-agent/",
]

# List of directories. For this list we are only checking permissions for directory.
directories_to_check = [
  "/etc/shpurdp-server/conf",
  "/usr/lib/shpurdp-server",
  "/usr/lib/shpurdp-server/lib/shpurdp_server",
  "/var/lib/shpurdp-server",
  "/usr/lib/shpurdp-agent",
  "/usr/lib/shpurdp-agent/lib/shpurdp_agent",
  "/var/lib/shpurdp-agent/cache",
  "/var/lib/shpurdp-agent/cred",
  "/var/lib/shpurdp-agent/data",
  "/var/lib/shpurdp-agent/tools",
  "/var/lib/shpurdp-agent/lib",
  "/etc/shpurdp-agent/conf",
]
...
files_to_check = [
  "/etc/shpurdp-server/conf/",
  "/etc/init/shpurdp-server.conf",
  "/etc/init.d/shpurdp-server",
  "/usr/lib/shpurdp-server",
  "/usr/lib/shpurdp-server/lib/shpurdp_server",
  "/usr/sbin/shpurdp_server_main.py",
  "/usr/sbin/shpurdp-server.py",
  "/var/lib/shpurdp-server",
  "/usr/lib/shpurdp-agent",
  "/usr/lib/shpurdp-agent/lib/shpurdp_agent",
  "/var/lib/shpurdp-agent",
...
secure_directories_to_check = [
  "/var/lib/shpurdp-server/keys",
  "/var/lib/shpurdp-agent/keys",
]
...
secure_files_to_check = ["/var/lib/shpurdp-server/keys", "/var/lib/shpurdp-agent/keys"]


def main():
  parser = argparse.ArgumentParser(
    description="This script search for shpurdp files with incorrect permissions.",
    epilog="Only for shpurdp!",
  )
  ...
  parser.add_argument(
    ...
    default="/",
    action="store",
    help='Shpurdp server root directory. By default it is "/".',
  )
...
def do_work(args):
  ...
  for path in files_to_check:
    path = os.path.join(args.shpurdp_root_dir, path.lstrip("/"))
    files_with_wrong_permissions = (
      files_with_wrong_permissions
  ...
  print(
    "\n*****Check shpurdp jar file, or files in directory, for valid permissions (without w+x for group and other)*****"
  )
  jar_files_with_wrong_permissions = []
  for jar_path in jar_files_to_check:
    jar_path = os.path.join(args.shpurdp_root_dir, jar_path.lstrip("/"))
  ...
  for dir_path in directories_to_check:
    dir_path = os.path.join(args.shpurdp_root_dir, dir_path.lstrip("/"))
    directories_with_wrong_permissions = (
      directories_with_wrong_permissions
