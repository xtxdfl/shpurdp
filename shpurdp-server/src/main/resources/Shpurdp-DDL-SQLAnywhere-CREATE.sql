...
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('cluster_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('host_id_seq', 0);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('host_role_command_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('user_id_seq', 2);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('user_authentication_id_seq', 2);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('group_id_seq', 1);
INSERT INTO shpurdp_sequences(sequence_name, sequence_value) values ('member_id_seq', 1);
...
insert into adminpermission(permission_id, permission_name, resource_type_id, permission_label, principal_id, sort_order)
  select 1, 'SHPURDP.ADMINISTRATOR', 1, 'Shpurdp Administrator', 7, 1
  union all
  ...
  INSERT INTO roleauthorization(authorization_id, authorization_name)
    ...
    SELECT 'SHPURDP.ADD_DELETE_CLUSTERS', 'Create new clusters' UNION ALL
    SELECT 'SHPURDP.RENAME_CLUSTER', 'Rename clusters' UNION ALL
    SELECT 'SHPURDP.MANAGE_SETTINGS', 'Manage settings' UNION ALL
    SELECT 'SHPURDP.MANAGE_CONFIGURATION', 'Manage shpurdp configuration' UNION ALL
    SELECT 'SHPURDP.MANAGE_USERS', 'Manage users' UNION ALL
    SELECT 'SHPURDP.MANAGE_GROUPS', 'Manage groups' UNION ALL
    SELECT 'SHPURDP.MANAGE_VIEWS', 'Manage Shpurdp Views' UNION ALL
    SELECT 'SHPURDP.ASSIGN_ROLES', 'Assign roles' UNION ALL
    SELECT 'SHPURDP.MANAGE_STACK_VERSIONS', 'Manage stack versions' UNION ALL
    SELECT 'SHPURDP.EDIT_STACK_REPOS', 'Edit stack repository URLs' UNION ALL
    SELECT 'SHPURDP.VIEW_STATUS_INFO', 'View status information' UNION ALL
    SELECT 'SHPURDP.RUN_CUSTOM_COMMAND', 'Perform custom administrative actions';
  ...
  INSERT INTO permission_roleauthorization(permission_id, authorization_id)
    ...
    SELECT permission_id, 'CLUSTER.RUN_SERVICE_CHECK' FROM adminpermission WHERE permission_name='SHPURDP.ADMINISTRATOR' UNION ALL
    ...
    SELECT permission_id, 'SHPURDP.RUN_SERVICE_CHECK' FROM adminpermission WHERE permission_name='SHPURDP.ADMINISTRATOR';
...
insert into metainfo(metainfo_key, metainfo_value)
  select 'version','${shpurdpSchemaVersion}';
