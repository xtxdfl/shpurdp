...
example creates a Jinja2 environment with the i18n extension loaded::
    ...
    jinja_env = Environment(extensions=['shpurdp_jinja2.ext.i18n'])
...
**Import name:** `shpurdp_jinja2.ext.i18n`
...
.. method:: shpurdp_jinja2.Environment.install_gettext_translations(translations, newstyle=False)
...
.. method:: shpurdp_jinja2.Environment.install_null_translations(newstyle=False)
...
.. method:: shpurdp_jinja2.Environment.install_gettext_callables(gettext, ngettext, newstyle=False)
...
.. method:: shpurdp_jinja2.Environment.uninstall_gettext_translations()

    Uninstall the translations again.

.. method:: shpurdp_jinja2.Environment.extract_translations(source)
...
translation methods to the environment at environment generation time::
    ...
    env = Environment(extensions=['shpurdp_jinja2.ext.i18n'])
...
**Import name:** `shpurdp_jinja2.ext.do`
...
**Import name:** `shpurdp_jinja2.ext.loopcontrols`
...
**Import name:** `shpurdp_jinja2.ext.with_`
...
**Import name:** `shpurdp_jinja2.ext.autoescape`
...
Extensions always have to extend the :class:`shpurdp_jinja2.ext.Extension` class:
...
.. autoclass:: shpurdp_jinja2.parser.Parser
    ...
    .. attribute:: stream
        ...
        The current :class:`~shpurdp_jinja2.lexer.TokenStream`

.. autoclass:: shpurdp_jinja2.lexer.TokenStream
   :members: push, look, eos, skip, next, next_if, skip_if, expect

   .. attribute:: current

        The current :class:`~shpurdp_jinja2.lexer.Token`.

.. autoclass:: shpurdp_jinja2.lexer.Token
...
.. autofunction:: shpurdp_jinja2.lexer.count_newlines
...
For more information have a look at the repr of :meth:`shpurdp_jinja2.Environment.parse`.

.. module:: shpurdp_jinja2.nodes
