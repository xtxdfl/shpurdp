...
from shpurdp_jinja2 import Environment, FileSystemLoader
...
from shpurdp_jinja2.defaults import DEFAULT_FILTERS, DEFAULT_TESTS
...
def jinja_nodes(dirname, arguments, options, content, lineno,
                content_offset, block_text, state, state_machine):
    from shpurdp_jinja2.nodes import Node
    doc = ViewList()
