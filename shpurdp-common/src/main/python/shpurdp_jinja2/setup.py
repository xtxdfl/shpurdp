...
debugsupport = Feature(
  ...
  standard=False,
  ext_modules=[
    Extension("shpurdp_jinja2._debugsupport", ["shpurdp_jinja2/_debugsupport.c"]),
  ],
)
...
setup(
  ...
  packages=[
    "shpurdp_jinja2",
    "shpurdp_jinja2.testsuite",
    "shpurdp_jinja2.testsuite.res",
    "shpurdp_jinja2._markupsafe",
  ],
  extras_require={"i18n": ["Babel>=0.8"]},
  test_suite="shpurdp_jinja2.testsuite.suite",
  include_package_data=True,
  entry_points="""
    [babel.extractors]
    shpurdp_jinja2 = shpurdp_jinja2.ext:babel_extract[i18n]
    """,
