...
# -*- coding: utf-8 -*-
"""
shpurdp_jinja2.testsuite.filters
~~~~~~~~~~~~~~~~~~~~~~~~
...
from shpurdp_jinja2 import Markup, Environment
...
class FilterTestCase(JinjaTestCase):
  ...
  def test_float(self):
    tmpl = env.from_string(
      '{{ "42"|float }}|' '{{ "ajsghasjgd"|float }}|' '{{ "32.32"|float }}'
    )
    out = tmpl.render()
  ...
  def test_urlize(self):
    ...
    assert (
      tmpl.render() == 'foo <a href="http://www.example.com/">'
