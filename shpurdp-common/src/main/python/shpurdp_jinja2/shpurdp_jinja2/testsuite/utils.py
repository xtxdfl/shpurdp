...
# -*- coding: utf-8 -*-
"""
shpurdp_jinja2.testsuite.utils
~~~~~~~~~~~~~~~~~~~~~~
...
from shpurdp_jinja2.utils import LRUCache, escape, object_type_repr
...
class HelpersTestCase(JinjaTestCase):
  def test_object_type_repr(self):
    ...
    self.assert_equal(object_type_repr(X()), "shpurdp_jinja2.testsuite.utils.X object")
