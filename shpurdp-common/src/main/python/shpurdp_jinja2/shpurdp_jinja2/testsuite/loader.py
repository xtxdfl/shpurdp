...
# -*- coding: utf-8 -*-
"""
shpurdp_jinja2.testsuite.loader
~~~~~~~~~~~~~~~~~~~~~~~
...
from shpurdp_jinja2.testsuite import (
  JinjaTestCase,
  dict_loader,
  package_loader,
  filesystem_loader,
...
from shpurdp_jinja2 import Environment, loaders
from shpurdp_jinja2.loaders import split_template_path
