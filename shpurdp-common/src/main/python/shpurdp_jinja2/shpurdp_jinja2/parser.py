...
from shpurdp_jinja2.exceptions import TemplateSyntaxError, TemplateAssertionError
from shpurdp_jinja2.utils import next
from shpurdp_jinja2.lexer import describe_token, describe_token_expr
...
class Parser(object):
  ...
  def free_identifier(self, lineno=None):
    """Return a new free identifier as :class:`~shpurdp_jinja2.nodes.InternalName`."""
  ...
  def parse_tuple(
    ...
    delimited by a comma a :class:`~shpurdp_jinja2.nodes.Tuple` node is created.
