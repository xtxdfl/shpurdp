...
from shpurdp_jinja2.utils import LRUCache, next
import sys
...
try:
  ...
  from shpurdp_jinja2 import _stringdefs
...
class TokenStream(object):
  ...
  def expect(self, expr):
    ...
    argument as :meth:`shpurdp_jinja2.lexer.Token.test`.
    """
