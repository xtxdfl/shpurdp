...
class Markup(str):
  ...
  def unescape(self):
    ...
    """
    from shpurdp_jinja2._markupsafe._constants import HTML_ENTITIES
...
try:
  from shpurdp_jinja2._markupsafe._speedups import escape, escape_silent, soft_unicode
except ImportError:
  from shpurdp_jinja2._markupsafe._native import escape, escape_silent, soft_unicode
