...
from shpurdp_jinja2.utils import Markup, MethodType, FunctionType
...
class ExtensionAttribute(Expr):
  ...
  :meth:`~shpurdp_jinja2.ext.Extension.attr` method on an extension.
  """
...
class InternalName(Expr):
  ...
  :meth:`~shpurdp_jinja2.parser.Parser.free_identifier` method that creates
...
class ContextReference(Expr):
  ...
  current :class:`~shpurdp_jinja2.runtime.Context` object.
...
class ScopedEvalContextModifier(EvalContextModifier):
  ...
  :class:`~shpurdp_jinja2.nodes.EvalContext` for nodes in the :attr:`body`.
  """
