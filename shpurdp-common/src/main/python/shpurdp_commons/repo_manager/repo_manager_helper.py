...
def check_installed_metrics_hadoop_sink_version(
  hadoop_sink_package_name="shpurdp-metrics-hadoop-sink",
  ...
  if (
    ...
    hadoop_sink_package_name = "shpurdp-metrics-assembly"
  ...
  Logger.info("shpurdp-metrics-hadoop-sink package version is OK")
