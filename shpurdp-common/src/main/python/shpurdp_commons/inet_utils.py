...
if OSCheck.is_windows_family():
  from shpurdp_commons.os_windows import os_run_os_command
else:
  # MacOS not supported
  from shpurdp_commons.os_linux import os_run_os_command
...
def ensure_ssl_using_protocol(protocol="PROTOCOL_TLSv1_2", ca_certs=None):
  ...
  if hasattr(ssl, "_create_default_https_context"):
    if not hasattr(ssl._create_default_https_context, "_shpurdp_patched"):
      ...
      _create_default_https_context_patched._shpurdp_patched = True
