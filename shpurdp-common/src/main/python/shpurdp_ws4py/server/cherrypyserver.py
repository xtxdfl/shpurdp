...
.. code-block:: python
    ...
    import cherrypy
    from shpurdp_ws4py.server.cherrypyserver import WebSocketPlugin, WebSocketTool
...
from shpurdp_ws4py import WS_KEY, WS_VERSION
from shpurdp_ws4py.exc import HandshakeError
from shpurdp_ws4py.websocket import WebSocket
from shpurdp_ws4py.compat import py3k, get_connection, detach_connection
