...
import filecmp
import tempfile
from shpurdp_commons import OSCheck, os_utils
        ...
        for (
          ...
          if not os.path.isfile(repo_file_path) or not filecmp.cmp(
            ...
            try:
              ...
              # remove created file or else shpurdp will consider that update was successful and skip repository operations
              File(
                repo_file_path,
                action="delete",
              )
