...
import os
import shpurdp_pyaes
from shpurdp_pbkdf2.pbkdf2 import PBKDF2
...
def decrypt(encrypted_value, encryption_key):
  ...
  aes = shpurdp_pyaes.AESModeOfOperationCBC(key, iv=iv)
  return shpurdp_pyaes.util.strip_PKCS7_padding(aes.decrypt(data))
