...
from shpurdp_stomp.adapter.multicast import MulticastConnection
import shpurdp_stomp.colors
from shpurdp_stomp.connect import (
  shpurdp_stompConnection10,
  StompConnection11,
  StompConnection12,
)
from shpurdp_stomp.listener import ConnectionListener, StatsListener

sys.path.append(".")
import shpurdp_stomp as stomp
