...
DESCRIPTION = "URL should point to full tar.gz location e.g.: https://public-repo-1.hortonworks.com/something/shpurdp-server.tar.gz"

logger = logging.getLogger("install_shpurdp_tarball")
...
class Runner:
  def parse_opts(self):
    ...
    parser.add_option(
      ...
      dest="root_folder",
      default="/",
      help="root folder to install Shpurdp to. E.g.: /opt",
    )
    parser.add_option(
      "-d",
      "--dependencies-skip",
