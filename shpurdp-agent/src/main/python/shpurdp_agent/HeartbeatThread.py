...
from shpurdp_agent.Register import Register
from shpurdp_agent.Utils import BlockingDictionary
from shpurdp_agent.Utils import Utils
from shpurdp_agent.ComponentVersionReporter import ComponentVersionReporter
from shpurdp_agent.listeners.TopologyEventListener import TopologyEventListener
from shpurdp_agent.listeners.ConfigurationEventListener import ConfigurationEventListener
from shpurdp_agent.listeners.AgentActionsListener import AgentActionsListener
from shpurdp_agent.listeners.MetadataEventListener import MetadataEventListener
from shpurdp_agent.listeners.CommandsEventListener import CommandsEventListener
from shpurdp_agent.listeners.HostLevelParamsEventListener import (
  HostLevelParamsEventListener,
)
from shpurdp_agent.listeners.AlertDefinitionsEventListener import (
  AlertDefinitionsEventListener,
)
from shpurdp_agent.listeners.EncryptionKeyListener import EncryptionKeyListener
from shpurdp_agent import security
...
class HeartbeatThread(threading.Thread):
  ...
  def blocking_request(
    ...
    try:
      ...
      # this happens when trying to connect to broken connection. Happens if shpurdp-server is restarted.
