...
from shpurdp_agent.ClusterCache import ClusterCache
from shpurdp_agent.Utils import ImmutableDictionary, synchronized
    ...
    for component_dict in self[cluster_id].components:
      ...
      for host_id in component_dict.hostIds:
        if host_id in self.hosts_to_id[cluster_id]:
          ...
          # In theory this should never happen. But in practice it happened when shpurdp-server had corrupt DB cache.
