...
from shpurdp_agent.models.commands import AgentCommand, CommandStatus
from shpurdp_commons.str_utils import split_on_chunks
...
class ActionQueue(threading.Thread):
  ...
  def execute_command(self, command):
    ...
    # let shpurdp know name of custom command
