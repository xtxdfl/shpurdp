...
class TestPortAlert(TestCase):
  ...
  def test_collect_defaultPort(self, time, socket):
    ...
    alert_source_meta = {"uri": "http://192.168.0.1", "default_port": 80}
    cluster = "c1"
    host = "host1"
    cluster_id = "0"
    expected_state = "OK"
  ...
  def test_collect_warning(self, time, socket):
    ...
    alert_source_meta = {"uri": "http://192.168.0.1:8080", "default_port": 80}
    cluster = "c1"
    host = "host1"
    cluster_id = "0"
