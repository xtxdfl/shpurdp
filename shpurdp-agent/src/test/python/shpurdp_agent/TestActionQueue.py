...
from shpurdp_agent.ActionQueue import ActionQueue, hide_passwords
...
from shpurdp_agent.models.commands import CommandStatus, AgentCommand
...
class TestActionQueue(TestCase):
  ...
  background_command = {
    ...
    "shpurdpLevelParams": {"jdk_location": "test"},
    "clusterId": CLUSTER_ID,
  }
  ...
  @patch.object(ShpurdpConfig, "get_parallel_exec_option")
  ...
  def test_log_execution_commands(
    ...
    config.set("agent", "cache_dir", "/var/lib/shpurdp-agent/cache")
    config.set("agent", "tolerate_download_failures", "true")
