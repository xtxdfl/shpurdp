...
from shpurdp_agent.models.commands import CommandStatus
...
from shpurdp_agent.BackgroundCommandExecutionHandle import (
...
class TestCustomServiceOrchestrator:  # (TestCase):
  ...
  @patch("shpurdp_agent.hostname.public_hostname")
  ...
  def test_dump_command_to_json_with_retry(
    ...
    command = {
      ...
      "clusterHostInfo": {
        ...
        "shpurdp_server_host": "a.b.c",
        "shpurdp_server_port": "123",
        "shpurdp_server_use_ssl": "false",
  ...
  def test_runCommand(
    ...
    command = {
      ...
      "shpurdpLevelParams": {"jdk_location": "some_location"},
      "commandParams": {
        "script_type": "PYTHON",
  ...
  @patch.object(ConfigurationBuilder, "get_configuration")
  @patch("shpurdp_commons.shell.kill_process_with_children")
  @patch.object(CustomServiceOrchestrator, "resolve_script_path")
  @patch.object(CustomServiceOrchestrator, "resolve_hook_script_path")
  @patch.object(FileCache, "get_host_scripts_base_dir")
  @patch.object(FileCache, "get_service_base_dir")
  ...
  @patch.object(ConfigurationBuilder, "get_configuration")
  @patch.object(ShpurdpConfig, "get")
  @patch.object(CustomServiceOrchestrator, "dump_command_to_json")
  @patch.object(PythonExecutor, "run_file")
  @patch.object(FileCache, "__init__")
  ...
  def test_runCommand_custom_action(
    ...
    shpurdp_config_get.return_value = "0"
    FileCache_mock.return_value = None
