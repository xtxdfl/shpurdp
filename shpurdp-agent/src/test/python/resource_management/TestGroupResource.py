  ...
  def test_action_create_nonexistent(self, popen_mock, getgrnam_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E groupadd -p secure hadoop",
      ],
      shell=False,
  ...
  def test_action_create_existent(self, popen_mock, getgrnam_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E groupmod -g 2 -p secure mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_action_remove(self, popen_mock, getgrnam_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E groupdel mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
