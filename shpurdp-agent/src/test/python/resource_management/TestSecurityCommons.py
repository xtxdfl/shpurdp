...
class TestSecurityCommons(TestCase):
  ...
  def test_get_params_from_filesystem_JAAS(self):
    ...
    with open(jaas_file_path, "w+") as f:
      f.write(
        ...
        '  principal="hbase/vp-shpurdp-ranger-med-0120-2.cs1cloud.internal@EXAMPLE.COM";\n'
        "};\n"
      )
  ...
  def test_cached_executor(
    ...
    principal = "nn/c6405.shpurdp.apache.org@EXAMPLE.COM"
    ...
    shpurdp_simplejson_load_mock.return_value = output
    ...
    shpurdp_simplejson_load_mock.reset_mock()
    shpurdp_simplejson_load_mock.return_value = output_error
    ...
    # Test that the shpurdp_simplejson throws an exception
    os_path_exists_mock.return_value = True

    shpurdp_simplejson_load_mock.reset_mock()
    shpurdp_simplejson_load_mock.side_effect = Exception("Invalid file")
    ...
    shpurdp_simplejson_load_mock.reset_mock()
    shpurdp_simplejson_load_mock.return_value = None
