...
class TestServiceResource(TestCase):
  ...
  def test_action_start(self, shell_mock):
    ...
    self.assertEqual(
      shell_mock.call_args_list[0][0][0], ["/etc/init.d/some_service", "status"]
    )
    self.assertEqual(
      shell_mock.call_args_list[1][0][0], ["/etc/init.d/some_service", "start"]
    )
  ...
  def test_action_stop(self, shell_mock):
    ...
    self.assertEqual(
      shell_mock.call_args_list[1][0][0], ["/etc/init.d/some_service", "stop"]
    )
  ...
  def test_action_reload(self, shell_mock):
    ...
    self.assertEqual(
      shell_mock.call_args_list[1][0][0], ["/etc/init.d/some_service", "reload"]
    )
  ...
  def test_action_not_existing(self):
    try:
      ...
      self.assertEqual(
        "ServiceProvider[Service['some_service']] does not implement action not_existing_action",
        str(e),
      )
