  ...
  def test_action_create_nonexistent(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E useradd -m -s /bin/bash mapred",
      ],
      shell=False,
  ...
  def test_action_create_existent(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -s /bin/bash mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_action_delete(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E userdel mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_comment(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -c testComment -s /bin/bash mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_home(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -s /bin/bash -d /test/home mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_password(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -s /bin/bash -p secure mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_shell(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -s /bin/sh mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_uid(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -u 1 -s /bin/bash mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_gid(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -g 1 -s /bin/bash mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
  ...
  def test_attribute_groups(self, getpwnam_mock, popen_mock, user_groups_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E usermod -s /bin/bash -G 1,2,3,hadoop mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      env={"PATH": "/bin"},
  ...
  def test_missing_shell_argument(self, getpwnam_mock, popen_mock):
    ...
    popen_mock.assert_called_with(
      [
        ...
        "--noprofile",
        "-c",
        "shpurdp-sudo.sh  PATH=/bin -H -E useradd -m mapred",
      ],
      shell=False,
      preexec_fn=preexec_fn,
      stderr=-2,
