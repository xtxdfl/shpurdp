...
export PYTHONPATH=$PYTHONPATH:$(pwd)/shpurdp-agent/src/test/python:
$(pwd)/shpurdp-common/src/test/python:
$(pwd)/shpurdp-agent/src/test/python/shpurdp_agent:
$(pwd)/shpurdp-common/src/main/python:
$(pwd)/shpurdp-server/src/main/resources/common-services/HDFS/2.1.0.2.0/package/files:
$(pwd)/shpurdp-server/src/test/python:
$(pwd)/shpurdp-agent/src/test/python/resource_management:
$(pwd)/shpurdp-common/src/main/python/shpurdp_jinja2
"""
...
if __name__ == "__main__":
  ...
  shpurdp_agent_dir = os.path.dirname(
    os.path.dirname(os.path.dirname(os.path.dirname(pwd)))
  )
  src_dir = os.path.dirname(shpurdp_agent_dir)
  shpurdp_common_dir = os.path.join(src_dir, "shpurdp-common")

  sys.path.insert(0, os.path.join(shpurdp_agent_dir, "src", "main", "python"))
  sys.path.insert(
    0, os.path.join(shpurdp_agent_dir, "src", "main", "python", "shpurdp_agent")
  )
  sys.path.insert(0, os.path.join(shpurdp_common_dir, "src", "main", "python"))
  sys.path.insert(
    0, os.path.join(shpurdp_common_dir, "src", "main", "python", "shpurdp_jinja2")
  )
  sys.path.insert(0, os.path.join(shpurdp_common_dir, "src", "test", "python"))
