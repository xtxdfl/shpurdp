...
.. code-block:: python
    ...
    from shpurdp_ws4py.websocket import EchoWebSocket
    from shpurdp_ws4py.server.wsgirefserver import WSGIServer, WebSocketWSGIRequestHandler
    from shpurdp_ws4py.server.wsgiutils import WebSocketWSGIApplication
...
from shpurdp_ws4py.manager import WebSocketManager
from shpurdp_ws4py import format_addresses
from shpurdp_ws4py.server.wsgiutils import WebSocketWSGIApplication
from shpurdp_ws4py.compat import get_connection

__all__ = ["WebSocketWSGIHandler", "WebSocketWSGIRequestHandler", "WSGIServer"]

logger = logging.getLogger("shpurdp_ws4py")
...
if __name__ == "__main__":
  from shpurdp_ws4py import configure_logger
