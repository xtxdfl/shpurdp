...
import os
import signal
from shpurdp_agent.RemoteDebugUtils import NamedPipe
from shpurdp_agent.RemoteDebugUtils import pipename
...
def main():
  with open("/var/run/shpurdp-agent/shpurdp-agent.pid") as f:
