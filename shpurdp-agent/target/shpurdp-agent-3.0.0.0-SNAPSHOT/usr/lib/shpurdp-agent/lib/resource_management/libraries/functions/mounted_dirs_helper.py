...
# However, it is not advised to delete this file since Shpurdp may
...
def handle_mounted_dirs(func, dirs_string, history_filename, update_cache=True):
  ...
  If Shpurdp forcefully creates the directory when it doesn't exist and drive became unmounted, then Shpurdp will soon
  ...
  # Get the dirs that Shpurdp knows about and their last known mount point
