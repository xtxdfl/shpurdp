...
class ExecutionCommand(object):
  ...
  def __init__(self, command):
    ...
    self.__module_configs = module_configs.ModuleConfigs(
      self.__get_value("configurations"), self.__get_value("configurationAttributes")
    )
    # TODO : 'stack_settings' and 'cluster_settings' may be segregated later out of 'cluster-env'
    # as done in 'branch-feature-SHPURDP-14714'.
  ...
  """
    Shpurdp variables section
    """

  def get_jdk_location(self):
    """
    Retrieve URL of jdk from command.json. i.e "jdk_location": "http://c7302.shpurdp.apache.org:8080/resources/"
    :return: jdk url string
    """
    return self.__get_value("shpurdpLevelParams/jdk_location")
  ...
  def get_jdk_name(self):
    ...
    """
    return self.__get_value("shpurdpLevelParams/jdk_name")
  ...
  def get_java_home(self):
    ...
    """
    return self.__get_value("shpurdpLevelParams/java_home")
  ...
  def get_java_version(self):
    ...
    return expect_v2("shpurdpLevelParams/java_version", int)
  ...
  def get_jce_name(self):
    ...
    """
    return self.__get_value("shpurdpLevelParams/jce_name")
  ...
  def get_db_driver_file_name(self):
    ...
    """
    return self.__get_value("shpurdpLevelParams/db_driver_filename")

  def get_db_name(self):
    """
    Retrieve database name, i.e Shpurdp server's db name is "db_name": "shpurdp"
    :return: DB name
    """
    return self.__get_value("shpurdpLevelParams/db_name")

  def get_oracle_jdbc_url(self):
    """
    Retrieve oracle database jdbc driver url,
    i.e "oracle_jdbc_url": "http://c7302.shpurdp.apache.org:8080/resources//ojdbc6.jar"
    :return: oracle jdbc url
    """
    return self.__get_value("shpurdpLevelParams/oracle_jdbc_url")

  def get_mysql_jdbc_url(self):
    """
    Retrieve mysql database jdbc driver url,
    i.e "mysql_jdbc_url": "http://c7302.shpurdp.apache.org:8080/resources//mysql-connector-java.jar"
    :return: mysql jdbc url
    """
    return self.__get_value("shpurdpLevelParams/mysql_jdbc_url")
  ...
  def get_agent_stack_retry_count(self):
    ...
    return expect_v2("shpurdpLevelParams/agent_stack_retry_count", int, 5)
  ...
  def check_agent_stack_want_retry_on_unavailability(self):
    ...
    """
    return self.__get_value("shpurdpLevelParams/agent_stack_retry_on_unavailability")

  def get_shpurdp_server_host(self):
    """
    Retrieve shpurdp server host url from command.json, i.e "shpurdp_server_host": "c7302.shpurdp.apache.org"
    :return: shpurdp server url
    """
    return self.__get_value("shpurdpLevelParams/shpurdp_server_host")

  def get_shpurdp_server_port(self):
    """
    Retrieve ambar server port number from command.json, i.e "shpurdp_server_port": "8080"
    :return: amabari server port number
    """
    return self.__get_value("shpurdpLevelParams/shpurdp_server_port")

  def is_shpurdp_server_use_ssl(self):
    """
    Check if ssl is needed to connect to shpurdp server
    :return: True or False
    """
    return self.__get_value("shpurdpLevelParams/shpurdp_server_use_ssl", False)
  ...
  def is_host_system_prepared(self):
    ...
    :return: True or False
    """
    return self.__get_value("shpurdpLevelParams/host_sys_prepped", False)

  def is_gpl_license_accepted(self):
    """
    Check shpurdp server accepts gpl license or not
    :return: True or False
    """
    return self.__get_value("shpurdpLevelParams/gpl_license_accepted", False)
  ...
  def get_user_groups(self):
    """
    Retrieve shpurdp server user groups, i.e "user_groups": "{\"zookeeper\":[\"hadoop\"],\"shpurdp-qa\":[\"hadoop\"]}"
  ...
  def get_user_list(self):
    """
    Retrieve a list of users from command.json, i.e "user_list": "[\"zookeeper\",\"shpurdp-qa\"]"
  ...
  def get_host_name(self):
    """
    Retrieve host name on which shpurdp agent is running
    :return: host name
    """
  ...
  def get_agent_cache_dir(self):
    """
    The root directory in which shpurdp agent stores cache or log etc,
    i.e "agentCacheDir": "/var/lib/shpurdp-agent/cache"
  ...
  def check_agent_config_execute_in_parallel(self):
    """
    Check if config commands can be executed in parallel in shpurdp agent
    :return: True or False
    """
    return int(
      self.__get_value("agentLevelParams/agentConfigParams/agent/parallel_execution", 0)
    )
  ...
  '''
    def get_shpurdp_java_home(self):
        return self.__get_value('commandParams/shpurdp_java_home')
    def get_shpurdp_java_name(self):
        return self.__get_value('commandParams/shpurdp_java_name')
    def get_shpurdp_jce_name(self):
        return self.__get_value('commandParams/shpurdp_jce_name')
    def get_shpurdp_jdk_name(self):
        return self.__get_value('commandParams/shpurdp_jdk_name')
