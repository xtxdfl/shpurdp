...
from shpurdp_jinja2 import Environment as JinjaEnvironment
...
def __create_solr_cloud_cli_prefix(
  ...
  solr_cli_prefix = format(
    "{sudo} JAVA_HOME={java64_home}{infra_solr_cli_opts} /usr/lib/shpurdp-infra-solr-client/solrCloudCli.sh "
...
def setup_solr_client(
  ...
  solr_client_log_dir = (
    default_config(
      ...
      "/var/log/shpurdp-infra-solr-client",
    )
