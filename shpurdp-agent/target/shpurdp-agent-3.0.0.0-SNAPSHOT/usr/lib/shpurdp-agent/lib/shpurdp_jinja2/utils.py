...
def clear_caches():
  ...
  """
  from shpurdp_jinja2.environment import _spontaneous_environments
  from shpurdp_jinja2.lexer import _lexer_cache
...
def generate_lorem_ipsum(n=5, html=True, min=20, max=100):
  ...
  from shpurdp_jinja2.constants import LOREM_IPSUM_WORDS
...
try:
  ...
  from shpurdp_jinja2._markupsafe import Markup, escape, soft_unicode
