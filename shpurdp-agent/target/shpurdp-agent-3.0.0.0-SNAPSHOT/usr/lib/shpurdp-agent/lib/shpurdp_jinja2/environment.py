...
import os
import sys
from shpurdp_jinja2 import nodes
from shpurdp_jinja2.defaults import *
from shpurdp_jinja2.lexer import get_lexer, TokenStream
from shpurdp_jinja2.parser import Parser
from shpurdp_jinja2.optimizer import optimize
from shpurdp_jinja2.compiler import generate
from shpurdp_jinja2.runtime import Undefined, new_context
...
class Environment(object):
  ...
  Here the possible initialization parameters:
      ...
      `autoescape`
          ...
          :class:`~shpurdp_jinja2.utils.Markup`.  As of Jinja 2.4 this can also
  ...
  #: have a look at shpurdp_jinja2.sandbox
  sandboxed = False
  ...
  def _tokenize(self, source, name, filename=None, state=None):
    ...
    for all the extensions.  Returns a :class:`~shpurdp_jinja2.lexer.TokenStream`.
    """
  ...
  def compile_templates(
    ...
    .. versionadded:: 2.4
    """
    from shpurdp_jinja2.loaders import ModuleLoader
  ...
  def handle_exception(self, exc_info=None, rendered=False, source_hint=None):
    ...
    if _make_traceback is None:
      from shpurdp_jinja2.debug import make_traceback as _make_traceback
...
class TemplateExpression(object):
  """The :meth:`shpurdp_jinja2.Environment.compile_expression` method returns an
