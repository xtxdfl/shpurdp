...
from shpurdp_jinja2.exceptions import TemplateNotFound
from shpurdp_jinja2.utils import LRUCache, open_if_exists, internalcode
...
class BaseLoader(object):
  ...
  system could look like this::
      ...
      from shpurdp_jinja2 import BaseLoader, TemplateNotFound
...
class ModuleLoader(BaseLoader):
  ...
  def __init__(self, path):
    package_name = f"_shpurdp_jinja2_module_templates_{id(self):x}"
