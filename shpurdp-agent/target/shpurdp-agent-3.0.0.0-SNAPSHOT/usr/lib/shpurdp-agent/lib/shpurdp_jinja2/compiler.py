...
from shpurdp_jinja2.nodes import EvalContext
from shpurdp_jinja2.visitor import NodeVisitor, NodeTransformer
from shpurdp_jinja2.exceptions import TemplateAssertionError
from shpurdp_jinja2.utils import Markup, concat, escape, is_python_keyword, next
...
class CodeGenerator(NodeVisitor):
  ...
  def visit_Template(self, node, frame=None):
    ...
    from shpurdp_jinja2.runtime import __all__ as exported

    self.writeline("from __future__ import division")
    self.writeline("from shpurdp_jinja2.runtime import " + ", ".join(exported))
