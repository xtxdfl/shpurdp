...
class Shpurdp_Infra_SolrServiceAdvisor(service_advisor.ServiceAdvisor):
  def __init__(self, *args, **kwargs):
    self.as_super = super(Shpurdp_Infra_SolrServiceAdvisor, self)
  ...
  def getServiceComponentLayoutValidations(self, services, hosts):
    ...
    return self.getServiceComponentCardinalityValidations(
      services, hosts, "SHPURDP_INFRA_SOLR"
    )
