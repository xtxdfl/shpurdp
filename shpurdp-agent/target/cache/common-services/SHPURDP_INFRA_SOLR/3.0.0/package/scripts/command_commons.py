...
index_helper_script = "/usr/lib/shpurdp-infra-solr-client/solrIndexHelper.sh"
...
# where "." chars replaced with "_"(e.g.: /my/path/backup_locationc7301_shpurdp_apache_org), that can be useful if different
