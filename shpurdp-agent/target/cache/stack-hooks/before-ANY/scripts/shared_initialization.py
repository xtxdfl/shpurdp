...
def setup_java():
  ...
  Install shpurdp jdk as well if the stack and shpurdp jdk are different.
  """
  import params

  __setup_java(custom_java_home=params.java_home, custom_jdk_name=params.jdk_name)
  if params.shpurdp_java_home and params.shpurdp_java_home != params.java_home:
    __setup_java(
      custom_java_home=params.shpurdp_java_home, custom_jdk_name=params.shpurdp_jdk_name
    )


def __setup_java(custom_java_home, custom_jdk_name):
  """
  Installs jdk using specific params, that comes from shpurdp-server
  """
  import params
