...
artifact_dir = tmp_dir + "/SHPURDP-artifacts"
...
host_sys_prepped = default("/shpurdpLevelParams/host_sys_prepped", False)

# Whether to skip copying fast-hdfs-resource.jar to /var/lib/shpurdp-agent/lib/
...
shpurdp_server_resources_url = default("/shpurdpLevelParams/jdk_location", None)
if shpurdp_server_resources_url is not None and shpurdp_server_resources_url.endswith(
  "/"
):
  shpurdp_server_resources_url = shpurdp_server_resources_url[:-1]
...
java_home = default("/shpurdpLevelParams/java_home", None)
...
shpurdp_server_hostname = config["shpurdpLevelParams"]["shpurdp_server_host"]
...
oracle_driver_symlink_url = format(
  "{shpurdp_server_resources_url}/oracle-jdbc-driver.jar"
)
mysql_driver_symlink_url = format("{shpurdp_server_resources_url}/mysql-jdbc-driver.jar")
...
shpurdp_java_home = default("/commandParams/shpurdp_java_home", None)
shpurdp_jdk_name = default("/commandParams/shpurdp_jdk_name", None)
shpurdp_jce_name = default("/commandParams/shpurdp_jce_name", None)

shpurdp_libs_dir = "/var/lib/shpurdp-agent/lib"
