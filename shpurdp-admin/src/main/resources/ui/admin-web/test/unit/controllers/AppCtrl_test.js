...
describe('#AppCtrl', function () {
  ...
  beforeEach(function () {
    module('shpurdpAdminConsole', function ($provide) {
      $provide.value('$route', {
        current: null
      });
      $provide.value('$window', {
        location: {
          pathname: 'http://c6401.shpurdp.apache.org:8080/views/ADMIN_VIEW/2.0.0/INSTANCE/#/'
        },
        localStorage: {
          getItem: function () {
            return null;
      ...
      localStorage.shpurdp = JSON.stringify({
        app: {
          authenticated: true,
          loginName: 'admin',
          user: 'user'
    ...
    inject(function (_$httpBackend_, $rootScope, $controller, _$window_, _Cluster_, _$q_) {
      ...
      $httpBackend.whenGET(/api\/v1\/services\/SHPURDP\/components\/SHPURDP_SERVER.+/).respond(200, {
      ...
      $httpBackend.whenGET(/\/api\/v1\/views.+/).respond(200, {
          "href": "http://c6401.shpurdp.apache.org:8080/api/v1/views?fields=versions/instances/ViewInstanceInfo&versions/ViewVersionInfo/system=false&versions/instances/ViewInstanceInfo/visible=true",
          "items": [
            {
              "ViewInfo": {
                "view_name": "SLIDER"
              },
              "href": "http://c6401.shpurdp.apache.org:8080/api/v1/views/SLIDER",
              "versions": [
                {
                  "ViewVersionInfo": {
                    "system": false,
                  ...
                  "href": "http://c6401.shpurdp.apache.org:8080/api/v1/views/SLIDER/versions/1.0.0",
                  "instances": [
                    {
                      "ViewInstanceInfo": {
                        ...
                        "properties": {
                          "shpurdp.server.password": "123",
                          "shpurdp.server.url": "123",
                          "shpurdp.server.username": "123",
                          "slider.user": null,
                      ...
                      "href": "http://c6401.shpurdp.apache.org:8080/api/v1/views/SLIDER/versions/1.0.0/instances/VisibleInstance"
                    }
                  ]
                }
              ]
  ...
  describe('signout', function () {
    ...
    beforeEach(function (done) {
      ...
      $httpBackend.whenGET(/\/api\/v1\/users\/admin\/authorizations.*/).respond(200, {
        items: [
          {
            AuthorizationInfo: {
              authorization_id: "SHPURDP.RENAME_CLUSTER"
            }
          }
        ]
      });
    ...
    it('should reset window.location and shpurdp localstorage', function (done) {
