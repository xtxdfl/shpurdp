...
import org.apache.shpurdp.funtest.server.api.cluster.GetAllClustersWebRequest;
import org.apache.shpurdp.funtest.server.api.user.DeleteUserWebRequest;
...
public class RoleBasedAccessControlBasicTest extends ServerTestBase {
    ...
    public void testGetClustersAsAnonUser() throws Exception {
         ...
         */
        ClusterUtils.createUser(adminConnectionParams, clusterName, anonUserName, anonUserPwd, ShpurdpUserRole.NONE);
