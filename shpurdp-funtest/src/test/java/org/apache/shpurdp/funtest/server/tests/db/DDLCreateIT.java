 ...
 */
package org.apache.shpurdp.funtest.server.tests.db;
...
public class DDLCreateIT {
  ...
  @Test
  public void mysql() {
    testSchemaCreate(() -> new MariaDBContainer("mariadb:10.2").withConfigurationOverride(null).withInitScript("Shpurdp-DDL-MySQL-CREATE.sql"));
    testSchemaCreate(() -> new MySQLContainer("mysql:5.7").withConfigurationOverride(null).withInitScript("Shpurdp-DDL-MySQL-CREATE.sql"));
  }

  @Test
  public void postgres() {
    testSchemaCreate(() -> new PostgreSQLContainer("postgres:9.6").withInitScript("Shpurdp-DDL-Postgres-CREATE.sql"));
    testSchemaCreate(() -> new PostgreSQLContainer("postgres:10").withInitScript("Shpurdp-DDL-Postgres-CREATE.sql"));
  }
