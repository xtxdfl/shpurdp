 ...
 */
public class SetUserPrivilegeWebRequest extends ShpurdpHttpWebRequest {
    private final String clusterName;
    private final String userName;
    private final String principalType;
    private final ShpurdpUserRole userRole;
    private static String pathFormat = "/api/v1/clusters/%s/privileges";

    /**
     *
     * @param serverParams - Shpurdp server connection information
     * @param clusterName
     * @param userName
     * @param userRole
    ...
    public SetUserPrivilegeWebRequest(ConnectionParams serverParams, String clusterName, String userName,
                                      ShpurdpUserRole userRole, String principalType) {
