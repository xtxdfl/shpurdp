...
public class GetStacksTest extends ServerTestBase {
  /**
   * Waits for the shpurdp server to startup and then checks it's
   * status by querying /api/v1/stacks (does not touch the DB)
   */
  @Test
  public void testServerStatus() throws IOException {
    /**
     * Query the shpurdp server for the list of stacks.
    ...
    /**
     * Test URL for GETting the status of the shpurdp server
     */
