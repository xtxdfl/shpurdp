...
package org.apache.shpurdp.funtest.server.utils;
...
import org.apache.shpurdp.funtest.server.ShpurdpUserRole;
import org.apache.shpurdp.funtest.server.ClusterConfigParams;
import org.apache.shpurdp.funtest.server.ConnectionParams;
import org.apache.shpurdp.funtest.server.WebRequest;
import org.apache.shpurdp.funtest.server.WebResponse;
import org.apache.shpurdp.funtest.server.api.cluster.AddDesiredConfigurationWebRequest;
import org.apache.shpurdp.funtest.server.api.cluster.CreateClusterWebRequest;
import org.apache.shpurdp.funtest.server.api.cluster.CreateConfigurationWebRequest;
import org.apache.shpurdp.funtest.server.api.cluster.GetRequestStatusWebRequest;
import org.apache.shpurdp.funtest.server.api.cluster.SetUserPrivilegeWebRequest;
import org.apache.shpurdp.funtest.server.api.host.AddHostWebRequest;
import org.apache.shpurdp.funtest.server.api.host.RegisterHostWebRequest;
import org.apache.shpurdp.funtest.server.api.service.AddServiceWebRequest;
import org.apache.shpurdp.funtest.server.api.service.InstallServiceWebRequest;
import org.apache.shpurdp.funtest.server.api.servicecomponent.AddServiceComponentWebRequest;
import org.apache.shpurdp.funtest.server.api.servicecomponenthost.BulkAddServiceComponentHostsWebRequest;
import org.apache.shpurdp.funtest.server.api.servicecomponenthost.BulkSetServiceComponentHostStateWebRequest;
import org.apache.shpurdp.funtest.server.api.user.CreateUserWebRequest;
...
public class ClusterUtils {
    ...
    public static void createUser(ConnectionParams connectionParams, String clusterName,String userName,
                                 String password, ShpurdpUserRole userRole ) throws Exception {
        JsonElement jsonResponse;
        ...
        if (userRole != ShpurdpUserRole.NONE) {
    ...
    public static void createUserClusterUser(ConnectionParams connectionParams, String clusterName,
        ...
        createUser(connectionParams, clusterName, userName, password, ShpurdpUserRole.CLUSTER_USER);
    }
    ...
    public static void createUserServiceOperator(ConnectionParams connectionParams, String clusterName,
                                              String userName, String password) throws Exception {
        createUser(connectionParams, clusterName, userName, password, ShpurdpUserRole.SERVICE_OPERATOR);
    }
    ...
    public static void createUserServiceAdministrator(ConnectionParams connectionParams, String clusterName,
                                              String userName, String password) throws Exception {
        createUser(connectionParams, clusterName, userName, password, ShpurdpUserRole.SERVICE_ADMINISTRATOR);
    }
    ...
    public static void createUserClusterOperator(ConnectionParams connectionParams, String clusterName,
                                              String userName, String password) throws Exception {
        createUser(connectionParams, clusterName, userName, password, ShpurdpUserRole.CLUSTER_OPERATOR);
    }
    ...
    public static void createUserClusterAdministrator(ConnectionParams connectionParams, String clusterName,
                                              String userName, String password) throws Exception {
        createUser(connectionParams, clusterName, userName, password, ShpurdpUserRole.CLUSTER_ADMINISTRATOR);
    }
