...
package org.apache.shpurdp.funtest.server.api.cluster;

import org.apache.shpurdp.funtest.server.ShpurdpHttpWebRequest;
import org.apache.shpurdp.funtest.server.ConnectionParams;

/**
 * Gets the status of a request by request id. For example:
 * curl --user admin:admin -i -X GET http://SHPURDP_SERVER_HOST:8080/api/v1/clusters/CLUSTER_NAME/requests/9
 * curl --user admin:admin -i -X GET http://SHPURDP_SERVER_HOST:8080/api/v1/clusters/CLUSTER_NAME/requests/9/tasks/101
 *
 * Response:
 * {
 * "href" : "http://SHPURDP_SERVER_HOST:8080/api/v1/clusters/CLUSTER_NAME/requests/9/tasks/101",
 * "Tasks" : {
 * ...
 * "status" : "COMPLETED",
 * ...
 ...
 * }
 */
public class GetRequestStatusWebRequest extends ShpurdpHttpWebRequest {
