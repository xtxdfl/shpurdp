...
/**
 * REST API Client that performs various operations on the Shpurdp Server
 * using Http.
 */
public class ShpurdpHttpWebRequest extends WebRequest {
    private static final Log LOG = LogFactory.getLog(ShpurdpHttpWebRequest.class);
     ...
     * @param params
     */
    public ShpurdpHttpWebRequest(ConnectionParams params) {
        ...
        addHeader("X-Requested-By", "shpurdp");
        if (getUserName() != null) {
    ...
    /**
     * Sends the request to the Shpurdp server and returns the response.
     *
     * @return - Response from the Shpurdp server.
     * @throws IOException
     */
    @Override
    ...
    public String getCurlApi() {
        if (curlApi == null) {
            ...
            sb.append(String.format(" -H \"%s\"", "X-Requested-By: shpurdp"));
    ...
    /**
     * Sets the REST API URL for the Shpurdp Server
     *
    ...
    /**
     * Gets the REST API URL for the Shpurdp Server
     *
     * @return - REST API URL
     */
    ...
    /**
     * Gets URL for the Shpurdp Server (without the API path)
     *
     ...
     *
     * @return - Response from the Shpurdp server/Agent server.
     * @throws IOException
     */
