...
public class ViewXmlTest {
  ...
  public void testValidateViewXmls() throws Exception {
    ...
    File shpurdpViewsDir = new File("."); //shpurdp-views
    File xsdFile        = new File("./target/classes/view.xsd");

    // validate each of the view.xml files under shpurdp-views
    for (File file : getViewXmlFiles(viewXmlFiles, shpurdpViewsDir.listFiles())) {
