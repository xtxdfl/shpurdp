...
public interface ViewContext {
   ...
   */
  public static final String CONTEXT_ATTRIBUTE = "shpurdp-view-context";
  ...
  /**
   * Get an Shpurdp stream provider.
   *
   * @return an Shpurdp stream provider
   */
  public ShpurdpStreamProvider getShpurdpStreamProvider();

  /**
   * Get Shpurdp stream provider attached as cluster to the view
   * If view is not attached to shpurdp managed cluster then it will be null
   *
