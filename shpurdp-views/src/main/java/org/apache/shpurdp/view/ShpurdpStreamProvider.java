 ...
 */
public interface ShpurdpStreamProvider {
  /**
   * Read from the input stream specified by the given path on the Shpurdp server.
   *
   * @param path              the String to parse as an Shpurdp endpoint (e.g. /api/v1/users)
  ...
  public InputStream readFrom(String path, String requestMethod, String body,
                              Map<String, String> headers) throws IOException,ShpurdpHttpException;
